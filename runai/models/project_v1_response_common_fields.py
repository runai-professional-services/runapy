...
class ProjectV1ResponseCommonFields(BaseModel):
    """
    Pydantic class model representing ProjectV1ResponseCommonFields.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectV1ResponseCommonFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectV1ResponseCommonFields from a dict"""
        if obj is None:
            return None
