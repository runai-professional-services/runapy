...
class CleanPodPolicyOptions(BaseModel):
    """
    Pydantic class model representing CleanPodPolicyOptions.

    Parameters:
        ```python
        options: Optional[List[CleanPodPolicyOptionsOptionsInner]]
        ```
        options: See model List[CleanPodPolicyOptionsOptionsInner] for more information.
    Example:
        ```python
        CleanPodPolicyOptions(
            options=[
                    runai.models.clean_pod_policy_options_options_inner.CleanPodPolicyOptions_options_inner(
                        value = 'None',
    ...
    options: Optional[List[CleanPodPolicyOptionsOptionsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CleanPodPolicyOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CleanPodPolicyOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "options": (
                    [
                        CleanPodPolicyOptionsOptionsInner.from_dict(_item)
