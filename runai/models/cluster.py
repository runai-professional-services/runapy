...
class Cluster(BaseModel):
    """
    Pydantic class model representing Cluster.
    ...
    Parameters:
        ...
        ```
        metadata: See model ClusterMetadata for more information.
        current: See model ClusterCurrent for more information.
        time_range: See model TimeRange for more information.
    Example:
        ```python
        Cluster(
            metadata=runai.models.cluster_metadata.cluster_metadata(
                    cluster_id = '71f69d83-ba66-4822-adf5-55ce55efd210',
                    cluster_name = 'cluster-a', ),
                        current=runai.models.cluster_current.cluster_current(
                    resources = [
                        null
                        ],
                    project_resources = [
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "metadata": (
                    ClusterMetadata.from_dict(obj["metadata"])
                    if obj.get("metadata") is not None
                    else None
                ),
                "current": (
                    ClusterCurrent.from_dict(obj["current"])
