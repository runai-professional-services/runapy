...
class RestartPolicyOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing RestartPolicyOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[RestartPolicy]
        displayed: Optional[str]
        ```
        value: See model RestartPolicy for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RestartPolicyOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RestartPolicyOptionsOptionsInner from a dict"""
        if obj is None:
            return None
