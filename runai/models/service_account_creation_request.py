...
class ServiceAccountCreationRequest(BaseModel):
    """
    Pydantic class model representing ServiceAccountCreationRequest.

    Parameters:
        ```python
        name: str
        ```
        name: The name of the service account. The name must be unique within the organization and can only contain lowercase alphanumeric characters and hyphens. It must start and end with a letter.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServiceAccountCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServiceAccountCreationRequest from a dict"""
        if obj is None:
            return None
