...
class InferencesMinReplicasField(BaseModel):
    """
    Pydantic class model representing InferencesMinReplicasField.
    ...
    __properties: ClassVar[List[str]] = ["minReplicas"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferencesMinReplicasField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferencesMinReplicasField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"minReplicas": obj.get("minReplicas")})
        return _obj
