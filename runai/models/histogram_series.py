...
class HistogramSeries(BaseModel):
    """
    Pydantic class model representing HistogramSeries.

    Parameters:
        ```python
        type: str
        values: List[HistogramValue]
        ```
        type: specifies what data returned
        values: See model List[HistogramValue] for more information.
    Example:
        ```python
        HistogramSeries(
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "values": (
                    [HistogramValue.from_dict(_item) for _item in obj["values"]]
