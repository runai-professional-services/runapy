...
class TrainingPolicyV2(BaseModel):
    """
    Pydantic class model representing TrainingPolicyV2.

    Parameters:
        ```python
        meta: PolicyMeta
        policy: Optional[TrainingPolicyDefaultsAndRulesV2]
        effective: Optional[TrainingPolicyDefaultsAndRulesV2]
        ...
        effective: See model TrainingPolicyDefaultsAndRulesV2 for more information.
    ...
    effective: Optional[TrainingPolicyDefaultsAndRulesV2] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainingPolicyV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainingPolicyV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "effective": (
                    TrainingPolicyDefaultsAndRulesV2.from_dict(obj["effective"])
