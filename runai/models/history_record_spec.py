...
class HistoryRecordSpec(BaseModel):
    ...
    Parameters:
        ...
        phase_update: Optional[AssetPhaseUpdate]
        ```
        event: See model Event1 for more information.
        phase_update: See model AssetPhaseUpdate for more information.
    Example:
        ```python
        HistoryRecordSpec(
    ...
    phase_update: Optional[AssetPhaseUpdate] = Field(default=None, alias="phaseUpdate")
        ...
        _obj = cls.model_validate(
            {
                ...
                "phaseUpdate": (
                    AssetPhaseUpdate.from_dict(obj["phaseUpdate"])
