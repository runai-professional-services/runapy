...
class GitCreationRequest(BaseModel):
    """
    Pydantic class model representing GitCreationRequest.
    ...
    Parameters:
        ...
        spec: See model GitAssetSpec for more information.
    Example:
        ```python
        GitCreationRequest(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    GitAssetSpec.from_dict(obj["spec"])
