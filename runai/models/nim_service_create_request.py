...
class NimServiceCreateRequest(BaseModel):
    """
    Pydantic class model representing NimServiceCreateRequest.

    Parameters:
        ```python
        metadata: NIMServiceMetadataCreateParams
        spec: NimServiceSpec
        ```
        metadata: See model NIMServiceMetadataCreateParams for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NimServiceCreateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NimServiceCreateRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "metadata": (
                    NIMServiceMetadataCreateParams.from_dict(obj["metadata"])
