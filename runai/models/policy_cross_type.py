...
class PolicyCrossType(BaseModel):
    ...
    Parameters:
        ...
        nim_service: Optional[NimServicePolicy]
        ```
        ...
        nim_service: See model NimServicePolicy for more information.
    Example:
        ```python
        PolicyCrossType(
            workspace=runai.models.workspace_policy_v2.WorkspacePolicyV2(
                    ...
                    effective = runai.models.distributed_inference_policy_defaults_and_rules_v2.DistributedInferencePolicyDefaultsAndRulesV2(
                        ...
                        rules = runai.models.rules.rules(), ),
                    effective_updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                        nim_service=runai.models.nim_service_policy.NimServicePolicy(
                    meta = null,
    ...
    nim_service: Optional[NimServicePolicy] = Field(default=None, alias="nimService")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of nim_service
        if self.nim_service:
            _dict["nimService"] = self.nim_service.to_dict()
        ...
        # set to None if nim_service (nullable) is None
        # and model_fields_set contains the field
        if self.nim_service is None and "nim_service" in self.model_fields_set:
            _dict["nimService"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "nimService": (
                    NimServicePolicy.from_dict(obj["nimService"])
                    if obj.get("nimService") is not None
                    else None
                ),
            }
        )
