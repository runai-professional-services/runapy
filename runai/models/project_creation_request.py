...
class ProjectCreationRequest(BaseModel):
    """
    Pydantic class model representing ProjectCreationRequest.
    ...
    Parameters:
        ...
        enforce_run_ai_scheduler: Optional[bool]
        ...
        requested_namespace: project&#39;s requested namespace
        enforce_run_ai_scheduler: a flag to enforce that all pods in this namespace will be scheduled with runai-scheduler. Supported for cluster v2.21+ - Default: True
    ...
    enforce_run_ai_scheduler: Optional[StrictBool] = Field(
        default=True,
        ...
        alias="enforceRun:aiScheduler",
    )
    parent_id: Optional[StrictStr] = Field(
        default=None, description="department parent uuid", alias="parentId"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectCreationRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if enforce_run_ai_scheduler (nullable) is None
        # and model_fields_set contains the field
        if (
            self.enforce_run_ai_scheduler is None
            and "enforce_run_ai_scheduler" in self.model_fields_set
        ):
            _dict["enforceRun:aiScheduler"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "enforceRun:aiScheduler": (
                    obj.get("enforceRun:aiScheduler")
                    if obj.get("enforceRun:aiScheduler") is not None
                    else True
                ),
