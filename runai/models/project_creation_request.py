...
class ProjectCreationRequest(BaseModel):
    ...
    Parameters:
        ...
        enforce_runai_scheduler: a flag to enforce that all pods in this namespace will be scheduled with runai-scheduler. Supported for cluster v2.21+ - Default: True
        ...
        _obj = cls.model_validate(
            {
                ...
                "enforceRunaiScheduler": (
                    obj.get("enforceRunaiScheduler")
                    if obj.get("enforceRunaiScheduler") is not None
                    else True
                ),
