...
class ContainerOverridable(BaseModel):
    """
    Pydantic class model representing Container overrideable fields. In the context of assets,these are environment asset fields that can be overriden in the submit workload request..
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContainerOverridable from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContainerOverridable from a dict"""
        if obj is None:
            return None
