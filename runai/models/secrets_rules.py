...
class SecretsRules(BaseModel):
    """
    Pydantic class model representing SecretsRules.

    Parameters:
        ```python
        attributes: Optional[SecretRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model SecretRules for more information.
    ...
    attributes: Optional[SecretRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SecretsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SecretsRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    SecretRules.from_dict(obj["attributes"])
