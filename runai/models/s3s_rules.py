...
class S3sRules(BaseModel):
    """
    Pydantic class model representing S3sRules.

    Parameters:
        ```python
        attributes: Optional[S3Rules]
        instances: Optional[ItemRules]
        ```
        attributes: See model S3Rules for more information.
    ...
    attributes: Optional[S3Rules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of S3sRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of S3sRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    S3Rules.from_dict(obj["attributes"])
