...
class GetProjects200ResponseProjectsInner(BaseModel):
    ...
    Parameters:
        ```python
        scheduling_rules: Optional[DataUpdatableFieldsSchedulingRules]
        ...
        ```
        scheduling_rules: See model DataUpdatableFieldsSchedulingRules for more information.
    ...
    scheduling_rules: Optional[DataUpdatableFieldsSchedulingRules] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "schedulingRules": (
                    DataUpdatableFieldsSchedulingRules.from_dict(obj["schedulingRules"])
