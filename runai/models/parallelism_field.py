...
class ParallelismField(BaseModel):
    """
    Pydantic class model representing ParallelismField.
    ...
    __properties: ClassVar[List[str]] = ["parallelism"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ParallelismField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ParallelismField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"parallelism": obj.get("parallelism")})
        return _obj
