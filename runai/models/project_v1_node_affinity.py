...
class ProjectV1NodeAffinity(BaseModel):
    """
    Pydantic class model representing Node affinity configuration for jobs in the project..

    Parameters:
        ```python
        train: Optional[ProjectV1NodeAffinityTrain]
        interactive: Optional[ProjectV1NodeAffinityInteractive]
        ```
        train: See model ProjectV1NodeAffinityTrain for more information.
        interactive: See model ProjectV1NodeAffinityInteractive for more information.
    Example:
        ```python
    ...
    train: Optional[ProjectV1NodeAffinityTrain] = None
    interactive: Optional[ProjectV1NodeAffinityInteractive] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectV1NodeAffinity from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if interactive (nullable) is None
        # and model_fields_set contains the field
        if self.interactive is None and "interactive" in self.model_fields_set:
            _dict["interactive"] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectV1NodeAffinity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "train": (
                    ProjectV1NodeAffinityTrain.from_dict(obj["train"])
                    if obj.get("train") is not None
                    else None
                ),
                "interactive": (
                    ProjectV1NodeAffinityInteractive.from_dict(obj["interactive"])
