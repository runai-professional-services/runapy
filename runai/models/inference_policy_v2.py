...
class InferencePolicyV2(BaseModel):
    """
    Pydantic class model representing InferencePolicyV2.

    Parameters:
        ```python
        meta: PolicyMeta
        policy: Optional[InferencePolicyDefaultsAndRulesV2]
        effective: Optional[InferencePolicyDefaultsAndRulesV2]
        effective_updated_at: datetime
        ```
        meta: See model PolicyMeta for more information.
        policy: See model InferencePolicyDefaultsAndRulesV2 for more information.
        effective: See model InferencePolicyDefaultsAndRulesV2 for more information.
    ...
    policy: Optional[InferencePolicyDefaultsAndRulesV2] = None
    effective: Optional[InferencePolicyDefaultsAndRulesV2] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferencePolicyV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferencePolicyV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "policy": (
                    InferencePolicyDefaultsAndRulesV2.from_dict(obj["policy"])
                    if obj.get("policy") is not None
                    else None
                ),
                "effective": (
                    InferencePolicyDefaultsAndRulesV2.from_dict(obj["effective"])
