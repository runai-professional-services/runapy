...
class ExtendedResourcesRules(BaseModel):
    """
    Pydantic class model representing ExtendedResourcesRules.

    Parameters:
        ```python
        attributes: Optional[ExtendedResourceRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model ExtendedResourceRules for more information.
    ...
    attributes: Optional[ExtendedResourceRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedResourcesRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtendedResourcesRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    ExtendedResourceRules.from_dict(obj["attributes"])
