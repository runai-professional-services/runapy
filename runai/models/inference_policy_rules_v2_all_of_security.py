...
class InferencePolicyRulesV2AllOfSecurity(BaseModel):
    """
    Pydantic class model representing InferencePolicyRulesV2AllOfSecurity.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferencePolicyRulesV2AllOfSecurity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferencePolicyRulesV2AllOfSecurity from a dict"""
        if obj is None:
            return None
