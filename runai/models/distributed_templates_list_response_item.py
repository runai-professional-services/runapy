...
class DistributedTemplatesListResponseItem(BaseModel):
    """
    Pydantic class model representing DistributedTemplatesListResponseItem.

    Parameters:
        ```python
        meta: TemplateMetaFields
        spec: DistributedTemplateSpec
        ...
        combined_master_spec: Optional[MasterTemplateSpec]
        compliance_issues: List[ComplianceInfoReason]
        ```
        meta: See model TemplateMetaFields for more information.
        spec: See model DistributedTemplateSpec for more information.
        ...
        combined_master_spec: See model MasterTemplateSpec for more information.
    ...
    Example:
        ...
        DistributedTemplatesListResponseItem(
            meta=runai.models.template_meta_fields.TemplateMetaFields(
                    ...
                    spec = runai.models.master_template_spec.MasterTemplateSpec(
                        annotations = [
                    ...
                    issue = 'mandatory image is not provided', ),
                        ...
                        combined_master_spec=runai.models.master_template_spec.MasterTemplateSpec(
                    annotations = [
                        runai.models.annotation.Annotation(
                            name = 'billing',
                            value = 'my-billing-unit',
    ...
    meta: TemplateMetaFields
    spec: Optional[DistributedTemplateSpec] = None
    ...
    combined_master_spec: Optional[MasterTemplateSpec] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedTemplatesListResponseItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedTemplatesListResponseItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    DistributedTemplateSpec.from_dict(obj["spec"])
                ...
                "combinedMasterSpec": (
                    MasterTemplateSpec.from_dict(obj["combinedMasterSpec"])
