...
class PVCCreationRequest(BaseModel):
    """
    Pydantic class model representing PVCCreationRequest.
    ...
    Parameters:
        ...
        spec: See model PVCAssetSpec for more information.
    Example:
        ```python
        PVCCreationRequest(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PVCCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PVCCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    PVCAssetSpec.from_dict(obj["spec"])
