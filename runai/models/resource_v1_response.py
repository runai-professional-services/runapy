...
class ResourceV1Response(BaseModel):
    """
    Pydantic class model representing ResourceV1Response.
    ...
    over_quota_weight: Optional[Union[StrictFloat, StrictInt]] = Field(
        description="The priority for over quota resources.", alias="overQuotaWeight"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResourceV1Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourceV1Response from a dict"""
        if obj is None:
            return None
