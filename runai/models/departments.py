...
class Departments(BaseModel):
    """
    Pydantic class model representing Departments.

    Parameters:
        ```python
        data: List[DepartmentsDataInner]
        time_range: TimeRange
        ```
        data: See model List[DepartmentsDataInner] for more information.
    ...
    __properties: ClassVar[List[str]] = ["data", "timeRange"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": (
                    [DepartmentsDataInner.from_dict(_item) for _item in obj["data"]]
