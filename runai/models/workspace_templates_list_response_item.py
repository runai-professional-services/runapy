...
class WorkspaceTemplatesListResponseItem(BaseModel):
    """
    Pydantic class model representing WorkspaceTemplatesListResponseItem.
    ...
    Parameters:
        ...
        combined_spec: WorkspaceTemplateSpec
        ...
        combined_spec: See model WorkspaceTemplateSpec for more information.
    ...
    combined_spec: Optional[WorkspaceTemplateSpec] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceTemplatesListResponseItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceTemplatesListResponseItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "combinedSpec": (
                    WorkspaceTemplateSpec.from_dict(obj["combinedSpec"])
