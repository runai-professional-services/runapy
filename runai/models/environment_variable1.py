...
class EnvironmentVariable1(BaseModel):
    """
    ...
    Parameters:
        ...
        value: The value of the environment variable. (mutually exclusive with secret)
    ...
    __properties: ClassVar[List[str]] = ["name", "value", "secret", "exclude"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnvironmentVariable1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnvironmentVariable1 from a dict"""
        if obj is None:
            return None
