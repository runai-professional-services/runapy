...
class DataVolumeRules(BaseModel):
    """
    Pydantic class model representing DataVolumeRules.

    Parameters:
        ```python
        id: Optional[StringRules]
        mount_path: Optional[StringRules]
        ```
        id: See model StringRules for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataVolumeRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataVolumeRules from a dict"""
        if obj is None:
            return None
