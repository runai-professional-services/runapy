...
class ImagePullSecretsDefaults(BaseModel):
    """
    Pydantic class model representing ImagePullSecretsDefaults.

    Parameters:
        ```python
        instances: Optional[List[ImagePullSecret]]
        ```
        instances: A list of references to Kubernetes secrets in the same namespace used for pulling container images.
    Example:
        ```python
    ...
    instances: Optional[List[Optional[ImagePullSecret]]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImagePullSecretsDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImagePullSecretsDefaults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "instances": (
                    [ImagePullSecret.from_dict(_item) for _item in obj["instances"]]
