...
class DepartmentProjectChild(BaseModel):
    """
    Pydantic class model representing Department or project child.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DepartmentProjectChild from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DepartmentProjectChild from a dict"""
        if obj is None:
            return None
...
DepartmentProjectChild.model_rebuild(raise_errors=False)
