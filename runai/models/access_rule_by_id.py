...
class AccessRuleById(BaseModel):
    """
    Pydantic class model representing AccessRuleById.
    ...
    Parameters:
        ...
        tenant_id: int
        created_by: str
        status: AccessRuleStatusResponse
        ...
        status: See model AccessRuleStatusResponse for more information.
        scope_path: See model str for more information.
    Example:
        ```python
        AccessRuleById(
    ...
    status: Optional[AccessRuleStatusResponse] = None
    scope_path: Optional[StrictStr] = Field(default=None, alias="scopePath")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessRuleById from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if scope_path (nullable) is None
        # and model_fields_set contains the field
        if self.scope_path is None and "scope_path" in self.model_fields_set:
            _dict["scopePath"] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessRuleById from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "status": (
                    AccessRuleStatusResponse.from_dict(obj["status"])
