...
class GenericSecretListResponse(BaseModel):
    """
    Pydantic class model representing GenericSecretListResponse.

    Parameters:
        ```python
        entries: List[GenericSecret]
        ```
        entries: See model List[GenericSecret] for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenericSecretListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenericSecretListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [GenericSecret.from_dict(_item) for _item in obj["entries"]]
