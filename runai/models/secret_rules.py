...
class SecretRules(BaseModel):
    """
    Pydantic class model representing SecretRules.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SecretRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SecretRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "secret": (
                    StringRules.from_dict(obj["secret"])
