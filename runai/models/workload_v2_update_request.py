...
class WorkloadV2UpdateRequest(BaseModel):
    """
    Pydantic class model representing WorkloadV2UpdateRequest.

    Parameters:
        ```python
        metadata: WorkloadV2MetadataUpdateParams
        manifest: Dict[str, object]
        manifest_base64_encoded: bytearray
        ```
        metadata: See model WorkloadV2MetadataUpdateParams for more information.
    ...
    metadata: Optional[WorkloadV2MetadataUpdateParams] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkloadV2UpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkloadV2UpdateRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "metadata": (
                    WorkloadV2MetadataUpdateParams.from_dict(obj["metadata"])
