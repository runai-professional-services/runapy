...
class DistributedTemplatesListResponse(BaseModel):
    """
    Pydantic class model representing DistributedTemplatesListResponse.

    Parameters:
        ```python
        entries: List[DistributedTemplatesListResponseItem]
        pagination: PaginationInfo
        ```
        entries: See model List[DistributedTemplatesListResponseItem] for more information.
    ...
    entries: Optional[List[DistributedTemplatesListResponseItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedTemplatesListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedTemplatesListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [
                        DistributedTemplatesListResponseItem.from_dict(_item)
