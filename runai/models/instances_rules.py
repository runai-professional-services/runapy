...
class InstancesRules(BaseModel):
    """
    Pydantic class model representing InstancesRules.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstancesRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstancesRules from a dict"""
        if obj is None:
            return None
