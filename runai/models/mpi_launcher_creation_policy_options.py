...
class MpiLauncherCreationPolicyOptions(BaseModel):
    """
    Pydantic class model representing MpiLauncherCreationPolicyOptions.

    Parameters:
        ```python
        options: Optional[List[MpiLauncherCreationPolicyOptionsOptionsInner]]
        ```
        options: See model List[MpiLauncherCreationPolicyOptionsOptionsInner] for more information.
    Example:
        ```python
        MpiLauncherCreationPolicyOptions(
            options=[
                    runai.models.mpi_launcher_creation_policy_options_options_inner.MpiLauncherCreationPolicyOptions_options_inner(
                        value = 'AtStartup',
    ...
    options: Optional[List[MpiLauncherCreationPolicyOptionsOptionsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MpiLauncherCreationPolicyOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MpiLauncherCreationPolicyOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "options": (
                    [
                        MpiLauncherCreationPolicyOptionsOptionsInner.from_dict(_item)
