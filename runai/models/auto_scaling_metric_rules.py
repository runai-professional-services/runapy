...
class AutoScalingMetricRules(BaseModel):
    """
    Pydantic class model representing AutoScalingMetricRules.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AutoScalingMetricRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AutoScalingMetricRules from a dict"""
        if obj is None:
            return None
