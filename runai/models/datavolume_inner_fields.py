...
class DatavolumeInnerFields(BaseModel):
    """
    Pydantic class model representing DatavolumeInnerFields.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatavolumeInnerFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatavolumeInnerFields from a dict"""
        if obj is None:
            return None
