...
class UpdateSpec(BaseModel):
    ...
    Parameters:
        ...
        spec: UpdateSpecSpec
        ```
        spec: See model UpdateSpecSpec for more information.
    Example:
        ```python
        UpdateSpec(
            spec="example"
    ...
    spec: Optional[UpdateSpecSpec] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "spec": (
                    UpdateSpecSpec.from_dict(obj["spec"])
