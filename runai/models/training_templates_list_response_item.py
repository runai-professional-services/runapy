...
class TrainingTemplatesListResponseItem(BaseModel):
    """
    Pydantic class model representing TrainingTemplatesListResponseItem.
    ...
    Parameters:
        ...
        combined_spec: TrainingTemplateSpec
        ...
        combined_spec: See model TrainingTemplateSpec for more information.
    ...
    combined_spec: Optional[TrainingTemplateSpec] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainingTemplatesListResponseItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainingTemplatesListResponseItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "combinedSpec": (
                    TrainingTemplateSpec.from_dict(obj["combinedSpec"])
