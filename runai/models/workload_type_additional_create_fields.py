...
class WorkloadTypeAdditionalCreateFields(BaseModel):
    """
    Pydantic class model representing WorkloadTypeAdditionalCreateFields.
    ...
    group: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkloadTypeAdditionalCreateFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkloadTypeAdditionalCreateFields from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"name": obj.get("name"), "group": obj.get("group")})
        return _obj
