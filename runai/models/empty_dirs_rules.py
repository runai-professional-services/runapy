...
class EmptyDirsRules(BaseModel):
    """
    Pydantic class model representing EmptyDirsRules.

    Parameters:
        ```python
        attributes: Optional[EmptyDirRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model EmptyDirRules for more information.
    ...
    attributes: Optional[EmptyDirRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmptyDirsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmptyDirsRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    EmptyDirRules.from_dict(obj["attributes"])
