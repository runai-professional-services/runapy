...
class WorkloadV2SyncInfo(BaseModel):
    """
    Pydantic class model representing WorkloadV2SyncInfo.

    Parameters:
        ```python
        status: WorkloadV2SyncStatus
        message: str
        ```
        status: See model WorkloadV2SyncStatus for more information.
    ...
    status: WorkloadV2SyncStatus
    message: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkloadV2SyncInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkloadV2SyncInfo from a dict"""
        if obj is None:
            return None
