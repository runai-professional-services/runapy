...
class WorkspaceTemplate(BaseModel):
    ...
    Parameters:
        ...
        combined_spec: WorkspaceSpecSpec
        ```
        ...
        combined_spec: See model WorkspaceSpecSpec for more information.
    Example:
        ```python
        WorkspaceTemplate(
    ...
    combined_spec: Optional[WorkspaceSpecSpec] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "combinedSpec": (
                    WorkspaceSpecSpec.from_dict(obj["combinedSpec"])
