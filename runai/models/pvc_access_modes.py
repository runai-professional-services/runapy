...
class PvcAccessModes(BaseModel):
    """
    Pydantic class model representing Requested access mode(s) for the newly created PVC..
    ...
    Parameters:
        ...
        ```
        read_write_once: Requesting claim that can be mounted in read/write mode to exactly one host. This is the default access mode. - Default: True
        read_only_many: Requesting claim that can be mounted in read-only mode to many hosts. - Default: False
        read_write_many: Requesting claim that can be mounted in read/write mode to many hosts. - Default: False
    Example:
        ```python
        PvcAccessModes(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PvcAccessModes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PvcAccessModes from a dict"""
        if obj is None:
            return None
