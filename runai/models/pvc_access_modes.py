...
class PvcAccessModes(BaseModel):
    """
    Pydantic class model representing Default access mode(s) applied to newly created PVCs unless explicitly overridden..
    ...
    Parameters:
        ...
        ```
        read_write_once: Mount the volume as read/write by a single node. - Default: True
        read_only_many: Mount the volume as read-only by many nodes. - Default: False
        read_write_many: Mount the volume as read/write by many nodes. - Default: False
    Example:
        ```python
        PvcAccessModes(
