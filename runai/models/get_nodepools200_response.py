...
class GetNodepools200Response(BaseModel):
    """
    Pydantic class model representing GetNodepools200Response.

    Parameters:
        ```python
        nodepools: List[Nodepool]
        ```
        nodepools: See model List[Nodepool] for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetNodepools200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNodepools200Response from a dict"""
        if obj is None:
            return None
