...
class TelemetryResponse(BaseModel):
    """
    Pydantic class model representing TelemetryResponse.

    Parameters:
        ```python
        type: str
        timestamp: datetime
        values: List[TelemetryResponseValuesInner]
        ```
        type: specifies what data returned
        timestamp: See model datetime for more information.
        values: See model List[TelemetryResponseValuesInner] for more information.
    Example:
        ```python
        TelemetryResponse(
    ...
    timestamp: datetime
    values: List[TelemetryResponseValuesInner]
    __properties: ClassVar[List[str]] = ["type", "timestamp", "values"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TelemetryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TelemetryResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "values": (
                    [
                        TelemetryResponseValuesInner.from_dict(_item)
