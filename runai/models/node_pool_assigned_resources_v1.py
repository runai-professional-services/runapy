...
class NodePoolAssignedResourcesV1(BaseModel):
    """
    Pydantic class model representing NodePoolAssignedResourcesV1.

    Parameters:
        ```python
        id: float
        node_pool: NodePoolAssignedResourcesV1ResponseNodePool
        gpu: NonNullResourceV1
        cpu: ResourceV1
        memory: ResourceV1
        ```
    ...
    gpu: Optional[NonNullResourceV1] = Field(
        default=None, description="Number of GPUs assigned in the node pool."
    )
    cpu: Optional[ResourceV1] = Field(
        default=None,
    ...
    memory: Optional[ResourceV1] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodePoolAssignedResourcesV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodePoolAssignedResourcesV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "gpu": (
                    NonNullResourceV1.from_dict(obj["gpu"])
                    if obj.get("gpu") is not None
                    else None
                ),
                "cpu": (
                    ResourceV1.from_dict(obj["cpu"])
                    if obj.get("cpu") is not None
                    else None
                ),
                "memory": (
                    ResourceV1.from_dict(obj["memory"])
