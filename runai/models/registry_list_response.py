...
class RegistryListResponse(BaseModel):
    """
    Pydantic class model representing RegistryListResponse.

    Parameters:
        ```python
        entries: List[Registry]
        ```
        entries: See model List[Registry] for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegistryListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegistryListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [Registry.from_dict(_item) for _item in obj["entries"]]
