...
class ContainerNonOverridable(BaseModel):
    """
    Pydantic class model representing Container non overrideable fields. In the context of assets,these are environment asset fields that cannot be overriden in the submit workload request..
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContainerNonOverridable from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContainerNonOverridable from a dict"""
        if obj is None:
            return None
