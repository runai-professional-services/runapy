...
class GetProjects200Response(BaseModel):
    ...
    Parameters:
        ```python
        projects: List[GetProjects200ResponseProjectsInner]
        next: int
        ```
        projects: See model List[GetProjects200ResponseProjectsInner] for more information.
    ...
    projects: Optional[List[GetProjects200ResponseProjectsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                "projects": (
                    [
                        GetProjects200ResponseProjectsInner.from_dict(_item)
