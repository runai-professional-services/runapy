...
class EnvironmentVariableOfAsset(BaseModel):
    ...
    Parameters:
        ...
        value: The value of the environment variable. (mutually exclusive with credential)
    ...
    value: Optional[StrictStr] = Field(
        default=None,
        description="The value of the environment variable. (mutually exclusive with credential)",
    )
