...
class DistributedInferenceLeaderWorkerSpec1Storage(BaseModel):
    """
    Pydantic class model representing DistributedInferenceLeaderWorkerSpec1Storage.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedInferenceLeaderWorkerSpec1Storage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedInferenceLeaderWorkerSpec1Storage from a dict"""
        if obj is None:
            return None
