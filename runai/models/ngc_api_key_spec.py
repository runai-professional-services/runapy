...
class NgcApiKeySpec(BaseModel):
    """
    Pydantic class model representing NgcApiKeySpec.
    ...
    __properties: ClassVar[List[str]] = ["ngc_api_key", "keyId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NgcApiKeySpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NgcApiKeySpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"ngc_api_key": obj.get("ngc_api_key"), "keyId": obj.get("keyId")}
        )
        return _obj
