...
class DockerRegistryListResponse(BaseModel):
    """
    Pydantic class model representing DockerRegistryListResponse.

    Parameters:
        ```python
        entries: List[DockerRegistry]
        ```
        entries: See model List[DockerRegistry] for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DockerRegistryListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DockerRegistryListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [DockerRegistry.from_dict(_item) for _item in obj["entries"]]
