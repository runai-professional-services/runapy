...
class RegenerateAccessKeySecret200Response(BaseModel):
    """
    Pydantic class model representing RegenerateAccessKeySecret200Response.

    Parameters:
        ```python
        client_secret: str
        ```
        client_secret: Secret credential paired with the client ID. Used to obtain authentication tokens.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegenerateAccessKeySecret200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegenerateAccessKeySecret200Response from a dict"""
        if obj is None:
            return None
