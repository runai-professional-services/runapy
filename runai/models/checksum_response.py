...
class ChecksumResponse(BaseModel):
    """
    Pydantic class model representing ChecksumResponse.
    ...
    Parameters:
        ...
        md5_hash: See model str for more information.
        crc32c: See model str for more information.
    Example:
        ```python
        ChecksumResponse(
            description='',
    ...
    __properties: ClassVar[List[str]] = ["description", "md5Hash", "crc32c"]
