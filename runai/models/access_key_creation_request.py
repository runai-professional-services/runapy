...
class AccessKeyCreationRequest(BaseModel):
    """
    Pydantic class model representing AccessKeyCreationRequest.
    ...
    Parameters:
        ...
        spec: See model AccessKeyCreationSpec for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessKeyCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessKeyCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    AccessKeyCreationSpec.from_dict(obj["spec"])
