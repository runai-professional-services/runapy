...
class ConfigMapListResponse(BaseModel):
    """
    Pydantic class model representing ConfigMapListResponse.

    Parameters:
        ```python
        entries: List[ConfigMapAsset]
        ```
        entries: See model List[ConfigMapAsset] for more information.
    Example:
        ```python
        ConfigMapListResponse(
            entries=[
                    runai.models.config_map_asset.ConfigMapAsset(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigMapListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigMapListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [ConfigMapAsset.from_dict(_item) for _item in obj["entries"]]
