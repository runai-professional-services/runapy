...
class ResourcesNullable(BaseModel):
    """
    Pydantic class model representing ResourcesNullable.

    Parameters:
        ```python
        node_pool: Optional[ResourcesNodePool]
        gpu: ResourcesNullableGpu
        cpu: Optional[ResourcesCpu]
        memory: Optional[ResourcesMemory]
        priority: Optional[str]
        ```
        node_pool: See model ResourcesNodePool for more information.
        gpu: See model ResourcesNullableGpu for more information.
    ...
    gpu: Optional[ResourcesNullableGpu] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResourcesNullable from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourcesNullable from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "gpu": (
                    ResourcesNullableGpu.from_dict(obj["gpu"])
