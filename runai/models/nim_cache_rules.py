...
class NimCacheRules(BaseModel):
    """
    Pydantic class model representing NimCacheRules.

    Parameters:
        ```python
        name: Optional[StringRules]
        profile: Optional[StringRules]
        ```
        name: See model StringRules for more information.
        profile: See model StringRules for more information.
    Example:
        ```python
        NimCacheRules(
    ...
    profile: Optional[StringRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NimCacheRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NimCacheRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "profile": (
                    StringRules.from_dict(obj["profile"])
