...
class Department1Metadata(BaseModel):
    """
    Pydantic class model representing Department1Metadata.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Department1Metadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Department1Metadata from a dict"""
        if obj is None:
            return None
