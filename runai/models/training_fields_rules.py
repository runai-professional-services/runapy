...
class TrainingFieldsRules(BaseModel):
    """
    Pydantic class model representing TrainingFieldsRules.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainingFieldsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainingFieldsRules from a dict"""
        if obj is None:
            return None
