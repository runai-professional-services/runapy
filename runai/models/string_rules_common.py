...
class StringRulesCommon(BaseModel):
    """
    Pydantic class model representing StringRulesCommon.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StringRulesCommon from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StringRulesCommon from a dict"""
        if obj is None:
            return None
