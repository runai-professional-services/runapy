...
class GitsRules(BaseModel):
    """
    Pydantic class model representing GitsRules.

    Parameters:
        ```python
        attributes: Optional[GitRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model GitRules for more information.
    ...
    attributes: Optional[GitRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitsRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    GitRules.from_dict(obj["attributes"])
