...
class ServingPortExposedProtocolOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing ServingPortExposedProtocolOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[ServingPortExposedProtocol]
        displayed: Optional[str]
        ```
        value: See model ServingPortExposedProtocol for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServingPortExposedProtocolOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServingPortExposedProtocolOptionsOptionsInner from a dict"""
        if obj is None:
            return None
