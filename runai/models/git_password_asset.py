...
class GitPasswordAsset(BaseModel):
    """
    Pydantic class model representing GitPasswordAsset.
    ...
    __properties: ClassVar[List[str]] = ["passwordAssetId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitPasswordAsset from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitPasswordAsset from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"passwordAssetId": obj.get("passwordAssetId")})
        return _obj
