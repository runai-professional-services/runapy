...
class WorkloadDetailed(BaseModel):
    ...
    Parameters:
        ...
        topology: Optional[WorkloadTopology]
        ...
        topology: See model WorkloadTopology for more information.
        ...
        WorkloadDetailed(
            tenant_id=1001,
                    ...
                    'key' : ''
                        ...
                        topology=runai.models.workload_topology.Workload_topology(
                    name = '',
                    preferred_placement = '',
                    required_placement = '', ),
    ...
    topology: Optional[WorkloadTopology] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "topology": (
                    WorkloadTopology.from_dict(obj["topology"])
