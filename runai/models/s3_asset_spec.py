...
class S3AssetSpec(BaseModel):
    """
    Pydantic class model representing S3AssetSpec.
    ...
    __properties: ClassVar[List[str]] = ["bucket", "path", "url", "accessKeyAssetId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of S3AssetSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of S3AssetSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "path": obj.get("path"),
                "url": obj.get("url"),
                "accessKeyAssetId": obj.get("accessKeyAssetId"),
            }
        )
        return _obj
