...
class GetAuditLogs1200Response(BaseModel):
    """
    Pydantic class model representing GetAuditLogs1200Response.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAuditLogs1200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAuditLogs1200Response from a dict"""
        if obj is None:
            return None
