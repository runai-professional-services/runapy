...
class EnvironmentListResponse(BaseModel):
    """
    Pydantic class model representing EnvironmentListResponse.

    Parameters:
        ```python
        entries: List[EnvironmentAsset]
        ```
        entries: See model List[EnvironmentAsset] for more information.
    Example:
        ```python
        EnvironmentListResponse(
            entries=[
                    runai.models.environment_asset.EnvironmentAsset(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [EnvironmentAsset.from_dict(_item) for _item in obj["entries"]]
