...
class DeservedResource(BaseModel):
    """
    Pydantic class model representing DeservedResource.
    ...
    __properties: ClassVar[List[str]] = ["deserved"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeservedResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeservedResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"deserved": obj.get("deserved")})
        return _obj
