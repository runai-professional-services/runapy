...
class AssetPhaseUpdate(BaseModel):
    """
    Pydantic class model representing AssetPhaseUpdate.
    ...
    phase: StrictStr
    phase_message: StrictStr = Field(alias="phaseMessage")
    __properties: ClassVar[List[str]] = ["phase", "phaseMessage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetPhaseUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetPhaseUpdate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"phase": obj.get("phase"), "phaseMessage": obj.get("phaseMessage")}
        )
        return _obj
