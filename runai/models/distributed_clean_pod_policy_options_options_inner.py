...
class DistributedCleanPodPolicyOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing DistributedCleanPodPolicyOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[DistributedCleanPodPolicy]
        displayed: Optional[str]
        ```
        value: See model DistributedCleanPodPolicy for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedCleanPodPolicyOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedCleanPodPolicyOptionsOptionsInner from a dict"""
        if obj is None:
            return None
