...
class PVCListResponse(BaseModel):
    """
    Pydantic class model representing PVCListResponse.

    Parameters:
        ```python
        entries: List[PVCAsset]
        ```
        entries: See model List[PVCAsset] for more information.
    Example:
        ```python
        PVCListResponse(
            entries=[
                    runai.models.pvc_asset.PVCAsset(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PVCListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PVCListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [PVCAsset.from_dict(_item) for _item in obj["entries"]]
