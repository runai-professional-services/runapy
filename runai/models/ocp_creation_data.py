...
class OcpCreationData(BaseModel):
    """
        Pydantic class model representing OcpCreationData.
        ...
        Parameters:
            ...
            idp_base_url: See model str for more information.
    ...
    idp_base_url: Annotated[str, Field(strict=True)] = Field(alias="idpBaseUrl")
    ...
    def idp_base_url_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OcpCreationData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OcpCreationData from a dict"""
        if obj is None:
            return None
