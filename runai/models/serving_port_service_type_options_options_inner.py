...
class ServingPortServiceTypeOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing ServingPortServiceTypeOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[ServingPortServiceType]
        displayed: Optional[str]
        ```
        value: See model ServingPortServiceType for more information. - Default: ServingPortServiceType.CLUSTERIP
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServingPortServiceTypeOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServingPortServiceTypeOptionsOptionsInner from a dict"""
        if obj is None:
            return None
