...
class S3UpdateRequest(BaseModel):
    """
    Pydantic class model representing S3UpdateRequest.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of S3UpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of S3UpdateRequest from a dict"""
        if obj is None:
            return None
