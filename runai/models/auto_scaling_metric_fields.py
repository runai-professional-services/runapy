...
class AutoScalingMetricFields(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metric", "metricThreshold"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AutoScalingMetricFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AutoScalingMetricFields from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"metric": obj.get("metric"), "metricThreshold": obj.get("metricThreshold")}
        )
        return _obj
