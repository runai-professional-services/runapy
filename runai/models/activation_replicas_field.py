...
class ActivationReplicasField(BaseModel):
    """
    Pydantic class model representing ActivationReplicasField.
    ...
    __properties: ClassVar[List[str]] = ["activationReplicas"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActivationReplicasField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActivationReplicasField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"activationReplicas": obj.get("activationReplicas")})
        return _obj
