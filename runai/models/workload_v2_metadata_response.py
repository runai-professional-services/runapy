...
class WorkloadV2MetadataResponse(BaseModel):
    """
    Pydantic class model representing WorkloadV2MetadataResponse.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkloadV2MetadataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkloadV2MetadataResponse from a dict"""
        if obj is None:
            return None
