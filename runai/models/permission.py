...
class Permission(BaseModel):
    """
    Pydantic class model representing Permission.
    ...
    Parameters:
        ...
        group_id: See model ResourceTypeGroupId for more information.
        actions: See model List[Action] for more information.
    Example:
        ```python
        Permission(
    ...
    group_id: ResourceTypeGroupId = Field(alias="groupId")
    actions: List[Action]
