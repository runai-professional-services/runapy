...
class S3Common(BaseModel):
    """
    Pydantic class model representing S3Common.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of S3Common from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of S3Common from a dict"""
        if obj is None:
            return None
