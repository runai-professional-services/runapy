...
class ProbesRules(BaseModel):
    """
    Pydantic class model representing ProbesRules.

    Parameters:
        ```python
        readiness: Optional[ProbeRules]
        ```
        readiness: See model ProbeRules for more information.
    Example:
        ```python
        ProbesRules(
    ...
    readiness: Optional[ProbeRules] = None
    __properties: ClassVar[List[str]] = ["readiness"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProbesRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProbesRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "readiness": (
                    ProbeRules.from_dict(obj["readiness"])
                    if obj.get("readiness") is not None
                    else None
                )
            }
        )
