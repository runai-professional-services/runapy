...
class CleanPodPolicyOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing CleanPodPolicyOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[CleanPodPolicy]
        displayed: Optional[str]
        ```
        value: See model CleanPodPolicy for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CleanPodPolicyOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CleanPodPolicyOptionsOptionsInner from a dict"""
        if obj is None:
            return None
