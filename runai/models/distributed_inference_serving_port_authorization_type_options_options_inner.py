...
class DistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing DistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[DistributedInferenceServingPortAccessAuthorizationTypeEnum]
        displayed: Optional[str]
        ```
        value: See model DistributedInferenceServingPortAccessAuthorizationTypeEnum for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner from a dict"""
        if obj is None:
            return None
