...
class NfssDefaults(BaseModel):
    """
    Pydantic class model representing NfssDefaults.

    Parameters:
        ```python
        attributes: Optional[NfsInstance]
        instances: Optional[List[NfsInstance]]
        ```
        attributes: See model NfsInstance for more information.
        instances: Set of nfs volumes to use in the workload.
    Example:
        ```python
        NfssDefaults(
    ...
    attributes: Optional[NfsInstance] = None
    instances: Optional[List[Optional[NfsInstance]]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NfssDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NfssDefaults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    NfsInstance.from_dict(obj["attributes"])
                    if obj.get("attributes") is not None
                    else None
                ),
                "instances": (
                    [NfsInstance.from_dict(_item) for _item in obj["instances"]]
