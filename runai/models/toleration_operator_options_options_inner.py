...
class TolerationOperatorOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing TolerationOperatorOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[TolerationOperator]
        displayed: Optional[str]
        ```
        value: See model TolerationOperator for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TolerationOperatorOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TolerationOperatorOptionsOptionsInner from a dict"""
        if obj is None:
            return None
