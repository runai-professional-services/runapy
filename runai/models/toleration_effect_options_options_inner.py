...
class TolerationEffectOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing TolerationEffectOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[TolerationEffect]
        displayed: Optional[str]
        ```
        value: See model TolerationEffect for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TolerationEffectOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TolerationEffectOptionsOptionsInner from a dict"""
        if obj is None:
            return None
