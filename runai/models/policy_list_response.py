...
class PolicyListResponse(BaseModel):
    """
    Pydantic class model representing PolicyListResponse.

    Parameters:
        ```python
        policies: List[PolicyListEntry]
        ```
        policies: See model List[PolicyListEntry] for more information.
    Example:
        ```python
        PolicyListResponse(
            policies=[
                    runai.models.policy_list_entry.PolicyListEntry(
                        type = 'workspace',
                        meta = null,
    ...
    policies: Optional[List[Optional[PolicyListEntry]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "policies": (
                    [PolicyListEntry.from_dict(_item) for _item in obj["policies"]]
