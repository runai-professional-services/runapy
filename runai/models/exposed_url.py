...
class ExposedUrl(BaseModel):
    ...
    Parameters:
        ...
        authorization_type: See model AuthorizationType for more information.
        ...
        exclude: Use &#39;true&#39; in case the instance is defined in defaults of the policy, and you wish to exclude it from the workload.
    Example:
        ```python
        ExposedUrl(
            container=8080,
    ...
    tool_type: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None,
        description="The tool type that runs on this container port.",
        alias="toolType",
    )
    tool_name: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None,
    ...
    def tool_type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
