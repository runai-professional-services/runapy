...
class DistributedMpiLauncherCreationPolicyOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing DistributedMpiLauncherCreationPolicyOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[DistributedMpiLauncherCreationPolicy]
        displayed: Optional[str]
        ```
        value: See model DistributedMpiLauncherCreationPolicy for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedMpiLauncherCreationPolicyOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedMpiLauncherCreationPolicyOptionsOptionsInner from a dict"""
        if obj is None:
            return None
