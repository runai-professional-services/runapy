...
class UserCreationRequest1(BaseModel):
    """
    Pydantic class model representing UserCreationRequest1.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserCreationRequest1 from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if reset_password (nullable) is None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserCreationRequest1 from a dict"""
        if obj is None:
            return None
