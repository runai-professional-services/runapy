...
class NodeFilterSortFields(str, Enum):
    """
    ...
    Example:
        ```python
        NodeFilterSortFields.NAME
        NodeFilterSortFields.STATUS
        NodeFilterSortFields.NODEPOOL
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NodeFilterSortFields from a JSON string"""
