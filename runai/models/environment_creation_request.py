...
class EnvironmentCreationRequest(BaseModel):
    """
    Pydantic class model representing EnvironmentCreationRequest.
    ...
    Parameters:
        ...
        spec: See model EnvironmentAssetSpec for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnvironmentCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnvironmentCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    EnvironmentAssetSpec.from_dict(obj["spec"])
