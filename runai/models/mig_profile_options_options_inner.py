...
class MigProfileOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing MigProfileOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[MigProfile]
        displayed: Optional[str]
        ```
        value: See model MigProfile for more information.
        displayed: Textual description of the value
    Example:
        ```python
        MigProfileOptionsOptionsInner(
            value='1g.5gb',
                        displayed=''
        )
        ```
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MigProfileOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MigProfileOptionsOptionsInner from a dict"""
        if obj is None:
            return None
