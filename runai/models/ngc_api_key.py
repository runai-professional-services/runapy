...
class NgcApiKey(BaseModel):
    """
    Pydantic class model representing NgcApiKey.
    ...
    Parameters:
        ...
        spec: See model NgcApiKeySpec for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NgcApiKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NgcApiKey from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    NgcApiKeySpec.from_dict(obj["spec"])
