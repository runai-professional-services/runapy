...
class SubmitWithTemplateId(BaseModel):
    """
    Pydantic class model representing SubmitWithTemplateId.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmitWithTemplateId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmitWithTemplateId from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"templateId": obj.get("templateId")})
        return _obj
