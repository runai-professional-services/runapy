...
class TrainingTemplatePatchRequest(BaseModel):
    """
    Pydantic class model representing TrainingTemplatePatchRequest.
    ...
    Parameters:
        ...
        spec: See model TrainingTemplateSpec for more information.
    Example:
        ```python
    ...
    spec: Optional[TrainingTemplateSpec] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainingTemplatePatchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainingTemplatePatchRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    TrainingTemplateSpec.from_dict(obj["spec"])
