...
class SecretsDefaults(BaseModel):
    ...
    Parameters:
        ```python
        attributes: Optional[SecretInstance]
        instances: Optional[List[SecretInstance1]]
        ```
        attributes: See model SecretInstance for more information.
    ...
    attributes: Optional[SecretInstance] = None
    instances: Optional[List[Optional[SecretInstance1]]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    SecretInstance.from_dict(obj["attributes"])
                    if obj.get("attributes") is not None
                    else None
                ),
                "instances": (
                    [SecretInstance1.from_dict(_item) for _item in obj["instances"]]
