...
class Annotation(BaseModel):
    """
    Pydantic class model representing Annotation details to be populated into the container..
    ...
    Parameters:
        ...
        ```
        name: The name of the annotation (mandatory)
        value: The value of the annotation.
        exclude: Use &#39;true&#39; in case the annotation is defined in defaults of the policy, and you wish to exclude it from the workload. - Default: False
    Example:
        ```python
        Annotation(
            name='billing',
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=63)]] = (
        Field(default=None, description="The name of the annotation (mandatory)")
    )
    value: Optional[StrictStr] = Field(
        default=None, description="The value of the annotation."
    )
