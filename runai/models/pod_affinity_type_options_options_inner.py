...
class PodAffinityTypeOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing PodAffinityTypeOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[PodAffinityType]
        displayed: Optional[str]
        ```
        value: See model PodAffinityType for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PodAffinityTypeOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PodAffinityTypeOptionsOptionsInner from a dict"""
        if obj is None:
            return None
