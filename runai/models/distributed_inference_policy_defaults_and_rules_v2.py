...
class DistributedInferencePolicyDefaultsAndRulesV2(BaseModel):
    """
    Pydantic class model representing DistributedInferencePolicyDefaultsAndRulesV2.

    Parameters:
        ```python
        defaults: Optional[DistributedInferenceDefaultsV2]
        rules: Optional[DistributedInferenceRulesV2]
        imposed_assets: Optional[DistributedInferenceImposedAssets]
        status: Optional[PolicyValidationStatus]
        ```
        defaults: See model DistributedInferenceDefaultsV2 for more information.
        rules: See model DistributedInferenceRulesV2 for more information.
        imposed_assets: See model DistributedInferenceImposedAssets for more information.
    ...
    defaults: Optional[DistributedInferenceDefaultsV2] = None
    rules: Optional[DistributedInferenceRulesV2] = None
    imposed_assets: Optional[DistributedInferenceImposedAssets] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedInferencePolicyDefaultsAndRulesV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedInferencePolicyDefaultsAndRulesV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "defaults": (
                    DistributedInferenceDefaultsV2.from_dict(obj["defaults"])
                    if obj.get("defaults") is not None
                    else None
                ),
                "rules": (
                    DistributedInferenceRulesV2.from_dict(obj["rules"])
                    if obj.get("rules") is not None
                    else None
                ),
                "imposedAssets": (
                    DistributedInferenceImposedAssets.from_dict(obj["imposedAssets"])
