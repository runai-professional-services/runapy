...
class WorkloadTemplate(BaseModel):
    """
    Pydantic class model representing WorkloadTemplate.
    ...
    Parameters:
        ...
        spec: See model SpecificRunInfoFields for more information.
    Example:
        ```python
        WorkloadTemplate(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkloadTemplate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkloadTemplate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    SpecificRunInfoFields.from_dict(obj["spec"])
