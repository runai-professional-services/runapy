...
class NodepoolSortFilterFields(str, Enum):
    """
    ...
    NODELEVELSCHEDULERENABLED = 'nodeLevelSchedulerEnabled'


    Example:
        ```python
        NodepoolSortFilterFields.NAME
        NodepoolSortFilterFields.PHASE
        ...
        NodepoolSortFilterFields.SWAPENABLED
        NodepoolSortFilterFields.NODELEVELSCHEDULERENABLED
        ```
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NodepoolSortFilterFields from a JSON string"""
