...
class PaginationInfo(BaseModel):
    """
    Pydantic class model representing PaginationInfo.
    ...
    Parameters:
        ...
        next_offset: float
        ```
        limit: the number of entries included in this bulk of entries
        offset: the first entry that was requested to be included in this bulk
        next_offset: the offset of the next bulk of entries
    Example:
        ```python
        PaginationInfo(
            limit=1.337,
    ...
    limit: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="the number of entries included in this bulk of entries",
    )
    offset: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="the first entry that was requested to be included in this bulk",
    )
    next_offset: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="the offset of the next bulk of entries",
        alias="nextOffset",
    )
    __properties: ClassVar[List[str]] = ["limit", "offset", "nextOffset"]
