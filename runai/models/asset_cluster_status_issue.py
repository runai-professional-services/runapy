...
class AssetClusterStatusIssue(BaseModel):
    """
    Pydantic class model representing AssetClusterStatusIssue.
    ...
    Parameters:
        ...
        issue: See model AssetClusterStatusIssueEnum for more information.
    Example:
        ```python
    ...
    issue: AssetClusterStatusIssueEnum
    __properties: ClassVar[List[str]] = ["scopeId", "scopeType", "issue"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetClusterStatusIssue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetClusterStatusIssue from a dict"""
        if obj is None:
            return None
