...
class AccessKeysAdministration(BaseModel):
    """
    Pydantic class model representing AccessKeysAdministration.

    Parameters:
        ```python
        access_keys: List[AccessKeyAdministration]
        ```
        access_keys: See model List[AccessKeyAdministration] for more information.
    Example:
        ```python
        AccessKeysAdministration(
            access_keys=[
                    {"name":"my-access-key","id":"3434c-12323ab-4ce2ea6-b44fc-db344d","clientId":"1434c-123233ab-4ce2ea6-b44fc-db344d","createdBy":"test@run.ai","createdAt":"2020-01-01T00:00:00Z","lastLogin":"2020-01-01T00:00:00Z"}
                    ]
        )
        ```
    """  # noqa: E501

    access_keys: List[AccessKeyAdministration] = Field(alias="accessKeys")
    __properties: ClassVar[List[str]] = ["accessKeys"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessKeysAdministration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessKeysAdministration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "accessKeys": (
                    [
                        AccessKeyAdministration.from_dict(_item)
                        for _item in obj["accessKeys"]
                    ]
