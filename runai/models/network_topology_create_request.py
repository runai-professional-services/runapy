...
class NetworkTopologyCreateRequest(BaseModel):
    """
    Pydantic class model representing NetworkTopologyCreateRequest.
    ...
    __properties: ClassVar[List[str]] = ["levels", "name", "clusterId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetworkTopologyCreateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetworkTopologyCreateRequest from a dict"""
        if obj is None:
            return None
