...
class MasterTemplateSpec(BaseModel):
    """
    Pydantic class model representing MasterTemplateSpec.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MasterTemplateSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MasterTemplateSpec from a dict"""
        if obj is None:
            return None
