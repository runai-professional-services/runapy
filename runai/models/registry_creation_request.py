...
class RegistryCreationRequest(BaseModel):
    """
    Pydantic class model representing RegistryCreationRequest.
    ...
    Parameters:
        ...
        spec: See model RegistrySpec for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegistryCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegistryCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    RegistrySpec.from_dict(obj["spec"])
