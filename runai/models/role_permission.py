...
class RolePermission(BaseModel):
    """
    Pydantic class model representing RolePermission.
    ...
    Parameters:
        ...
        actions: See model List[PermissionAction] for more information.
    Example:
        ```python
        RolePermission(
    ...
    actions: List[PermissionAction]
    __properties: ClassVar[List[str]] = ["resourceType", "actions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"resourceType": obj.get("resourceType"), "actions": obj.get("actions")}
        )
        return _obj
