...
class HistoryRecord1(BaseModel):
    """
    Pydantic class model representing HistoryRecord1.

    Parameters:
        ```python
        meta: HistoryRecordMeta
        spec: HistoryRecord1Spec
        ```
        meta: See model HistoryRecordMeta for more information.
        spec: See model HistoryRecord1Spec for more information.
    Example:
        ```python
        HistoryRecord1(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HistoryRecord1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HistoryRecord1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "meta": (
                    HistoryRecordMeta.from_dict(obj["meta"])
                    if obj.get("meta") is not None
                    else None
                ),
                "spec": (
                    HistoryRecord1Spec.from_dict(obj["spec"])
