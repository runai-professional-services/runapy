...
class LogoutRedirectUriSetting(BaseModel):
    """
    Pydantic class model representing Settings for configuring the logout redirect URI that determines where users are redirected after logging out..

    Parameters:
        ```python
        uri: Optional[str]
        ```
        uri: The URI where users will be redirected after logging out of the application
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LogoutRedirectUriSetting from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LogoutRedirectUriSetting from a dict"""
        if obj is None:
            return None
