...
class TolerationsRules(BaseModel):
    """
    Pydantic class model representing TolerationsRules.

    Parameters:
        ```python
        attributes: Optional[TolerationRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model TolerationRules for more information.
    ...
    attributes: Optional[TolerationRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TolerationsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TolerationsRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    TolerationRules.from_dict(obj["attributes"])
