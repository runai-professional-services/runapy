...
class EnvironmentVariable(BaseModel):
    ...
    Parameters:
        ...
        user_credential: Optional[EnvironmentVariableUserCredential]
        exclude: Optional[bool]
        description: Optional[str]
        ```
        name: The name of the environment variable. (mandatory)
        value: The value of the environment variable. (mutually exclusive with secret, userCredential, configMap and podFieldRef)
        ...
        user_credential: See model EnvironmentVariableUserCredential for more information.
    ...
    user_credential: Optional[EnvironmentVariableUserCredential] = Field(
        default=None, alias="userCredential"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "userCredential": (
                    EnvironmentVariableUserCredential.from_dict(obj["userCredential"])
                    if obj.get("userCredential") is not None
                    else None
                ),
