...
class CompletionsField(BaseModel):
    """
    Pydantic class model representing CompletionsField.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompletionsField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompletionsField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"completions": obj.get("completions")})
        return _obj
