...
class WorkloadTopology(BaseModel):
    """
    Pydantic class model representing WorkloadTopology.
    ...
    Parameters:
        ...
        preferred_placement: See model str for more information.
        required_placement: See model str for more information.
    Example:
        ```python
        WorkloadTopology(
            name='',
    ...
    preferred_placement: Optional[StrictStr] = Field(
        default=None, alias="preferredPlacement"
    )
    required_placement: Optional[StrictStr] = Field(
        default=None, alias="requiredPlacement"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkloadTopology from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkloadTopology from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "name": obj.get("name"),
                "preferredPlacement": obj.get("preferredPlacement"),
                "requiredPlacement": obj.get("requiredPlacement"),
            }
        )
        return _obj
