...
class ScaleToZeroRetentionField(BaseModel):
    """
    Pydantic class model representing ScaleToZeroRetentionField.
    ...
    __properties: ClassVar[List[str]] = ["scaleToZeroRetentionSeconds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScaleToZeroRetentionField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScaleToZeroRetentionField from a dict"""
        if obj is None:
            return None
