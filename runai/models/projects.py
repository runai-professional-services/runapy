...
class Projects(BaseModel):
    """
    Pydantic class model representing Projects.

    Parameters:
        ```python
        data: List[ProjectsDataInner]
        time_range: TimeRange
        ```
        data: See model List[ProjectsDataInner] for more information.
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": (
                    [ProjectsDataInner.from_dict(_item) for _item in obj["data"]]
