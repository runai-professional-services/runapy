...
class Secret4(BaseModel):
    """
    Pydantic class model representing Secret4.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Secret4 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Secret4 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"secret": obj.get("secret"), "mountPath": obj.get("mountPath")}
        )
        return _obj
