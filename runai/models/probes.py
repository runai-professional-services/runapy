...
class Probes(BaseModel):
    """
    Pydantic class model representing Probes are used to determine if the container is healthy and ready to accept traffic..

    Parameters:
        ```python
        readiness: Optional[Probe]
        ```
        readiness: See model Probe for more information.
    Example:
        ```python
        Probes(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Probes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Probes from a dict"""
        if obj is None:
            return None
