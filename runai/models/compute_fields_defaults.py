...
class ComputeFieldsDefaults(BaseModel):
    """
    Pydantic class model representing ComputeFieldsDefaults.
    ...
    Parameters:
        ...
        extended_resources: Optional[ExtendedResourcesDefaults]
        ```
        gpu_devices_request: Requested number of GPU devices. Currently if more than one device is requested, it is not possible to provide values for gpuMemory/migProfile/gpuPortion.
        ...
        extended_resources: See model ExtendedResourcesDefaults for more information.
    Example:
        ```python
    ...
    extended_resources: Optional[ExtendedResourcesDefaults] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ComputeFieldsDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ComputeFieldsDefaults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "extendedResources": (
                    ExtendedResourcesDefaults.from_dict(obj["extendedResources"])
