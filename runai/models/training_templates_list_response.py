...
class TrainingTemplatesListResponse(BaseModel):
    """
    Pydantic class model representing TrainingTemplatesListResponse.

    Parameters:
        ```python
        entries: List[TrainingTemplatesListResponseItem]
        pagination: PaginationInfo
        ```
        entries: See model List[TrainingTemplatesListResponseItem] for more information.
    ...
    entries: Optional[List[TrainingTemplatesListResponseItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainingTemplatesListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainingTemplatesListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [
                        TrainingTemplatesListResponseItem.from_dict(_item)
