...
class InferencePolicyDefaultsV2(BaseModel):
    """
    Pydantic class model representing InferencePolicyDefaultsV2.
    ...
    Parameters:
        ...
        storage: Optional[InferencePolicyDefaultsV2AllOfStorage]
        ...
        storage: See model InferencePolicyDefaultsV2AllOfStorage for more information.
        ...
        InferencePolicyDefaultsV2(
            autoscaling=runai.models.auto_scaling.AutoScaling(),
                    ...
                    uid_gid_source = 'fromTheImage', ),
                        ...
                        storage=runai.models.inference_policy_defaults_v2_all_of_storage.InferencePolicyDefaultsV2_allOf_storage(
    ...
    storage: Optional[InferencePolicyDefaultsV2AllOfStorage] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferencePolicyDefaultsV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferencePolicyDefaultsV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "storage": (
                    InferencePolicyDefaultsV2AllOfStorage.from_dict(obj["storage"])
