...
class HostPathListResponse(BaseModel):
    """
    Pydantic class model representing HostPathListResponse.

    Parameters:
        ```python
        entries: List[HostPathAsset]
        ```
        entries: See model List[HostPathAsset] for more information.
    Example:
        ```python
        HostPathListResponse(
            entries=[
                    runai.models.host_path_asset.HostPathAsset(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HostPathListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HostPathListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [HostPathAsset.from_dict(_item) for _item in obj["entries"]]
