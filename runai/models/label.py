...
class Label(BaseModel):
    """
    Pydantic class model representing Label details to be populated into the container..
    ...
    Parameters:
        ...
        ```
        name: The name of the label (mandatory)
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(
        default=None, description="The name of the label (mandatory)"
    )
