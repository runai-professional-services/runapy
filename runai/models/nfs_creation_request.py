...
class NFSCreationRequest(BaseModel):
    """
    Pydantic class model representing NFSCreationRequest.
    ...
    Parameters:
        ...
        spec: See model NFSAssetSpec for more information.
    Example:
        ```python
        NFSCreationRequest(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NFSCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NFSCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    NFSAssetSpec.from_dict(obj["spec"])
