...
class ListReports200Response(BaseModel):
    """
    Pydantic class model representing ListReports200Response.

    Parameters:
        ```python
        reports: List[Report]
        ```
        reports: See model List[Report] for more information.
    Example:
        ```python
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "reports": (
                    [Report.from_dict(_item) for _item in obj["reports"]]
