...
class InferenceSecurityRules(BaseModel):
    """
    Pydantic class model representing InferenceSecurityRules.
    ...
    __properties: ClassVar[List[str]] = ["security"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferenceSecurityRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferenceSecurityRules from a dict"""
        if obj is None:
            return None
