...
class GitRules(BaseModel):
    """
    Pydantic class model representing GitRules.

    Parameters:
        ```python
        repository: Optional[StringRules]
        branch: Optional[StringRules]
        revision: Optional[StringRules]
        path: Optional[StringRules]
        ```
        repository: See model StringRules for more information.
        branch: See model StringRules for more information.
        revision: See model StringRules for more information.
    ...
    repository: Optional[StringRules] = None
    branch: Optional[StringRules] = None
    revision: Optional[StringRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "repository": (
                    StringRules.from_dict(obj["repository"])
                    if obj.get("repository") is not None
                    else None
                ),
                "branch": (
                    StringRules.from_dict(obj["branch"])
                    if obj.get("branch") is not None
                    else None
                ),
                "revision": (
                    StringRules.from_dict(obj["revision"])
