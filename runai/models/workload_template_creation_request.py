...
class WorkloadTemplateCreationRequest(BaseModel):
    """
    Pydantic class model representing WorkloadTemplateCreationRequest.
    ...
    Parameters:
        ...
        spec: See model SpecificRunCreationFields for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkloadTemplateCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkloadTemplateCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    SpecificRunCreationFields.from_dict(obj["spec"])
