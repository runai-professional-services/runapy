...
class NgcApiKeyCreationRequest(BaseModel):
    """
    Pydantic class model representing NgcApiKeyCreationRequest.

    Parameters:
        ```python
        meta: AssetCreationRequest
        spec: NgcApiKeyCreationSpec
        ```
        meta: See model AssetCreationRequest for more information.
        spec: See model NgcApiKeyCreationSpec for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NgcApiKeyCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NgcApiKeyCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    NgcApiKeyCreationSpec.from_dict(obj["spec"])
