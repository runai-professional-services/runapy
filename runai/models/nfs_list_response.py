...
class NFSListResponse(BaseModel):
    """
    Pydantic class model representing NFSListResponse.

    Parameters:
        ```python
        entries: List[NFSAsset]
        ```
        entries: See model List[NFSAsset] for more information.
    Example:
        ```python
        NFSListResponse(
            entries=[
                    runai.models.nfs_asset.NFSAsset(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NFSListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NFSListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [NFSAsset.from_dict(_item) for _item in obj["entries"]]
