...
class InferencesMaxReplicasField(BaseModel):
    """
    Pydantic class model representing InferencesMaxReplicasField.
    ...
    __properties: ClassVar[List[str]] = ["maxReplicas"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferencesMaxReplicasField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferencesMaxReplicasField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"maxReplicas": obj.get("maxReplicas")})
        return _obj
