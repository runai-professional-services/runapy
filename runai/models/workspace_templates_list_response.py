...
class WorkspaceTemplatesListResponse(BaseModel):
    """
    Pydantic class model representing WorkspaceTemplatesListResponse.

    Parameters:
        ```python
        entries: List[WorkspaceTemplatesListResponseItem]
        pagination: PaginationInfo
        ```
        entries: See model List[WorkspaceTemplatesListResponseItem] for more information.
    ...
    entries: Optional[List[WorkspaceTemplatesListResponseItem]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceTemplatesListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceTemplatesListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [
                        WorkspaceTemplatesListResponseItem.from_dict(_item)
