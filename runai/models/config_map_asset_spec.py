...
class ConfigMapAssetSpec(BaseModel):
    """
    Pydantic class model representing ConfigMapAssetSpec.
    ...
    __properties: ClassVar[List[str]] = ["configMap", "mountPath"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigMapAssetSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigMapAssetSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"configMap": obj.get("configMap"), "mountPath": obj.get("mountPath")}
        )
        return _obj
