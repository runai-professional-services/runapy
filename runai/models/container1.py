...
class Container1(BaseModel):
    """
    Pydantic class model representing Container1.
    ...
    Parameters:
        ...
        image: See model str for more information.
        started_at: See model datetime for more information.
    Example:
        ```python
        Container1(
            name='alpine',
    ...
    __properties: ClassVar[List[str]] = ["name", "image", "startedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Container1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Container1 from a dict"""
        if obj is None:
            return None
