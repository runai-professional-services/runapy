...
class SuperSet(BaseModel):
    """
    Pydantic class model representing SuperSet.
    ...
    __properties: ClassVar[List[str]] = ["servingPort", "restartPolicy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SuperSet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SuperSet from a dict"""
        if obj is None:
            return None
