...
class ResourcesResetAction(str, Enum):
    """
    The action to apply

    Allowed enum values:

    QUOTAS_TO_DEFAULT = 'QUOTAS_TO_DEFAULT'

    RANKS_TO_DEFAULT = 'RANKS_TO_DEFAULT'

    WEIGHTS_TO_DEFAULT = 'WEIGHTS_TO_DEFAULT'

    WEIGHTS_TO_DESERVED = 'WEIGHTS_TO_DESERVED'


    Example:
        ```python
        ResourcesResetAction.QUOTAS_TO_DEFAULT
        ResourcesResetAction.RANKS_TO_DEFAULT
        ResourcesResetAction.WEIGHTS_TO_DEFAULT
        ResourcesResetAction.WEIGHTS_TO_DESERVED
        ```
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ResourcesResetAction from a JSON string"""
