...
class PVCAssetSpec(BaseModel):
    """
    Pydantic class model representing PVCAssetSpec.
    ...
    Parameters:
        ...
        ```
        path: Local path within the workload to which the PVC bucket will be mapped. (mandatory)
    ...
    def claim_name_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PVCAssetSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PVCAssetSpec from a dict"""
        if obj is None:
            return None
