...
class StringOption(BaseModel):
    """
    Pydantic class model representing One of the values that the field can be assigned to, when options police is applied on the field..
    ...
    Parameters:
        ...
        ```
        value: The value that the field should hold
        displayed: Textual description of the value. to be used by user interface applications.
    Example:
        ```python
        StringOption(
            value='',
    ...
    value: StrictStr = Field(description="The value that the field should hold")
