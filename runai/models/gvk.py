...
class GVK(BaseModel):
    """
    Pydantic class model representing Specifies the Group, Version, and Kind (GVK) of the Kubernetes resource that defines the workload..
    ...
    Parameters:
        ...
        version: The API version of the resource within the specified group.
        kind: The type of Kubernetes resource being referenced.
    Example:
        ```python
        GVK(
            group='apps',
    ...
    group: StrictStr = Field(description="The API group of the Kubernetes resource.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GVK from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GVK from a dict"""
        if obj is None:
            return None
