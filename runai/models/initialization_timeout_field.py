...
class InitializationTimeoutField(BaseModel):
    """
    Pydantic class model representing InitializationTimeoutField.
    ...
    __properties: ClassVar[List[str]] = ["initializationTimeoutSeconds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InitializationTimeoutField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InitializationTimeoutField from a dict"""
        if obj is None:
            return None
