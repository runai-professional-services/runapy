...
class ServingPortExposedProtocol(str, Enum):
    """
    ...
    Example:
        ```python
        ServingPortExposedProtocol.HTTP
        ServingPortExposedProtocol.GRPC
        ```
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ServingPortExposedProtocol from a JSON string"""
