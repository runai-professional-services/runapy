...
class PvcAttributesToRemove(BaseModel):
    """
    Pydantic class model representing optional list of attributes that you wish to remove.
    ...
    __properties: ClassVar[List[str]] = ["attributesToRemove"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PvcAttributesToRemove from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PvcAttributesToRemove from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"attributesToRemove": obj.get("attributesToRemove")})
        return _obj
