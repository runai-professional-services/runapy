...
class DepartmentV1CommonFieldsResponse(BaseModel):
    """
    Pydantic class model representing DepartmentV1CommonFieldsResponse.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DepartmentV1CommonFieldsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DepartmentV1CommonFieldsResponse from a dict"""
        if obj is None:
            return None
