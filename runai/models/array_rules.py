...
class ArrayRules(BaseModel):
    """
    Pydantic class model representing ArrayRules.
    ...
    Parameters:
        ...
        required: Whether this array is mandatory. Mandatory array must include at least one item. default to false.
        options: Set of options that the value of each item of the array must be chosen from.
        can_edit: Whether the value of the array, as a whole, is editable. default to false.
    Example:
        ```python
        ArrayRules(
    ...
    options: Optional[List[StringOption]] = Field(
        default=None,
        description="Set of options that the value of each item of the array must be chosen from.",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArrayRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArrayRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "options": (
                    [StringOption.from_dict(_item) for _item in obj["options"]]
