...
class HostPathsRules(BaseModel):
    """
    Pydantic class model representing HostPathsRules.

    Parameters:
        ```python
        attributes: Optional[HostPathRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model HostPathRules for more information.
    ...
    attributes: Optional[HostPathRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HostPathsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HostPathsRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    HostPathRules.from_dict(obj["attributes"])
