...
class TemplateCreationMetaFields(BaseModel):
    """
    Pydantic class model representing TemplateCreationMetaFields.
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "scopeType", "scopeId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TemplateCreationMetaFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TemplateCreationMetaFields from a dict"""
        if obj is None:
            return None
