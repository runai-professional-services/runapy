...
class ComputeRules(BaseModel):
    """
    Pydantic class model representing ComputeRules.
    ...
    __properties: ClassVar[List[str]] = ["compute"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ComputeRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ComputeRules from a dict"""
        if obj is None:
            return None
