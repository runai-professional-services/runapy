...
class Revision(BaseModel):
    ...
    Parameters:
        ...
        requested_resources: Optional[WorkloadRequestResources]
        ...
        requested_resources: See model WorkloadRequestResources for more information.
    ...
    requested_resources: Optional[WorkloadRequestResources] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "requestedResources": (
                    WorkloadRequestResources.from_dict(obj["requestedResources"])
