...
class ProbeHandlerRules(BaseModel):
    """
    Pydantic class model representing ProbeHandlerRules.

    Parameters:
        ```python
        http_get: ProbeHandlerRulesHttpGet
        ```
        http_get: See model ProbeHandlerRulesHttpGet for more information.
    Example:
        ```python
        ProbeHandlerRules(
    ...
    http_get: Optional[ProbeHandlerRulesHttpGet] = Field(default=None, alias="httpGet")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProbeHandlerRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProbeHandlerRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "httpGet": (
                    ProbeHandlerRulesHttpGet.from_dict(obj["httpGet"])
