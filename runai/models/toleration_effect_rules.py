...
class TolerationEffectRules(BaseModel):
    """
    Pydantic class model representing TolerationEffectRules.
    ...
    Parameters:
        ...
        options: Optional[List[TolerationEffectOptionsOptionsInner]]
        ```
    ...
    options: Optional[List[TolerationEffectOptionsOptionsInner]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TolerationEffectRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TolerationEffectRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "options": (
                    [
                        TolerationEffectOptionsOptionsInner.from_dict(_item)
