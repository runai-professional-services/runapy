...
class PreemptibilityOptions(BaseModel):
    """
    Pydantic class model representing PreemptibilityOptions.

    Parameters:
        ```python
        options: Optional[List[PreemptibilityOptionsOptionsInner]]
        ```
        options: Limit the permitted values for preemptibility to a given set of values.
    Example:
        ```python
        PreemptibilityOptions(
            options=[
                    runai.models.preemptibility_options_options_inner.PreemptibilityOptions_options_inner(
                        value = 'preemptible',
    ...
    options: Optional[List[PreemptibilityOptionsOptionsInner]] = Field(
        default=None,
        description="Limit the permitted values for preemptibility to a given set of values.",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PreemptibilityOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PreemptibilityOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "options": (
                    [
                        PreemptibilityOptionsOptionsInner.from_dict(_item)
