...
class StorageClassPermissions(BaseModel):
    """
    Pydantic class model representing Defines the access permissions and behavioral rules for this storage class..
    ...
    Parameters:
        ...
        ```
        allowed_for_assets: Determines whether PVC assets can be created using this storage class.
        allowed_for_workloads: Allows workloads to include PVCs that use this storage class. When disabled, users cannot (a) include non-existing PVC assets created with this class in asset-based submissions, or (b) attach PVCs with existing&#x3D;false to workloads using this class.
        allowed_for_ephemeral_volumes: Allows workloads to create ephemeral volumes using this storage class. When disabled, users cannot (a) create PVC assets with autoDelete&#x3D;true and ephemeral&#x3D;true, or (b) include PVC instances with isEphemeral&#x3D;false that use this storage class.
        allowed_for_persistent_volumes: Allows workloads to create persistent volumes using this storage class. When disabled, users cannot (a) create PVC assets with autoDelete&#x3D;true and ephemeral&#x3D;true, or (b) include PVC instances with isEphemeral&#x3D;false that use this storage class.
        allow_data_sharing: Allows creation of PVCs using a shared volume.
    Example:
        ```python
