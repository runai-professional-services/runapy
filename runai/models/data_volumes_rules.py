...
class DataVolumesRules(BaseModel):
    """
    Pydantic class model representing DataVolumesRules.

    Parameters:
        ```python
        attributes: Optional[DataVolumeRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model DataVolumeRules for more information.
    ...
    attributes: Optional[DataVolumeRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataVolumesRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataVolumesRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    DataVolumeRules.from_dict(obj["attributes"])
