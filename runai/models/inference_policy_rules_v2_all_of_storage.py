...
class InferencePolicyRulesV2AllOfStorage(BaseModel):
    """
    Pydantic class model representing InferencePolicyRulesV2AllOfStorage.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferencePolicyRulesV2AllOfStorage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferencePolicyRulesV2AllOfStorage from a dict"""
        if obj is None:
            return None
