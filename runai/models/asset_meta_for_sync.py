...
class AssetMetaForSync(BaseModel):
    """
    Pydantic class model representing AssetMetaForSync.
    ...
    Parameters:
        ...
        private: The asset will be private to the user who created it. supported only for docker registry and generic secrets - Default: False
        name: The name of the asset.
        description: The description of the asset.
        id: Unique identifier of the asset.
        kind: See model AssetKind for more information.
        prev_name: The name of the asset.
    Example:
        ```python
        AssetMetaForSync(
            scope='system',
    ...
    ] = Field(default=None, description="The description of the asset.")
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description="Unique identifier of the asset."
    )
    kind: AssetKind
    prev_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(
        default=None, description="The name of the asset.", alias="prevName"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetMetaForSync from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetMetaForSync from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "private": (
                    obj.get("private") if obj.get("private") is not None else False
                ),
                "name": obj.get("name"),
                "description": obj.get("description"),
                "id": obj.get("id"),
                "kind": obj.get("kind"),
                "prevName": obj.get("prevName"),
            }
        )
        return _obj
