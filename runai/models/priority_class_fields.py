...
class PriorityClassFields(BaseModel):
    """
    Pydantic class model representing PriorityClassFields.
    ...
    __properties: ClassVar[List[str]] = ["priorityClass"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PriorityClassFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PriorityClassFields from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"priorityClass": obj.get("priorityClass")})
        return _obj
