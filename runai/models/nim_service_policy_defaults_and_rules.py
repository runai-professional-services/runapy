...
class NimServicePolicyDefaultsAndRules(BaseModel):
    """
    Pydantic class model representing NimServicePolicyDefaultsAndRules.

    Parameters:
        ```python
        defaults: Optional[NimServiceDefaults]
        rules: Optional[NimServiceRules]
        status: Optional[PolicyValidationStatus]
        ```
        defaults: See model NimServiceDefaults for more information.
        rules: See model NimServiceRules for more information.
    ...
    defaults: Optional[NimServiceDefaults] = None
    rules: Optional[NimServiceRules] = None
    status: Optional[PolicyValidationStatus] = None
    __properties: ClassVar[List[str]] = ["defaults", "rules", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NimServicePolicyDefaultsAndRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NimServicePolicyDefaultsAndRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "defaults": (
                    NimServiceDefaults.from_dict(obj["defaults"])
                    if obj.get("defaults") is not None
                    else None
                ),
                "rules": (
                    NimServiceRules.from_dict(obj["rules"])
