...
class PvcsRules(BaseModel):
    """
    Pydantic class model representing PvcsRules.

    Parameters:
        ```python
        attributes: Optional[PvcRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model PvcRules for more information.
    ...
    attributes: Optional[PvcRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PvcsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PvcsRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    PvcRules.from_dict(obj["attributes"])
