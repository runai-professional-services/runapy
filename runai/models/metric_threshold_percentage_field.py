...
class MetricThresholdPercentageField(BaseModel):
    """
    Pydantic class model representing MetricThresholdPercentageField.
    ...
    __properties: ClassVar[List[str]] = ["metricThresholdPercentage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetricThresholdPercentageField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetricThresholdPercentageField from a dict"""
        if obj is None:
            return None
