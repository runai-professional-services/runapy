...
class SecretInstance1(BaseModel):
    """
    Pydantic class model representing SecretInstance1.
    ...
    __properties: ClassVar[List[str]] = ["name", "secret", "mountPath"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SecretInstance1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SecretInstance1 from a dict"""
        if obj is None:
            return None
