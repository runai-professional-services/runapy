...
class AccessKeys(BaseModel):
    """
    Pydantic class model representing AccessKeys.

    Parameters:
        ```python
        access_keys: List[AccessKey1]
        ```
        access_keys: See model List[AccessKey1] for more information.
    Example:
        ```python
        AccessKeys(
            access_keys=[
                    {"name":"my-access-key","id":"3434c-12323ab-4ce2ea6-b44fc-db344d","clientId":"3434c-12323ab-4ce2ea6","createdAt":"2019-01-01T00:00:00Z","lastLogin":"2020-01-01T00:00:00Z"}
                    ]
        )
        ```
    """  # noqa: E501

    access_keys: List[AccessKey1] = Field(alias="accessKeys")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "accessKeys": (
                    [AccessKey1.from_dict(_item) for _item in obj["accessKeys"]]
