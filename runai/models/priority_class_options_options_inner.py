...
class PriorityClassOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing PriorityClassOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[PriorityClass]
        displayed: Optional[str]
        ```
        value: See model PriorityClass for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PriorityClassOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PriorityClassOptionsOptionsInner from a dict"""
        if obj is None:
            return None
