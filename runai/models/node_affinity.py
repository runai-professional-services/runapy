...
class NodeAffinity(BaseModel):
    """
    Pydantic class model representing NodeAffinity.
    ...
    Parameters:
        ...
        selected_types: See model List[NodeTypeForProject] for more information.
    Example:
        ```python
        NodeAffinity(
    ...
    selected_types: Optional[List[NodeTypeForProject]] = Field(
        default=None, alias="selectedTypes"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "selectedTypes": (
                    [
                        NodeTypeForProject.from_dict(_item)
