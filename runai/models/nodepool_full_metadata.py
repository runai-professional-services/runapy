...
class NodepoolFullMetadata(BaseModel):
    """
    Pydantic class model representing NodepoolFullMetadata.
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "clusterId", "phase"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodepoolFullMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodepoolFullMetadata from a dict"""
        if obj is None:
            return None
