...
class ServingPortServiceType(str, Enum):
    """
    ...
    Example:
        ```python
        ServingPortServiceType.CLUSTERIP
        ServingPortServiceType.NODEPORT
        ServingPortServiceType.LOADBALANCER
        ServingPortServiceType.EXTERNALNAME
        ```
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ServingPortServiceType from a JSON string"""
