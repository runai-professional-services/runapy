...
class ServiceAccountPostResponse(BaseModel):
    """
    Pydantic class model representing ServiceAccountPostResponse.
    ...
    Parameters:
        ...
        client_secret: Secret credential paired with the client ID. Used to obtain authentication tokens. Displayed only once upon creation.
        client_id: The client identifier associated with the service account. Used when requesting authentication tokens.
    Example:
        ```python
    ...
    id: StrictStr = Field(description="The unique identifier of the service account.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "clientSecret", "clientId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServiceAccountPostResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServiceAccountPostResponse from a dict"""
        if obj is None:
            return None
