...
class AccessModeCustomization(BaseModel):
    """
    Pydantic class model representing Controls whether PVC access modes are required and what defaults to apply..
    ...
    Parameters:
        ...
        ```
        required: If true, the accessMode field is mandatory when creating a PVC that uses this storage class.
