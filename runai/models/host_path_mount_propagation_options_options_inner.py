...
class HostPathMountPropagationOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing HostPathMountPropagationOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[HostPathMountPropagation]
        displayed: Optional[str]
        ```
        value: See model HostPathMountPropagation for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HostPathMountPropagationOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HostPathMountPropagationOptionsOptionsInner from a dict"""
        if obj is None:
            return None
