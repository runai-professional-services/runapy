...
class RegenerateServiceAccountSecretResponse(BaseModel):
    """
    Pydantic class model representing RegenerateServiceAccountSecretResponse.

    Parameters:
        ```python
        client_secret: str
        ```
        client_secret: Secret credential paired with the client ID. Used to obtain authentication tokens. Displayed only once upon regeneration.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegenerateServiceAccountSecretResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegenerateServiceAccountSecretResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"clientSecret": obj.get("clientSecret")})
        return _obj
