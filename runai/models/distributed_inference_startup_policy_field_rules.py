...
class DistributedInferenceStartupPolicyFieldRules(BaseModel):
    """
    Pydantic class model representing DistributedInferenceStartupPolicyFieldRules.
    ...
    __properties: ClassVar[List[str]] = ["startupPolicy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedInferenceStartupPolicyFieldRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedInferenceStartupPolicyFieldRules from a dict"""
        if obj is None:
            return None
