...
class InferenceTemplatesListResponseItem(BaseModel):
    """
    Pydantic class model representing InferenceTemplatesListResponseItem.
    ...
    Parameters:
        ...
        combined_spec: InferenceTemplateSpec
        ...
        combined_spec: See model InferenceTemplateSpec for more information.
    ...
    combined_spec: Optional[InferenceTemplateSpec] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferenceTemplatesListResponseItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferenceTemplatesListResponseItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "combinedSpec": (
                    InferenceTemplateSpec.from_dict(obj["combinedSpec"])
