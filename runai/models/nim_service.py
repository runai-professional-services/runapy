...
class NimService(BaseModel):
    """
    Pydantic class model representing NimService.
    ...
    __properties: ClassVar[List[str]] = ["ngcAuthSecret", "replicas"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NimService from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NimService from a dict"""
        if obj is None:
            return None
