...
class AssignedResources(BaseModel):
    """
    Pydantic class model representing AssignedResources.
    ...
    gpu: Optional[Resource1] = Field(default=None, description="GPU number assigned")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssignedResources from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssignedResources from a dict"""
        if obj is None:
            return None
