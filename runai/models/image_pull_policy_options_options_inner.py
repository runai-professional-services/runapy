...
class ImagePullPolicyOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing ImagePullPolicyOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[ImagePullPolicy]
        displayed: Optional[str]
        ```
        value: See model ImagePullPolicy for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImagePullPolicyOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImagePullPolicyOptionsOptionsInner from a dict"""
        if obj is None:
            return None
