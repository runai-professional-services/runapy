...
class ArbitraryRules(BaseModel):
    """
    Pydantic class model representing ArbitraryRules.
    ...
    Parameters:
        ...
        required: Whether this arbitrary object is mandatory. default to false.
        can_edit: Whether the value of the field, as a whole, is editable. default to false.
    Example:
        ```python
        ArbitraryRules(
    ...
    required: Optional[StrictBool] = Field(
        default=None,
        description="Whether this arbitrary object is mandatory. default to false.",
    )
    can_edit: Optional[StrictBool] = Field(
        default=None,
        description="Whether the value of the field, as a whole, is editable. default to false.",
        alias="canEdit",
    )
    __properties: ClassVar[List[str]] = ["sourceOfRule", "required", "canEdit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArbitraryRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArbitraryRules from a dict"""
        if obj is None:
            return None
