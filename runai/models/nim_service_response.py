...
class NimServiceResponse(BaseModel):
    """
    Pydantic class model representing NimServiceResponse.
    ...
    Parameters:
        ...
        spec: See model NimServiceSpec for more information.
    Example:
        ```python
        NimServiceResponse(
            metadata="example",
    ...
    spec: NimServiceSpec
    __properties: ClassVar[List[str]] = ["metadata", "desiredPhase", "spec"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NimServiceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NimServiceResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    NimServiceSpec.from_dict(obj["spec"])
