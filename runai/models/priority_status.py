...
class PriorityStatus(BaseModel):
    """
    Pydantic class model representing PriorityStatus.
    ...
    __properties: ClassVar[List[str]] = ["clusterId", "phase"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PriorityStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PriorityStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"clusterId": obj.get("clusterId"), "phase": obj.get("phase")}
        )
        return _obj
