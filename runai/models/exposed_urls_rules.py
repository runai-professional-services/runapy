...
class ExposedUrlsRules(BaseModel):
    """
    Pydantic class model representing ExposedUrlsRules.

    Parameters:
        ```python
        attributes: Optional[ExposedUrlRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model ExposedUrlRules for more information.
    ...
    attributes: Optional[ExposedUrlRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExposedUrlsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExposedUrlsRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    ExposedUrlRules.from_dict(obj["attributes"])
