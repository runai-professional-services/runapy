...
class InitialReplicasField(BaseModel):
    """
    Pydantic class model representing InitialReplicasField.
    ...
    __properties: ClassVar[List[str]] = ["initialReplicas"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InitialReplicasField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InitialReplicasField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"initialReplicas": obj.get("initialReplicas")})
        return _obj
