...
class MpiLauncherCreationPolicyOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing MpiLauncherCreationPolicyOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[MpiLauncherCreationPolicy]
        displayed: Optional[str]
        ```
        value: See model MpiLauncherCreationPolicy for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MpiLauncherCreationPolicyOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MpiLauncherCreationPolicyOptionsOptionsInner from a dict"""
        if obj is None:
            return None
