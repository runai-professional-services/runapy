...
class DistributedInferenceRestartPolicyOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing DistributedInferenceRestartPolicyOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[DistributedInferenceRestartPolicy]
        displayed: Optional[str]
        ```
        value: See model DistributedInferenceRestartPolicy for more information. - Default: DistributedInferenceRestartPolicy.RECREATEGROUPONPODRESTART
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedInferenceRestartPolicyOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedInferenceRestartPolicyOptionsOptionsInner from a dict"""
        if obj is None:
            return None
