...
class S3CreationRequest(BaseModel):
    """
    Pydantic class model representing S3CreationRequest.
    ...
    Parameters:
        ...
        spec: See model S3AssetSpec for more information.
    Example:
        ```python
        S3CreationRequest(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of S3CreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of S3CreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    S3AssetSpec.from_dict(obj["spec"])
