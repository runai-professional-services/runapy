...
class UidGidSourceOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing UidGidSourceOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[UidGidSource]
        displayed: Optional[str]
        ```
        value: See model UidGidSource for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UidGidSourceOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UidGidSourceOptionsOptionsInner from a dict"""
        if obj is None:
            return None
