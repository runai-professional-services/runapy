...
class DepartmentAccessControl(BaseModel):
    """
    Pydantic class model representing DepartmentAccessControl.
    ...
    __properties: ClassVar[List[str]] = ["departmentId", "departmentAdmins"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DepartmentAccessControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DepartmentAccessControl from a dict"""
        if obj is None:
            return None
