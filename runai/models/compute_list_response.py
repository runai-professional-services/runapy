...
class ComputeListResponse(BaseModel):
    """
    Pydantic class model representing ComputeListResponse.

    Parameters:
        ```python
        entries: List[ComputeAsset]
        ```
        entries: See model List[ComputeAsset] for more information.
    Example:
        ```python
        ComputeListResponse(
            entries=[
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ComputeListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ComputeListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [ComputeAsset.from_dict(_item) for _item in obj["entries"]]
