...
class StorageClassConfigurationCreationRequest(BaseModel):
    """
    Pydantic class model representing StorageClassConfigurationCreationRequest.
    ...
    Parameters:
        ...
        scope_type: the scope type of the configuration. - Default: &#39;cluster&#39;
        scope_id: The ID of the cluster.
        name: The name of the storage class to which the configuration applies.
    ...
    scope_type: StrictStr = Field(
        description="the scope type of the configuration.", alias="scopeType"
    )
    scope_id: StrictStr = Field(description="The ID of the cluster.", alias="scopeId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StorageClassConfigurationCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StorageClassConfigurationCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "scopeType": (
                    obj.get("scopeType")
                    if obj.get("scopeType") is not None
                    else "cluster"
                ),
