...
class Preemptibility(str, Enum):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of Preemptibility from a JSON string"""
