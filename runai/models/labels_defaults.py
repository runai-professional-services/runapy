...
class LabelsDefaults(BaseModel):
    """
    Pydantic class model representing LabelsDefaults.

    Parameters:
        ```python
        instances: Optional[List[Label]]
        ```
        instances: Set of labels to populate into the container running the workspace.
    Example:
        ```python
        LabelsDefaults(
            instances=[
    ...
    instances: Optional[List[Optional[Label]]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LabelsDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LabelsDefaults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "instances": (
                    [Label.from_dict(_item) for _item in obj["instances"]]
