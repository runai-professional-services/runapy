...
class DepartmentForListAllOfStatus(BaseModel):
    """
    Pydantic class model representing DepartmentForListAllOfStatus.
    ...
    __properties: ClassVar[List[str]] = ["quotaStatus"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DepartmentForListAllOfStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DepartmentForListAllOfStatus from a dict"""
        if obj is None:
            return None
