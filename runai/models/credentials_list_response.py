...
class CredentialsListResponse(BaseModel):
    """
    Pydantic class model representing CredentialsListResponse.

    Parameters:
        ```python
        entries: List[CredentialsListResponseEntry]
        ```
        entries: See model List[CredentialsListResponseEntry] for more information.
    Example:
        ```python
        CredentialsListResponse(
            entries=[
                    runai.models.credentials_list_response_entry.CredentialsListResponseEntry(
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [
                        CredentialsListResponseEntry.from_dict(_item)
