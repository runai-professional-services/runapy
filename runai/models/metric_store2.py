...
class MetricStore2(BaseModel):
    ...
    datasource_id: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = (
        Field(description="Id of datasource", alias="datasourceId")
    )
    metric_store_details: MetricStoreDetails = Field(alias="metricStoreDetails")
