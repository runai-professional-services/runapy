...
class SecretAssetCreationRequest(BaseModel):
    """
    Pydantic class model representing SecretAssetCreationRequest.
    ...
    Parameters:
        ...
        spec: See model SecretAssetSpec for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SecretAssetCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SecretAssetCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    SecretAssetSpec.from_dict(obj["spec"])
