...
class DistributedTemplateCreationRequest(BaseModel):
    """
    Pydantic class model representing DistributedTemplateCreationRequest.

    Parameters:
        ```python
        meta: TemplateCreationMetaFields
        spec: DistributedTemplateSpec
        master_spec_same_as_worker: Optional[bool]
        master: Optional[TemplateMasterSection]
        ```
        meta: See model TemplateCreationMetaFields for more information.
    ...
    Example:
        ...
        DistributedTemplateCreationRequest(
            meta=runai.models.template_creation_meta_fields.TemplateCreationMetaFields(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedTemplateCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedTemplateCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "meta": (
                    TemplateCreationMetaFields.from_dict(obj["meta"])
