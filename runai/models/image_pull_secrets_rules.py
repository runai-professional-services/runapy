...
class ImagePullSecretsRules(BaseModel):
    """
    Pydantic class model representing ImagePullSecretsRules.

    Parameters:
        ```python
        attributes: Optional[ImagePullSecretsRulesAttributes]
        instances: Optional[ItemRules]
        ```
        attributes: See model ImagePullSecretsRulesAttributes for more information.
        instances: See model ItemRules for more information.
    Example:
        ```python
        ImagePullSecretsRules(
    ...
    attributes: Optional[ImagePullSecretsRulesAttributes] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImagePullSecretsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImagePullSecretsRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    ImagePullSecretsRulesAttributes.from_dict(obj["attributes"])
