...
class AutoScalingMetricField(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AutoScalingMetricField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AutoScalingMetricField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"metric": obj.get("metric")})
        return _obj
