...
class MeAccessRule(BaseModel):
    """
    Pydantic class model representing MeAccessRule.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeAccessRule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeAccessRule from a dict"""
        if obj is None:
            return None
