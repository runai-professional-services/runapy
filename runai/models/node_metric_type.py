...
class NodeMetricType(str, Enum):
    ...
    NVLINK_BANDWIDTH_TOTAL = 'NVLINK_BANDWIDTH_TOTAL'

    NVLINK_BANDWIDTH_TOTAL_PER_GPU = 'NVLINK_BANDWIDTH_TOTAL_PER_GPU'
    ...
    Example:
        ...
        NodeMetricType.NVLINK_BANDWIDTH_TOTAL
        NodeMetricType.NVLINK_BANDWIDTH_TOTAL_PER_GPU
        ```
    """
