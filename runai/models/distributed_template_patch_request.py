...
class DistributedTemplatePatchRequest(BaseModel):
    """
    Pydantic class model representing DistributedTemplatePatchRequest.

    Parameters:
        ```python
        meta: Optional[TemplatePatchMetaFields]
        ...
        ```
        meta: See model TemplatePatchMetaFields for more information.
        fields_to_clear: See model List[str] for more information.
    ...
    Example:
        ...
        DistributedTemplatePatchRequest(
            meta=runai.models.template_patch_meta_fields.TemplatePatchMetaFields(
    ...
    meta: Optional[TemplatePatchMetaFields] = None
    fields_to_clear: Optional[
        List[Annotated[str, Field(min_length=1, strict=True)]]
    ] = Field(default=None, alias="fieldsToClear")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedTemplatePatchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedTemplatePatchRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "meta": (
                    TemplatePatchMetaFields.from_dict(obj["meta"])
                    if obj.get("meta") is not None
                    else None
                ),
                "fieldsToClear": obj.get("fieldsToClear"),
                "spec": (
