...
class DistributedInferenceTemplateSpec(BaseModel):
    """
    Pydantic class model representing DistributedInferenceTemplateSpec.
    ...
    Parameters:
        ...
        leader: Optional[DistributedInferenceLeaderWorkerTemplateSpec]
        worker: Optional[DistributedInferenceLeaderWorkerTemplateSpec]
        ```
        ...
        leader: Defines the pod specification for the leader.
        worker: Defines the pod specification for the workers.
    Example:
        ```python
        DistributedInferenceTemplateSpec(
            category='jUR,rZ#UM/?R,Fp^l6$ARj',
                        ...
                        workers=4,
                        replicas=2,
                        leader=runai.models.distributed_inference_leader_worker_template_spec.DistributedInferenceLeaderWorkerTemplateSpec(
                    annotations = [
                    ...
                    working_dir = '/home/myfolder', ),
                        worker=runai.models.distributed_inference_leader_worker_template_spec.DistributedInferenceLeaderWorkerTemplateSpec(
                    annotations = [
                        runai.models.annotation.Annotation(
                            name = 'billing',
                            value = 'my-billing-unit',
    ...
    leader: Optional[DistributedInferenceLeaderWorkerTemplateSpec] = Field(
        default=None, description="Defines the pod specification for the leader."
    )
    worker: Optional[DistributedInferenceLeaderWorkerTemplateSpec] = Field(
        default=None, description="Defines the pod specification for the workers."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedInferenceTemplateSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedInferenceTemplateSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "leader": (
                    DistributedInferenceLeaderWorkerTemplateSpec.from_dict(
                        obj["leader"]
                    )
