...
class DatasourceListResponse(BaseModel):
    """
    Pydantic class model representing DatasourceListResponse.

    Parameters:
        ```python
        entries: List[DatasourceListResponseEntry]
        ```
        entries: See model List[DatasourceListResponseEntry] for more information.
    Example:
        ```python
        DatasourceListResponse(
            entries=[
                    runai.models.datasource_list_response_entry.DatasourceListResponseEntry(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatasourceListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatasourceListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [
                        DatasourceListResponseEntry.from_dict(_item)
