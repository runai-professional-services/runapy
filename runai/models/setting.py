...
class Setting(BaseModel):
    """
    Pydantic class model representing Setting.
    ...
    Parameters:
        ...
        value: str
        ```
        active: See model bool for more information.
        ...
        label: See model str for more information.
        stage: See model str for more information.
