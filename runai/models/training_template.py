...
class TrainingTemplate(BaseModel):
    """
    Pydantic class model representing TrainingTemplate.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainingTemplate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainingTemplate from a dict"""
        if obj is None:
            return None
