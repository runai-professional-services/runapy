...
class TrainingTemplate(BaseModel):
    ...
    Parameters:
        ...
        combined_spec: TrainingSpecSpec
        ```
        ...
        combined_spec: See model TrainingSpecSpec for more information.
    Example:
        ```python
        TrainingTemplate(
    ...
    combined_spec: Optional[TrainingSpecSpec] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "combinedSpec": (
                    TrainingSpecSpec.from_dict(obj["combinedSpec"])
