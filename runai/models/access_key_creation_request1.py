...
class AccessKeyCreationRequest1(BaseModel):
    """
    Pydantic class model representing AccessKeyCreationRequest1.

    Parameters:
        ```python
        name: str
        ```
        name: The name of the access key. The name must be unique within the user&#39;s access keys list and can only contain lowercase alphanumeric characters and hyphens. It must start and end with a letter.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessKeyCreationRequest1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessKeyCreationRequest1 from a dict"""
        if obj is None:
            return None
