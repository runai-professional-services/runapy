...
class RepositoryTags(BaseModel):
    """
    Pydantic class model representing RepositoryTags.
    ...
    Parameters:
        ...
        tags: See model List[str] for more information.
    Example:
        ```python
        RepositoryTags(
            name='',
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"name": obj.get("name"), "tags": obj.get("tags")})
        return _obj
