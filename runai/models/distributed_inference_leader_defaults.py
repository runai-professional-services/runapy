...
class DistributedInferenceLeaderDefaults(BaseModel):
    """
    Pydantic class model representing DistributedInferenceLeaderDefaults.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedInferenceLeaderDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedInferenceLeaderDefaults from a dict"""
        if obj is None:
            return None
