...
class RequestResourceQuantity(BaseModel):
    """
    Pydantic class model representing RequestResourceQuantity.
    ...
    Parameters:
        ...
        ```
        limit: See model str for more information.
        request: See model str for more information.
    Example:
        ```python
    ...
    request: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequestResourceQuantity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequestResourceQuantity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"limit": obj.get("limit"), "request": obj.get("request")}
        )
        return _obj
