...
class HistoryRecord1Spec(BaseModel):
    """
    Pydantic class model representing HistoryRecord1Spec.
    ...
    Parameters:
        ...
        ```
        event: See model Event2 for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HistoryRecord1Spec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HistoryRecord1Spec from a dict"""
        if obj is None:
            return None
