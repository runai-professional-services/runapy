...
class StorageDefaults(BaseModel):
    """
    Pydantic class model representing StorageDefaults.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StorageDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StorageDefaults from a dict"""
        if obj is None:
            return None
