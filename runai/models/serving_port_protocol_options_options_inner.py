...
class ServingPortProtocolOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing ServingPortProtocolOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[ServingPortProtocol]
        displayed: Optional[str]
        ```
        value: See model ServingPortProtocol for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServingPortProtocolOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServingPortProtocolOptionsOptionsInner from a dict"""
        if obj is None:
            return None
