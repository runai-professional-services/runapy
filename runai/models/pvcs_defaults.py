...
class PvcsDefaults(BaseModel):
    """
    Pydantic class model representing PvcsDefaults.

    Parameters:
        ```python
        attributes: Optional[PvcInstance]
        instances: Optional[List[PvcInstance]]
        ```
        attributes: See model PvcInstance for more information.
        instances: Set of pvc persistent volume claims to use in the workload.
    Example:
        ```python
        PvcsDefaults(
    ...
    attributes: Optional[PvcInstance] = None
    instances: Optional[List[Optional[PvcInstance]]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PvcsDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PvcsDefaults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    PvcInstance.from_dict(obj["attributes"])
                    if obj.get("attributes") is not None
                    else None
                ),
                "instances": (
                    [PvcInstance.from_dict(_item) for _item in obj["instances"]]
