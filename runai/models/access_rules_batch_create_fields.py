...
class AccessRulesBatchCreateFields(BaseModel):
    """
    Pydantic class model representing AccessRulesBatchCreateFields.

    Parameters:
        ```python
        payload: AccessRulesBatchCreateFieldsPayload
        ```
        payload: See model AccessRulesBatchCreateFieldsPayload for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessRulesBatchCreateFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessRulesBatchCreateFields from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "payload": (
                    AccessRulesBatchCreateFieldsPayload.from_dict(obj["payload"])
