...
class TrainingSpecificRunParams(BaseModel):
    """
    Pydantic class model representing TrainingSpecificRunParams.
    ...
    Parameters:
        ...
        master: Optional[InfoDistMaster]
        ```
        ...
        master: See model InfoDistMaster for more information.
    Example:
        ```python
        TrainingSpecificRunParams(
            command='python',
                    ...
                    runai.models.specific_run_connection_info.SpecificRunConnectionInfo(
                        ...
                        no_master=True,
                        dist_framework='MPI',
                        master=runai.models.info_dist_master.InfoDistMaster(
    ...
    master: Optional[InfoDistMaster] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainingSpecificRunParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainingSpecificRunParams from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "master": (
                    InfoDistMaster.from_dict(obj["master"])
