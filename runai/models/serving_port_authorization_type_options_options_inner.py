...
class ServingPortAuthorizationTypeOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing ServingPortAuthorizationTypeOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[ServingPortAccessAuthorizationTypeEnum]
        displayed: Optional[str]
        ```
        value: See model ServingPortAccessAuthorizationTypeEnum for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServingPortAuthorizationTypeOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServingPortAuthorizationTypeOptionsOptionsInner from a dict"""
        if obj is None:
            return None
