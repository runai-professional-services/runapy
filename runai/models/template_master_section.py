...
class TemplateMasterSection(BaseModel):
    """
    Pydantic class model representing TemplateMasterSection.

    Parameters:
        ```python
        spec: Optional[MasterTemplateSpec]
        assets: Optional[object]
        ```
        spec: See model MasterTemplateSpec for more information.
    ...
    spec: Optional[MasterTemplateSpec] = None
    assets: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["spec", "assets"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TemplateMasterSection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TemplateMasterSection from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "spec": (
                    MasterTemplateSpec.from_dict(obj["spec"])
