...
class StorageClassConfiguration(BaseModel):
    """
    Pydantic class model representing StorageClassConfiguration.
    ...
    Parameters:
        ...
        ```
        id: The unique identifier of the storage class configuration.
        tenant_id: The id of the tenant.
        scope_type: Currently supported value: &#39;cluster&#39;, which is also the default. - Default: &#39;cluster&#39;
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StorageClassConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StorageClassConfiguration from a dict"""
        if obj is None:
            return None
