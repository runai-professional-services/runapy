...
class PasswordListResponse(BaseModel):
    """
    Pydantic class model representing PasswordListResponse.

    Parameters:
        ```python
        entries: List[Password]
        ```
        entries: See model List[Password] for more information.
    Example:
        ```python
        PasswordListResponse(
            entries=[
                    runai.models.password.Password(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PasswordListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PasswordListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [Password.from_dict(_item) for _item in obj["entries"]]
