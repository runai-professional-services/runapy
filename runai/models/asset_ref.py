...
class AssetRef(BaseModel):
    """
    Pydantic class model representing Reference information about an asset..
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetRef from a dict"""
        if obj is None:
            return None
