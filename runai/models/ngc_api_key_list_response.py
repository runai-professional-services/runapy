...
class NgcApiKeyListResponse(BaseModel):
    """
    Pydantic class model representing NgcApiKeyListResponse.

    Parameters:
        ```python
        entries: List[NgcApiKey]
        ```
        entries: See model List[NgcApiKey] for more information.
    Example:
        ```python
        NgcApiKeyListResponse(
            entries=[
                    runai.models.ngc_api_key.NgcApiKey(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NgcApiKeyListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NgcApiKeyListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [NgcApiKey.from_dict(_item) for _item in obj["entries"]]
