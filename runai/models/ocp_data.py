...
class OcpData(BaseModel):
    """
    Pydantic class model representing OcpData.
    ...
    idp_base_url: Optional[StrictStr] = Field(default=None, alias="idpBaseUrl")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OcpData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OcpData from a dict"""
        if obj is None:
            return None
