...
class NodePoolQuotaStatus(BaseModel):
    """
    Pydantic class model representing NodePoolQuotaStatus.
    ...
    Parameters:
        ...
        allocated: See model QuotaStatusResourceList for more information.
        allocated_non_preemptible: See model QuotaStatusResourceList for more information.
        requested: See model QuotaStatusResourceList for more information.
    Example:
        ```python
        NodePoolQuotaStatus(
            node_pool_name='',
                    ...
                    cpu = 1000,
                    memory = 1000, ),
                        requested=runai.models.quota_status_resource_list.QuotaStatusResourceList(
                    gpu = 0,
                    cpu = 1000,
                    memory = 1000, )
        )
    ...
    allocated: Optional[QuotaStatusResourceList] = None
    allocated_non_preemptible: Optional[QuotaStatusResourceList] = Field(
        default=None, alias="allocatedNonPreemptible"
    )
    requested: Optional[QuotaStatusResourceList] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodePoolQuotaStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodePoolQuotaStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "allocated": (
                    QuotaStatusResourceList.from_dict(obj["allocated"])
                    if obj.get("allocated") is not None
                    else None
                ),
                "allocatedNonPreemptible": (
                    QuotaStatusResourceList.from_dict(obj["allocatedNonPreemptible"])
                    if obj.get("allocatedNonPreemptible") is not None
                    else None
                ),
                "requested": (
                    QuotaStatusResourceList.from_dict(obj["requested"])
