...
class AllowOverQuota(BaseModel):
    """
    Pydantic class model representing AllowOverQuota.
    ...
    __properties: ClassVar[List[str]] = ["allowOverQuota"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllowOverQuota from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllowOverQuota from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"allowOverQuota": obj.get("allowOverQuota")})
        return _obj
