...
class ChangeUserPassword200Response(BaseModel):
    """
    Pydantic class model representing ChangeUserPassword200Response.
    ...
    Parameters:
        ...
        new_password: str
        ```
        current_password: See model str for more information.
        new_password: See model str for more information.
    Example:
        ```python
