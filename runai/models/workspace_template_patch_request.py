...
class WorkspaceTemplatePatchRequest(BaseModel):
    """
    Pydantic class model representing WorkspaceTemplatePatchRequest.
    ...
    Parameters:
        ...
        spec: See model WorkspaceTemplateSpec for more information.
    Example:
        ```python
    ...
    spec: Optional[WorkspaceTemplateSpec] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceTemplatePatchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceTemplatePatchRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    WorkspaceTemplateSpec.from_dict(obj["spec"])
