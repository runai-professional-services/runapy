...
class ConfigMapsRules(BaseModel):
    """
    Pydantic class model representing ConfigMapsRules.

    Parameters:
        ```python
        attributes: Optional[ConfigMapRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model ConfigMapRules for more information.
    ...
    attributes: Optional[ConfigMapRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigMapsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigMapsRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    ConfigMapRules.from_dict(obj["attributes"])
