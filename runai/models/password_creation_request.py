...
class PasswordCreationRequest(BaseModel):
    """
    Pydantic class model representing PasswordCreationRequest.
    ...
    Parameters:
        ...
        spec: See model PasswordCreationSpec for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PasswordCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PasswordCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    PasswordCreationSpec.from_dict(obj["spec"])
