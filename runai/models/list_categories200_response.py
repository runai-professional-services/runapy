...
class ListCategories200Response(BaseModel):
    """
    Pydantic class model representing ListCategories200Response.

    Parameters:
        ```python
        categories: List[WorkloadCategory]
        ```
        categories: See model List[WorkloadCategory] for more information.
    Example:
        ```python
        ListCategories200Response(
            categories=[
                    runai.models.workload_category.WorkloadCategory(
                        id = '',
                        name = '',
                        description = '',
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCategories200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCategories200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "categories": (
                    [WorkloadCategory.from_dict(_item) for _item in obj["categories"]]
