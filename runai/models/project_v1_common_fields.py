...
class ProjectV1CommonFields(BaseModel):
    """
    Pydantic class model representing ProjectV1CommonFields.
    ...
    Parameters:
        ...
        node_affinity: Optional[ProjectV1NodeAffinity]
        ...
        node_affinity: See model ProjectV1NodeAffinity for more information.
        permissions: See model ProjectV1CommonFieldsPermissions for more information.
    ...
    node_affinity: Optional[ProjectV1NodeAffinity] = Field(
        default=None, alias="nodeAffinity"
    )
    permissions: Optional[ProjectV1CommonFieldsPermissions] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectV1CommonFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectV1CommonFields from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "nodeAffinity": (
                    ProjectV1NodeAffinity.from_dict(obj["nodeAffinity"])
                    if obj.get("nodeAffinity") is not None
                    else None
                ),
                "permissions": (
                    ProjectV1CommonFieldsPermissions.from_dict(obj["permissions"])
