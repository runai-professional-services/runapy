...
class DistributedFrameworkOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing DistributedFrameworkOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[DistributedFramework]
        displayed: Optional[str]
        ```
        value: See model DistributedFramework for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedFrameworkOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedFrameworkOptionsOptionsInner from a dict"""
        if obj is None:
            return None
