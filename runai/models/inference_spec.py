...
class InferenceSpec(BaseModel):
    """
    Pydantic class model representing The specifications of the inference to be created..
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferenceSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferenceSpec from a dict"""
        if obj is None:
            return None
