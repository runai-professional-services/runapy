...
class TrainingSpecSpec(BaseModel):
    """
    Pydantic class model representing TrainingSpecSpec.
    ...
    Parameters:
        ...
        completions: Used with Hyperparameter Optimization. Specifies the number of successful pods the job should reach to be completed. The Job will be marked as successful once the specified amount of pods has been reached.
        parallelism: Used with Hyperparameter Optimization. Specifies the maximum number of pods the workload should run at any given time.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainingSpecSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainingSpecSpec from a dict"""
        if obj is None:
            return None
