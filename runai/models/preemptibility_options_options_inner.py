...
class PreemptibilityOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing PreemptibilityOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[Preemptibility]
        displayed: Optional[str]
        ```
        value: See model Preemptibility for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PreemptibilityOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PreemptibilityOptionsOptionsInner from a dict"""
        if obj is None:
            return None
