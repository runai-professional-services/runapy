...
class PortServiceTypeRules(BaseModel):
    """
    Pydantic class model representing PortServiceTypeRules.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PortServiceTypeRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PortServiceTypeRules from a dict"""
        if obj is None:
            return None
