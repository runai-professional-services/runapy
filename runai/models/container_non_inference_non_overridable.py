...
class ContainerNonInferenceNonOverridable(BaseModel):
    """
    Pydantic class model representing Container non Inference overrideable fields. It adds properties which are not allowed for Inference containers.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContainerNonInferenceNonOverridable from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContainerNonInferenceNonOverridable from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"tty": obj.get("tty"), "stdin": obj.get("stdin")})
        return _obj
