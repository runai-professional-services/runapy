...
class DistributedInferencePolicyV2(BaseModel):
    """
    Pydantic class model representing DistributedInferencePolicyV2.

    Parameters:
        ```python
        meta: PolicyMeta
        policy: Optional[DistributedInferencePolicyDefaultsAndRulesV2]
        effective: Optional[DistributedInferencePolicyDefaultsAndRulesV2]
        effective_updated_at: datetime
        ```
        meta: See model PolicyMeta for more information.
        policy: See model DistributedInferencePolicyDefaultsAndRulesV2 for more information.
        effective: See model DistributedInferencePolicyDefaultsAndRulesV2 for more information.
        effective_updated_at: The time at which an event occurred. e.g. the time an effective policy has been updated
    Example:
        ```python
        DistributedInferencePolicyV2(
            meta="example",
    ...
    policy: Optional[DistributedInferencePolicyDefaultsAndRulesV2] = None
    effective: Optional[DistributedInferencePolicyDefaultsAndRulesV2] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedInferencePolicyV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedInferencePolicyV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "policy": (
                    DistributedInferencePolicyDefaultsAndRulesV2.from_dict(
                        obj["policy"]
                    )
