...
class VolumeModeCustomization(BaseModel):
    """
    Pydantic class model representing Defines whether the volumeMode field is required when creating PVCs and specifies default and supported modes for the storage class..
    ...
    Parameters:
        ...
        ```
        required: Indicates whether the volumeMode field is mandatory when creating a PVC.
