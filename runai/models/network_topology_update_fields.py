...
class NetworkTopologyUpdateFields(BaseModel):
    """
    Pydantic class model representing NetworkTopologyUpdateFields.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetworkTopologyUpdateFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetworkTopologyUpdateFields from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"levels": obj.get("levels")})
        return _obj
