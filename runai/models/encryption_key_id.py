...
class EncryptionKeyId(BaseModel):
    """
    Pydantic class model representing EncryptionKeyId.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EncryptionKeyId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EncryptionKeyId from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"keyId": obj.get("keyId")})
        return _obj
