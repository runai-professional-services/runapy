...
class ResourceType(str, Enum):
    ...
    SERVICE_MINUS_ACCOUNT = 'service-account'
    ...
    SCRAPEABLE_MINUS_METRICS = 'scrapeable-metrics'
    ...
    Example:
        ...
        ResourceType.USERS
        ResourceType.APPS
        ResourceType.SERVICE_MINUS_ACCOUNT
