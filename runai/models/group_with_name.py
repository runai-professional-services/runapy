...
class GroupWithName(BaseModel):
    """
    Pydantic class model representing GroupWithName.
    ...
    username: Optional[StrictStr] = Field(default=None, description="group name")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupWithName from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupWithName from a dict"""
        if obj is None:
            return None
