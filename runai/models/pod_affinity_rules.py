...
class PodAffinityRules(BaseModel):
    """
    Pydantic class model representing PodAffinityRules.

    Parameters:
        ```python
        type: Optional[PodAffinityTypeRules]
        key: Optional[StringRules]
        ```
        type: See model PodAffinityTypeRules for more information.
    ...
    type: Optional[PodAffinityTypeRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PodAffinityRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PodAffinityRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "type": (
                    PodAffinityTypeRules.from_dict(obj["type"])
