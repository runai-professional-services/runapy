...
class WorkloadV2SyncStatus(str, Enum):
    """
    ...
    Example:
        ```python
        WorkloadV2SyncStatus.QUEUED
        WorkloadV2SyncStatus.APPLYING
        WorkloadV2SyncStatus.DELETING
        WorkloadV2SyncStatus.SYNCED
        WorkloadV2SyncStatus.DELETED
        WorkloadV2SyncStatus.FAILED
        ```
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WorkloadV2SyncStatus from a JSON string"""
