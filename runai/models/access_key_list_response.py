...
class AccessKeyListResponse(BaseModel):
    """
    Pydantic class model representing AccessKeyListResponse.

    Parameters:
        ```python
        entries: List[AccessKey]
        ```
        entries: See model List[AccessKey] for more information.
    Example:
        ```python
        AccessKeyListResponse(
            entries=[
                    runai.models.access_key.AccessKey(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "entries": (
                    [AccessKey.from_dict(_item) for _item in obj["entries"]]
