...
class GitsDefaults(BaseModel):
    """
    Pydantic class model representing GitsDefaults.

    Parameters:
        ```python
        attributes: Optional[GitInstance]
        instances: Optional[List[GitInstance]]
        ```
        attributes: See model GitInstance for more information.
        instances: Set of git repositories to use in the workload.
    Example:
        ```python
        GitsDefaults(
    ...
    attributes: Optional[GitInstance] = None
    instances: Optional[List[Optional[GitInstance]]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitsDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitsDefaults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    GitInstance.from_dict(obj["attributes"])
                    if obj.get("attributes") is not None
                    else None
                ),
                "instances": (
                    [GitInstance.from_dict(_item) for _item in obj["instances"]]
