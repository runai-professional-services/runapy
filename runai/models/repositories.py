...
class Repositories(BaseModel):
    """
    Pydantic class model representing Repositories.

    Parameters:
        ```python
        repositories: List[str]
        ```
        repositories: See model List[str] for more information.
    Example:
        ```python
        Repositories(
            repositories=[
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"repositories": obj.get("repositories")})
        return _obj
