...
class S3sDefaults(BaseModel):
    """
    Pydantic class model representing S3sDefaults.

    Parameters:
        ```python
        attributes: Optional[S3Instance]
        instances: Optional[List[S3Instance]]
        ```
        attributes: See model S3Instance for more information.
        instances: Set of s3 buckets to use in the workload.
    Example:
        ```python
        S3sDefaults(
    ...
    attributes: Optional[S3Instance] = None
    instances: Optional[List[Optional[S3Instance]]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of S3sDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of S3sDefaults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    S3Instance.from_dict(obj["attributes"])
                    if obj.get("attributes") is not None
                    else None
                ),
                "instances": (
                    [S3Instance.from_dict(_item) for _item in obj["instances"]]
