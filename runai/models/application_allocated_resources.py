...
class ApplicationAllocatedResources(BaseModel):
    """
    Pydantic class model representing ApplicationAllocatedResources.
    ...
    Parameters:
        ...
        ```
        gpu: States the number of GPUs allocated for the created workloads.
        gpu_memory: See model str for more information.
        cpu: States the amount of CPU cores used by the workloads running.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplicationAllocatedResources from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplicationAllocatedResources from a dict"""
        if obj is None:
            return None
