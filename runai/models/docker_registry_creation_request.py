...
class DockerRegistryCreationRequest(BaseModel):
    """
    Pydantic class model representing DockerRegistryCreationRequest.
    ...
    Parameters:
        ...
        spec: See model DockerRegistryCreationSpec for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DockerRegistryCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DockerRegistryCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    DockerRegistryCreationSpec.from_dict(obj["spec"])
