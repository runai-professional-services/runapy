...
class AnnotationsDefaults(BaseModel):
    """
    Pydantic class model representing AnnotationsDefaults.

    Parameters:
        ```python
        instances: Optional[List[Annotation]]
        ```
        instances: Set of annotations to populate into the container running the workspace.
    Example:
        ```python
        AnnotationsDefaults(
            instances=[
    ...
    instances: Optional[List[Optional[Annotation]]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnnotationsDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnnotationsDefaults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "instances": (
                    [Annotation.from_dict(_item) for _item in obj["instances"]]
