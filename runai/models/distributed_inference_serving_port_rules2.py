...
class DistributedInferenceServingPortRules2(BaseModel):
    """
    ...
    Parameters:
        ...
        authorization_type: Optional[DistributedInferenceServingPortAuthorizationTypeRules]
        ...
        authorization_type: See model DistributedInferenceServingPortAuthorizationTypeRules for more information.
        ...
        DistributedInferenceServingPortRules2(
            port=runai.models.integer_rules.IntegerRules(
                    ...
                    default_from = runai.models.default_from_rule.DefaultFromRule(
                        ...
                        authorization_type=runai.models.distributed_inference_serving_port_authorization_type_rules.DistributedInferenceServingPortAuthorizationTypeRules(),
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedInferenceServingPortRules2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedInferenceServingPortRules2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "authorizationType": (
                    DistributedInferenceServingPortAuthorizationTypeRules.from_dict(
