...
class RelatedUrlsRules(BaseModel):
    """
    Pydantic class model representing RelatedUrlsRules.

    Parameters:
        ```python
        attributes: Optional[RelatedUrlRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model RelatedUrlRules for more information.
    ...
    attributes: Optional[RelatedUrlRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RelatedUrlsRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RelatedUrlsRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    RelatedUrlRules.from_dict(obj["attributes"])
