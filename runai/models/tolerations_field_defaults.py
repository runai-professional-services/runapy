...
class TolerationsFieldDefaults(BaseModel):
    """
    Pydantic class model representing TolerationsFieldDefaults.
    ...
    __properties: ClassVar[List[str]] = ["tolerations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TolerationsFieldDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TolerationsFieldDefaults from a dict"""
        if obj is None:
            return None
