...
class TolerationsDefaults(BaseModel):
    """
    Pydantic class model representing TolerationsDefaults.

    Parameters:
        ```python
        attributes: Optional[Toleration]
        instances: Optional[List[Toleration]]
        ```
        attributes: See model Toleration for more information.
        instances: Set of tolerations to apply to the workload.
    Example:
        ```python
        TolerationsDefaults(
    ...
    attributes: Optional[Toleration] = None
    instances: Optional[List[Optional[Toleration]]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TolerationsDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TolerationsDefaults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    Toleration.from_dict(obj["attributes"])
                    if obj.get("attributes") is not None
                    else None
                ),
                "instances": (
                    [Toleration.from_dict(_item) for _item in obj["instances"]]
