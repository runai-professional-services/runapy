...
class PortsDefaults(BaseModel):
    """
    Pydantic class model representing PortsDefaults.

    Parameters:
        ```python
        attributes: Optional[Port]
        instances: Optional[List[Port]]
        ```
        attributes: See model Port for more information.
        instances: Set of container ports that the workload exposes.
    Example:
        ```python
        PortsDefaults(
    ...
    attributes: Optional[Port] = None
    instances: Optional[List[Optional[Port]]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PortsDefaults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PortsDefaults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    Port.from_dict(obj["attributes"])
                    if obj.get("attributes") is not None
                    else None
                ),
                "instances": (
                    [Port.from_dict(_item) for _item in obj["instances"]]
