...
class SupersetWorkload(BaseModel):
    ...
    Parameters:
        ...
        master_spec: See model object for more information.
    Example:
        ```python
        SupersetWorkload(
    ...
    master_spec: Optional[Dict[str, Any]] = Field(default=None, alias="masterSpec")
