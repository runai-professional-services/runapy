...
class GenericSecret(BaseModel):
    """
    Pydantic class model representing GenericSecret.
    ...
    Parameters:
        ...
        spec: See model GenericSecretSpec for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenericSecret from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenericSecret from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    GenericSecretSpec.from_dict(obj["spec"])
