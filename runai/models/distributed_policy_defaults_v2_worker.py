...
class DistributedPolicyDefaultsV2Worker(BaseModel):
    """
    Pydantic class model representing DistributedPolicyDefaultsV2Worker.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DistributedPolicyDefaultsV2Worker from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DistributedPolicyDefaultsV2Worker from a dict"""
        if obj is None:
            return None
