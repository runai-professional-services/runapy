...
class NimServicePolicy(BaseModel):
    """
    Pydantic class model representing NimServicePolicy.

    Parameters:
        ```python
        meta: PolicyMeta
        policy: Optional[NimServicePolicyDefaultsAndRules]
        effective: Optional[NimServicePolicyDefaultsAndRules]
        effective_updated_at: datetime
        ```
        meta: See model PolicyMeta for more information.
        policy: See model NimServicePolicyDefaultsAndRules for more information.
        effective: See model NimServicePolicyDefaultsAndRules for more information.
        ...
        NimServicePolicy(
            meta="example",
                    ...
                    status = runai.models.policy_validation_status.PolicyValidationStatus(
                        ...
                        effective=runai.models.nim_service_policy_defaults_and_rules.NimServicePolicyDefaultsAndRules(
                    defaults = runai.models.defaults.defaults(),
                    rules = runai.models.rules.rules(),
                    status = runai.models.policy_validation_status.PolicyValidationStatus(
                        validation = runai.models.policy_validation_status_validation.PolicyValidationStatus_validation(
    ...
    policy: Optional[NimServicePolicyDefaultsAndRules] = None
    effective: Optional[NimServicePolicyDefaultsAndRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NimServicePolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NimServicePolicy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "policy": (
                    NimServicePolicyDefaultsAndRules.from_dict(obj["policy"])
                    if obj.get("policy") is not None
                    else None
                ),
                "effective": (
                    NimServicePolicyDefaultsAndRules.from_dict(obj["effective"])
