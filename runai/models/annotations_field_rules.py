...
class AnnotationsFieldRules(BaseModel):
    """
    Pydantic class model representing AnnotationsFieldRules.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnnotationsFieldRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnnotationsFieldRules from a dict"""
        if obj is None:
            return None
