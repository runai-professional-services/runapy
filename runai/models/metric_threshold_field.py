...
class MetricThresholdField(BaseModel):
    """
    Pydantic class model representing MetricThresholdField.
    ...
    __properties: ClassVar[List[str]] = ["metricThreshold"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetricThresholdField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetricThresholdField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"metricThreshold": obj.get("metricThreshold")})
        return _obj
