...
class NfssRules(BaseModel):
    """
    Pydantic class model representing NfssRules.

    Parameters:
        ```python
        attributes: Optional[NfsRules]
        instances: Optional[ItemRules]
        ```
        attributes: See model NfsRules for more information.
    ...
    attributes: Optional[NfsRules] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NfssRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NfssRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    NfsRules.from_dict(obj["attributes"])
