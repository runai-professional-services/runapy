...
class GenericSecretCreationRequest(BaseModel):
    """
    Pydantic class model representing GenericSecretCreationRequest.
    ...
    Parameters:
        ...
        spec: See model GenericSecretCreationSpec for more information.
    Example:
        ```python
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenericSecretCreationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenericSecretCreationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    GenericSecretCreationSpec.from_dict(obj["spec"])
