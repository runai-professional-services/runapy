...
class Project1Metadata(BaseModel):
    """
    Pydantic class model representing Project1Metadata.
    ...
    Parameters:
        ...
        cluster_name: str
        ```
        project_id: See model int for more information.
    ...
    department_id: Annotated[int, Field(strict=True, ge=1)] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Project1Metadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Project1Metadata from a dict"""
        if obj is None:
            return None
