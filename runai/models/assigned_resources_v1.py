...
class AssignedResourcesV1(BaseModel):
    """
    Pydantic class model representing AssignedResourcesV1.
    ...
    Example:
        ...
        AssignedResourcesV1(
            id=1.337,
                        gpu=runai.models.resource_v1.ResourceV1(
                    deserved = 0,
                    max_allowed = 1000,
                    over_quota_weight = 2, ),
    ...
    gpu: Optional[ResourceV1] = Field(default=None, description="GPU number assigned")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssignedResourcesV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssignedResourcesV1 from a dict"""
        if obj is None:
            return None
