...
class GroupedMetricsResponse(BaseModel):
    """
    Pydantic class model representing GroupedMetricsResponse.

    Parameters:
        ```python
        measurements: List[GroupedMeasurementResponse]
        ```
        measurements: See model List[GroupedMeasurementResponse] for more information.
    Example:
        ```python
        GroupedMetricsResponse(
            measurements=[
                    runai.models.grouped_measurement_response.GroupedMeasurementResponse(
                        type = 'ALLOCATED_GPU',
                        labels = {'gpu': '3'},
                        values = [
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupedMetricsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupedMetricsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "measurements": (
                    [
                        GroupedMeasurementResponse.from_dict(_item)
