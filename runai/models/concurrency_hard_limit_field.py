...
class ConcurrencyHardLimitField(BaseModel):
    """
    Pydantic class model representing ConcurrencyHardLimitField.
    ...
    __properties: ClassVar[List[str]] = ["concurrencyHardLimit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConcurrencyHardLimitField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConcurrencyHardLimitField from a dict"""
        if obj is None:
            return None
