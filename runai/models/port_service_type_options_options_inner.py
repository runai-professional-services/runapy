...
class PortServiceTypeOptionsOptionsInner(BaseModel):
    """
    Pydantic class model representing PortServiceTypeOptionsOptionsInner.

    Parameters:
        ```python
        value: Optional[PortServiceType]
        displayed: Optional[str]
        ```
        value: See model PortServiceType for more information.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PortServiceTypeOptionsOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PortServiceTypeOptionsOptionsInner from a dict"""
        if obj is None:
            return None
