...
class ServiceAccount(BaseModel):
    """
    Pydantic class model representing ServiceAccount.
    ...
    Parameters:
        ...
        created_by: The email address of the user who created the service account.
        created_at: The timestamp for when the service account was created.
        updated_at: The timestamp for when the service account was last updated.
        enabled: Indicates whether the service account is enabled.
        tenant_id: The unique identifier of the tenant.
        last_login: The timestamp of the last time the service account was used to authenticate.
