...
class ProjectUpdateRequest(BaseModel):
    ...
    Parameters:
        ...
        enforce_run_ai_scheduler: a flag to enforce that all pods in this namespace will be scheduled with runai-scheduler. Supported for cluster v2.21+
        ...
        _obj = cls.model_validate(
            {
                ...
                "enforceRun:aiScheduler": obj.get("enforceRun:aiScheduler"),
                "resources": (
