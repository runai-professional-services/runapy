...
class GitApi(RunaiAPIService):
    ...
    def create_git_asset(
        self,
        git_creation_request: Optional[models.GitCreationRequest] = None,
    ):
        r"""
        ...
        ### Parameters:
        ```python
        git_creation_request: GitCreationRequest
        ```
        git_creation_request: See model GitCreationRequest for more information.

        ### Example:
        ```python
        GitApi(
            git_creation_request=runai.GitCreationRequest()
        )
        ```
        """

        # Body params:
        body_params = git_creation_request

        resource_path = f"/api/v1/asset/datasource/git".replace("_", "-")
        method = "POST"
    ...
    def delete_git_asset_by_id(
        ...
        resource_path = f"/api/v1/asset/datasource/git/{asset_id}".replace("_", "-")
        method = "DELETE"
        return self._api_client.call_api(
            resource_path=resource_path,
            method=method,
    ...
    def update_git_asset_by_id(
        self,
        asset_id: str,
        git_update_request: Optional[models.GitUpdateRequest] = None,
    ):
        r"""
        ...
        ```python
        asset_id: str
        git_update_request: GitUpdateRequest
        ```
        asset_id: Unique identifier of the asset.
        git_update_request: See model GitUpdateRequest for more information.

        ### Example:
        ```python
        GitApi(
            asset_id='asset_id_example',
                        git_update_request=runai.GitUpdateRequest()
        )
        ```
        """

        # Body params:
        body_params = git_update_request
