...
class ConfigMapApi(RunaiAPIService):
    ...
    def create_config_map_asset(
        self,
        config_map_creation_request: Optional[models.ConfigMapCreationRequest] = None,
    ):
        r"""
        ...
        ### Parameters:
        ```python
        config_map_creation_request: ConfigMapCreationRequest
        ```
        config_map_creation_request: See model ConfigMapCreationRequest for more information.

        ### Example:
        ```python
        ConfigMapApi(
            config_map_creation_request=runai.ConfigMapCreationRequest()
        )
        ```
        """

        # Body params:
        body_params = config_map_creation_request

        resource_path = f"/api/v1/asset/datasource/config_map".replace("_", "-")
        method = "POST"
    ...
    def delete_config_map_asset_by_id(
        self,
        asset_id: str,
    ):
        r"""
        ...
        resource_path = f"/api/v1/asset/datasource/config_map/{asset_id}".replace(
            "_", "-"
        )
        method = "DELETE"
        return self._api_client.call_api(
    ...
    def get_config_map_asset_by_id(
        self,
        asset_id: str,
    ...
    def update_config_map_asset_by_id(
        self,
        asset_id: str,
        config_map_update_request: Optional[models.ConfigMapUpdateRequest] = None,
    ):
        r"""
        ...
        ```python
        asset_id: str
        config_map_update_request: ConfigMapUpdateRequest
        ```
        asset_id: Unique identifier of the asset.
        config_map_update_request: See model ConfigMapUpdateRequest for more information.

        ### Example:
        ```python
        ConfigMapApi(
            asset_id='asset_id_example',
                        config_map_update_request=runai.ConfigMapUpdateRequest()
        )
        ```
        """

        # Body params:
        body_params = config_map_update_request
