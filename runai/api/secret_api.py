...
class SecretApi(RunaiAPIService):
    ...
    def create_secret_asset(
        self,
        secret_asset_creation_request: Optional[
            models.SecretAssetCreationRequest
        ] = None,
    ):
        r"""
        ...
        ### Parameters:
        ```python
        secret_asset_creation_request: SecretAssetCreationRequest
        ```
        secret_asset_creation_request: See model SecretAssetCreationRequest for more information.

        ### Example:
        ```python
        SecretApi(
            secret_asset_creation_request=runai.SecretAssetCreationRequest()
        )
        ```
        """

        # Body params:
        body_params = secret_asset_creation_request

        resource_path = f"/api/v1/asset/datasource/secrets".replace("_", "-")
        method = "POST"
    ...
    def delete_secret_asset_by_id(
        ...
        resource_path = f"/api/v1/asset/datasource/secrets/{asset_id}".replace("_", "-")
        method = "DELETE"
        return self._api_client.call_api(
            resource_path=resource_path,
            method=method,
    ...
    def update_secret_asset_by_id(
        self,
        asset_id: str,
        secret_asset_update_request: Optional[models.SecretAssetUpdateRequest] = None,
    ):
        r"""
        ...
        ```python
        asset_id: str
        secret_asset_update_request: SecretAssetUpdateRequest
        ```
        asset_id: Unique identifier of the asset.
        secret_asset_update_request: See model SecretAssetUpdateRequest for more information.

        ### Example:
        ```python
        SecretApi(
            asset_id='asset_id_example',
                        secret_asset_update_request=runai.SecretAssetUpdateRequest()
        )
        ```
        """

        # Body params:
        body_params = secret_asset_update_request
