...
class TestNimServiceServingPortRules(unittest.TestCase):
    """NimServiceServingPortRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceServingPortRules:
        """Test NimServiceServingPortRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceServingPortRules`

        # model = NimServiceServingPortRules()
        if include_optional:
            return NimServiceServingPortRules(
    ...
    def testNimServiceServingPortRules(self):
        """Test NimServiceServingPortRules"""
