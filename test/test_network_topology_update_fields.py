...
class TestNetworkTopologyUpdateFields(unittest.TestCase):
    """NetworkTopologyUpdateFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkTopologyUpdateFields:
        """Test NetworkTopologyUpdateFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NetworkTopologyUpdateFields`

        # model = NetworkTopologyUpdateFields()
        if include_optional:
            return NetworkTopologyUpdateFields(
                levels=[
    ...
    def testNetworkTopologyUpdateFields(self):
        """Test NetworkTopologyUpdateFields"""
