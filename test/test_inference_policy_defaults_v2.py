...
class TestInferencePolicyDefaultsV2(unittest.TestCase):
    """InferencePolicyDefaultsV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferencePolicyDefaultsV2:
        """Test InferencePolicyDefaultsV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferencePolicyDefaultsV2`

        # model = InferencePolicyDefaultsV2()
        if include_optional:
            return InferencePolicyDefaultsV2(
    ...
    def testInferencePolicyDefaultsV2(self):
        """Test InferencePolicyDefaultsV2"""
