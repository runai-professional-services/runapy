...
class TestSupersetRulesAllOfStorage(unittest.TestCase):
    """SupersetRulesAllOfStorage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupersetRulesAllOfStorage:
        """Test SupersetRulesAllOfStorage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupersetRulesAllOfStorage`

        # model = SupersetRulesAllOfStorage()
        if include_optional:
            return SupersetRulesAllOfStorage(
    ...
    def testSupersetRulesAllOfStorage(self):
        """Test SupersetRulesAllOfStorage"""
