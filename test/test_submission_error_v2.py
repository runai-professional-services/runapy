...
class TestSubmissionErrorV2(unittest.TestCase):
    """SubmissionErrorV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmissionErrorV2:
        """Test SubmissionErrorV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SubmissionErrorV2`

        # model = SubmissionErrorV2()
        if include_optional:
            return SubmissionErrorV2(
                code=100,
                message="",
                details="",
                compliance_issues=[
    ...
    def testSubmissionErrorV2(self):
        """Test SubmissionErrorV2"""
