...
class TestNimServiceResponse(unittest.TestCase):
    """NimServiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceResponse:
        """Test NimServiceResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceResponse`

        # model = NimServiceResponse()
        if include_optional:
            return NimServiceResponse(
                metadata=None,
    ...
    def testNimServiceResponse(self):
        """Test NimServiceResponse"""
