...
class TestMeAccessRulesResponseAccessRules(unittest.TestCase):
    """MeAccessRulesResponseAccessRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeAccessRulesResponseAccessRules:
        """Test MeAccessRulesResponseAccessRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MeAccessRulesResponseAccessRules`

        # model = MeAccessRulesResponseAccessRules()
        if include_optional:
            return MeAccessRulesResponseAccessRules(
    ...
    def testMeAccessRulesResponseAccessRules(self):
        """Test MeAccessRulesResponseAccessRules"""
