...
class TestProjectV1NodeAffinityResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectV1NodeAffinityResponse:
        """Test ProjectV1NodeAffinityResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectV1NodeAffinityResponse`

        # model = ProjectV1NodeAffinityResponse()
        if include_optional:
            return ProjectV1NodeAffinityResponse(
