...
class TestNotificationChannelResponse(unittest.TestCase):
    """NotificationChannelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationChannelResponse:
        """Test NotificationChannelResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NotificationChannelResponse`
    ...
    def testNotificationChannelResponse(self):
        """Test NotificationChannelResponse"""
