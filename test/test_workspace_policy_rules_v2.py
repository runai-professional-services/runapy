...
class TestWorkspacePolicyRulesV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WorkspacePolicyRulesV2:
        """Test WorkspacePolicyRulesV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspacePolicyRulesV2`

        # model = WorkspacePolicyRulesV2()
        if include_optional:
            return WorkspacePolicyRulesV2(
