...
class TestRelatedUrlsRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RelatedUrlsRules:
        """Test RelatedUrlsRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RelatedUrlsRules`

        # model = RelatedUrlsRules()
        if include_optional:
            return RelatedUrlsRules(
