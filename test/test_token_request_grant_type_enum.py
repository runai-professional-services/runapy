...
class TestTokenRequestGrantTypeEnum(unittest.TestCase):
    """TokenRequestGrantTypeEnum unit test stubs"""
    ...
    def testTokenRequestGrantTypeEnum(self):
        """Test TokenRequestGrantTypeEnum"""
        inst = TokenRequestGrantTypeEnum()
