...
class TestPolicyCrossType(unittest.TestCase):
    """PolicyCrossType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyCrossType:
        """Test PolicyCrossType
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PolicyCrossType`

        # model = PolicyCrossType()
        if include_optional:
            return PolicyCrossType(
