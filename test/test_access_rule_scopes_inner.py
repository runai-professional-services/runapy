...
class TestAccessRuleScopesInner(unittest.TestCase):
    """AccessRuleScopesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessRuleScopesInner:
        """Test AccessRuleScopesInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessRuleScopesInner`

        # model = AccessRuleScopesInner()
        if include_optional:
            return AccessRuleScopesInner(scope_id="", scope_type="system")
        else:
            return AccessRuleScopesInner(
                scope_id="",
                scope_type="system",
            )

    def testAccessRuleScopesInner(self):
        """Test AccessRuleScopesInner"""
