...
class TestAdvancedFlatFieldsRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AdvancedFlatFieldsRules:
        """Test AdvancedFlatFieldsRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AdvancedFlatFieldsRules`

        # model = AdvancedFlatFieldsRules()
        if include_optional:
            return AdvancedFlatFieldsRules(
