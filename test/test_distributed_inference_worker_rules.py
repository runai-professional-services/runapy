...
class TestDistributedInferenceWorkerRules(unittest.TestCase):
    """DistributedInferenceWorkerRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceWorkerRules:
        """Test DistributedInferenceWorkerRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceWorkerRules`

        # model = DistributedInferenceWorkerRules()
        if include_optional:
            return DistributedInferenceWorkerRules(
    ...
    def testDistributedInferenceWorkerRules(self):
        """Test DistributedInferenceWorkerRules"""
