...
class TestDistributedInferenceLeaderSpecFields(unittest.TestCase):
    """DistributedInferenceLeaderSpecFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceLeaderSpecFields:
        """Test DistributedInferenceLeaderSpecFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceLeaderSpecFields`

        # model = DistributedInferenceLeaderSpecFields()
        if include_optional:
            return DistributedInferenceLeaderSpecFields(
    ...
    def testDistributedInferenceLeaderSpecFields(self):
        """Test DistributedInferenceLeaderSpecFields"""
