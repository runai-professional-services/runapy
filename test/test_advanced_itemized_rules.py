...
class TestAdvancedItemizedRules(unittest.TestCase):
    """AdvancedItemizedRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvancedItemizedRules:
        """Test AdvancedItemizedRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AdvancedItemizedRules`

        # model = AdvancedItemizedRules()
        if include_optional:
            return AdvancedItemizedRules(
    ...
    def testAdvancedItemizedRules(self):
        """Test AdvancedItemizedRules"""
