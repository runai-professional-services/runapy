...
class TestActionsSupport(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActionsSupport:
        """Test ActionsSupport
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ActionsSupport`

        # model = ActionsSupport()
        if include_optional:
            return ActionsSupport(delete=True, suspend=True)
        else:
