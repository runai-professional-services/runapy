...
class TestTolerationOperatorOptions(unittest.TestCase):
    """TolerationOperatorOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TolerationOperatorOptions:
        """Test TolerationOperatorOptions
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TolerationOperatorOptions`

        # model = TolerationOperatorOptions()
        if include_optional:
            return TolerationOperatorOptions(
                options=[
    ...
    def testTolerationOperatorOptions(self):
        """Test TolerationOperatorOptions"""
