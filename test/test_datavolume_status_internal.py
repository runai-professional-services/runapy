...
class TestDatavolumeStatusInternal(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DatavolumeStatusInternal:
        """Test DatavolumeStatusInternal
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DatavolumeStatusInternal`

        # model = DatavolumeStatusInternal()
        if include_optional:
            return DatavolumeStatusInternal(
                phase="Ready",
