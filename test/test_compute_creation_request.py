...
class TestComputeCreationRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ComputeCreationRequest:
        """Test ComputeCreationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ComputeCreationRequest`

        # model = ComputeCreationRequest()
        if include_optional:
