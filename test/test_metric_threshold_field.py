...
class TestMetricThresholdField(unittest.TestCase):
    """MetricThresholdField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetricThresholdField:
        """Test MetricThresholdField
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MetricThresholdField`

        # model = MetricThresholdField()
        if include_optional:
            return MetricThresholdField(metric_threshold=56)
        else:
            return MetricThresholdField()

    def testMetricThresholdField(self):
        """Test MetricThresholdField"""
