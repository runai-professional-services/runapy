...
class TestProjectsResourcesResetRequest(unittest.TestCase):
    """ProjectsResourcesResetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectsResourcesResetRequest:
        """Test ProjectsResourcesResetRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectsResourcesResetRequest`

        # model = ProjectsResourcesResetRequest()
        if include_optional:
            return ProjectsResourcesResetRequest(
    ...
    def testProjectsResourcesResetRequest(self):
        """Test ProjectsResourcesResetRequest"""
