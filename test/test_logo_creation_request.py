...
class TestLogoCreationRequest(unittest.TestCase):
    """LogoCreationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogoCreationRequest:
        """Test LogoCreationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `LogoCreationRequest`

        # model = LogoCreationRequest()
        if include_optional:
            return LogoCreationRequest(logo="")
        else:
            return LogoCreationRequest(
                logo="",
            )

    def testLogoCreationRequest(self):
        """Test LogoCreationRequest"""
