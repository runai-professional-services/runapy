...
class TestDistributedInferenceImposedAssets(unittest.TestCase):
    """DistributedInferenceImposedAssets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceImposedAssets:
        """Test DistributedInferenceImposedAssets
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceImposedAssets`

        # model = DistributedInferenceImposedAssets()
        if include_optional:
            return DistributedInferenceImposedAssets(leader=[""], worker=[""])
        else:
            return DistributedInferenceImposedAssets()

    def testDistributedInferenceImposedAssets(self):
        """Test DistributedInferenceImposedAssets"""
