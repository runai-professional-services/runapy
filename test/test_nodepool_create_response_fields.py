...
class TestNodepoolCreateResponseFields(unittest.TestCase):
    """NodepoolCreateResponseFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodepoolCreateResponseFields:
        """Test NodepoolCreateResponseFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodepoolCreateResponseFields`

        # model = NodepoolCreateResponseFields()
        if include_optional:
            return NodepoolCreateResponseFields(
                name="v100",
                label_key="node-type",
                label_value="type-x",
    ...
    def testNodepoolCreateResponseFields(self):
        """Test NodepoolCreateResponseFields"""
