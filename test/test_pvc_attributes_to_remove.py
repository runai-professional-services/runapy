...
class TestPvcAttributesToRemove(unittest.TestCase):
    """PvcAttributesToRemove unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PvcAttributesToRemove:
        """Test PvcAttributesToRemove
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PvcAttributesToRemove`

        # model = PvcAttributesToRemove()
        if include_optional:
            return PvcAttributesToRemove(attributes_to_remove=["dnsname", "dnsip"])
        else:
            return PvcAttributesToRemove()

    def testPvcAttributesToRemove(self):
        """Test PvcAttributesToRemove"""
