...
class TestDepartmentCommonFields(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DepartmentCommonFields:
        """Test DepartmentCommonFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DepartmentCommonFields`

        # model = DepartmentCommonFields()
        if include_optional:
            return DepartmentCommonFields(
                name="default",
                deserved_gpus=2,
