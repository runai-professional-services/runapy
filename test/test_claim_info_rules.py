...
class TestClaimInfoRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClaimInfoRules:
        """Test ClaimInfoRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClaimInfoRules`

        # model = ClaimInfoRules()
        if include_optional:
            return ClaimInfoRules(
