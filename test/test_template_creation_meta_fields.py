...
class TestTemplateCreationMetaFields(unittest.TestCase):
    """TemplateCreationMetaFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateCreationMetaFields:
        """Test TemplateCreationMetaFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TemplateCreationMetaFields`

        # model = TemplateCreationMetaFields()
        if include_optional:
            return TemplateCreationMetaFields(
    ...
    def testTemplateCreationMetaFields(self):
        """Test TemplateCreationMetaFields"""
