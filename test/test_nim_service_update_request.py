...
class TestNimServiceUpdateRequest(unittest.TestCase):
    """NimServiceUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceUpdateRequest:
        """Test NimServiceUpdateRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceUpdateRequest`

        # model = NimServiceUpdateRequest()
        if include_optional:
            return NimServiceUpdateRequest(
                spec=None,
            )
        else:
            return NimServiceUpdateRequest(
    ...
    def testNimServiceUpdateRequest(self):
        """Test NimServiceUpdateRequest"""
