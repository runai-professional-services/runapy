...
class TestNimServiceCreateRequest(unittest.TestCase):
    """NimServiceCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceCreateRequest:
        """Test NimServiceCreateRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceCreateRequest`

        # model = NimServiceCreateRequest()
        if include_optional:
            return NimServiceCreateRequest(
    ...
    def testNimServiceCreateRequest(self):
        """Test NimServiceCreateRequest"""
