...
class TestIdpCreationRequest(unittest.TestCase):
    """IdpCreationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdpCreationRequest:
        """Test IdpCreationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `IdpCreationRequest`

        # model = IdpCreationRequest()
        if include_optional:
            return IdpCreationRequest(
                name="",
                type="saml",
    ...
    def testIdpCreationRequest(self):
        """Test IdpCreationRequest"""
