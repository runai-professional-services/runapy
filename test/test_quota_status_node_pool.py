...
class TestQuotaStatusNodePool(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QuotaStatusNodePool:
        """Test QuotaStatusNodePool
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `QuotaStatusNodePool`

        # model = QuotaStatusNodePool()
        if include_optional:
            return QuotaStatusNodePool(
