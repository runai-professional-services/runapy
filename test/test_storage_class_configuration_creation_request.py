...
class TestStorageClassConfigurationCreationRequest(unittest.TestCase):
    """StorageClassConfigurationCreationRequest unit test stubs"""
    ...
    def make_instance(
        ...
        """Test StorageClassConfigurationCreationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StorageClassConfigurationCreationRequest`

        # model = StorageClassConfigurationCreationRequest()
        if include_optional:
            return StorageClassConfigurationCreationRequest(
                tenant_id=1001,
                scope_type="cluster",
                scope_id="",
                name="Standard",
    ...
    def testStorageClassConfigurationCreationRequest(self):
        """Test StorageClassConfigurationCreationRequest"""
