...
class TestPvcAddedAttribute(unittest.TestCase):
    """PvcAddedAttribute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PvcAddedAttribute:
        """Test PvcAddedAttribute
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PvcAddedAttribute`

        # model = PvcAddedAttribute()
        if include_optional:
            return PvcAddedAttribute(
                key="dnsname",
                format="text",
                display="DNS Name",
    ...
    def testPvcAddedAttribute(self):
        """Test PvcAddedAttribute"""
