...
class TestTrainingPolicyRulesV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrainingPolicyRulesV2:
        """Test TrainingPolicyRulesV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TrainingPolicyRulesV2`

        # model = TrainingPolicyRulesV2()
        if include_optional:
            return TrainingPolicyRulesV2(
