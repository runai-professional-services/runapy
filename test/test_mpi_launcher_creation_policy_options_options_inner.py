...
class TestMpiLauncherCreationPolicyOptionsOptionsInner(unittest.TestCase):
    """MpiLauncherCreationPolicyOptionsOptionsInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test MpiLauncherCreationPolicyOptionsOptionsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MpiLauncherCreationPolicyOptionsOptionsInner`

        # model = MpiLauncherCreationPolicyOptionsOptionsInner()
        if include_optional:
            return MpiLauncherCreationPolicyOptionsOptionsInner(
                value="AtStartup", displayed="jUR,rZ#UM/?R,Fp^l6$ARj"
            )
        else:
            return MpiLauncherCreationPolicyOptionsOptionsInner(
                value="AtStartup",
    ...
    def testMpiLauncherCreationPolicyOptionsOptionsInner(self):
        """Test MpiLauncherCreationPolicyOptionsOptionsInner"""
