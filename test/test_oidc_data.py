...
class TestOidcData(unittest.TestCase):
    """OidcData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OidcData:
        """Test OidcData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OidcData`
