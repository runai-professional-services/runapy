...
class TestExtendedResourcesRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExtendedResourcesRules:
        """Test ExtendedResourcesRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExtendedResourcesRules`

        # model = ExtendedResourcesRules()
        if include_optional:
            return ExtendedResourcesRules(
