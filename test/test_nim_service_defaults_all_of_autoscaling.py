...
class TestNimServiceDefaultsAllOfAutoscaling(unittest.TestCase):
    """NimServiceDefaultsAllOfAutoscaling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceDefaultsAllOfAutoscaling:
        """Test NimServiceDefaultsAllOfAutoscaling
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceDefaultsAllOfAutoscaling`

        # model = NimServiceDefaultsAllOfAutoscaling()
        if include_optional:
            return NimServiceDefaultsAllOfAutoscaling(
                max_replicas=1,
    ...
    def testNimServiceDefaultsAllOfAutoscaling(self):
        """Test NimServiceDefaultsAllOfAutoscaling"""
