...
class TestComplianceIssuesV2ComplianceIssuesInner(unittest.TestCase):
    """ComplianceIssuesV2ComplianceIssuesInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test ComplianceIssuesV2ComplianceIssuesInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ComplianceIssuesV2ComplianceIssuesInner`

        # model = ComplianceIssuesV2ComplianceIssuesInner()
        if include_optional:
            return ComplianceIssuesV2ComplianceIssuesInner(
    ...
    def testComplianceIssuesV2ComplianceIssuesInner(self):
        """Test ComplianceIssuesV2ComplianceIssuesInner"""
