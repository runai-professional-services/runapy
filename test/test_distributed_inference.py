...
class TestDistributedInference(unittest.TestCase):
    """DistributedInference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInference:
        """Test DistributedInference
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInference`
    ...
    def testDistributedInference(self):
        """Test DistributedInference"""
