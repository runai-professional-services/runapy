...
class TestWorkloadTopology(unittest.TestCase):
    """WorkloadTopology unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadTopology:
        """Test WorkloadTopology
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadTopology`

        # model = WorkloadTopology()
        if include_optional:
            return WorkloadTopology(
                name="", preferred_placement="", required_placement=""
            )
        else:
            return WorkloadTopology()

    def testWorkloadTopology(self):
        """Test WorkloadTopology"""
