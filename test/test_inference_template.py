...
class TestInferenceTemplate(unittest.TestCase):
    """InferenceTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferenceTemplate:
        """Test InferenceTemplate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferenceTemplate`

        # model = InferenceTemplate()
        if include_optional:
    ...
    def testInferenceTemplate(self):
        """Test InferenceTemplate"""
