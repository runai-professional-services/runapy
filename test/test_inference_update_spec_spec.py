...
class TestInferenceUpdateSpecSpec(unittest.TestCase):
    """InferenceUpdateSpecSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferenceUpdateSpecSpec:
        """Test InferenceUpdateSpecSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferenceUpdateSpecSpec`
    ...
    def testInferenceUpdateSpecSpec(self):
        """Test InferenceUpdateSpecSpec"""
