...
class TestInferenceTemplatesListResponse(unittest.TestCase):
    """InferenceTemplatesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferenceTemplatesListResponse:
        """Test InferenceTemplatesListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferenceTemplatesListResponse`

        # model = InferenceTemplatesListResponse()
        if include_optional:
            return InferenceTemplatesListResponse(
                entries=[null],
    ...
    def testInferenceTemplatesListResponse(self):
        """Test InferenceTemplatesListResponse"""
