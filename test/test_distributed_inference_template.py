...
class TestDistributedInferenceTemplate(unittest.TestCase):
    """DistributedInferenceTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceTemplate:
        """Test DistributedInferenceTemplate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceTemplate`

        # model = DistributedInferenceTemplate()
        if include_optional:
            return DistributedInferenceTemplate(
    ...
    def testDistributedInferenceTemplate(self):
        """Test DistributedInferenceTemplate"""
