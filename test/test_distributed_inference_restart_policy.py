...
class TestDistributedInferenceRestartPolicy(unittest.TestCase):
    """DistributedInferenceRestartPolicy unit test stubs"""
    ...
    def testDistributedInferenceRestartPolicy(self):
        """Test DistributedInferenceRestartPolicy"""
        inst = DistributedInferenceRestartPolicy()
