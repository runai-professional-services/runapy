...
class TestDistributedInferenceLeaderWorkerTemplateSpec(unittest.TestCase):
    """DistributedInferenceLeaderWorkerTemplateSpec unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DistributedInferenceLeaderWorkerTemplateSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceLeaderWorkerTemplateSpec`

        # model = DistributedInferenceLeaderWorkerTemplateSpec()
        if include_optional:
            return DistributedInferenceLeaderWorkerTemplateSpec(
                annotations=[
    ...
    def testDistributedInferenceLeaderWorkerTemplateSpec(self):
        """Test DistributedInferenceLeaderWorkerTemplateSpec"""
