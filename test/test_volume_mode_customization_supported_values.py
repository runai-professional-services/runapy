...
class TestVolumeModeCustomizationSupportedValues(unittest.TestCase):
    """VolumeModeCustomizationSupportedValues unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VolumeModeCustomizationSupportedValues:
        """Test VolumeModeCustomizationSupportedValues
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VolumeModeCustomizationSupportedValues`

        # model = VolumeModeCustomizationSupportedValues()
        if include_optional:
            return VolumeModeCustomizationSupportedValues(filesystem=True, block=True)
        else:
            return VolumeModeCustomizationSupportedValues()

    def testVolumeModeCustomizationSupportedValues(self):
        """Test VolumeModeCustomizationSupportedValues"""
