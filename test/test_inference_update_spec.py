...
class TestInferenceUpdateSpec(unittest.TestCase):
    """InferenceUpdateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferenceUpdateSpec:
        """Test InferenceUpdateSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferenceUpdateSpec`

        # model = InferenceUpdateSpec()
        if include_optional:
            return InferenceUpdateSpec(
                spec=None,
            )
        else:
            return InferenceUpdateSpec()

    def testInferenceUpdateSpec(self):
        """Test InferenceUpdateSpec"""
