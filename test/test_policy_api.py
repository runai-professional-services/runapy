...
class TestPolicyApi(unittest.TestCase):
    ...
    def test_delete_nim_service_policy(self) -> None:
    ...
    def test_get_nim_service_policy(self) -> None:
    ...
    def test_overwrite_nim_service_policy(self) -> None:
    ...
    def test_update_nim_service_policy(self) -> None:
