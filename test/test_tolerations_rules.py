...
class TestTolerationsRules(unittest.TestCase):
    """TolerationsRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TolerationsRules:
        """Test TolerationsRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TolerationsRules`

        # model = TolerationsRules()
        if include_optional:
            return TolerationsRules(
