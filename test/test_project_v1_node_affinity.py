...
class TestProjectV1NodeAffinity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectV1NodeAffinity:
        """Test ProjectV1NodeAffinity
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectV1NodeAffinity`

        # model = ProjectV1NodeAffinity()
        if include_optional:
            return ProjectV1NodeAffinity(
