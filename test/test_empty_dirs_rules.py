...
class TestEmptyDirsRules(unittest.TestCase):
    """EmptyDirsRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmptyDirsRules:
        """Test EmptyDirsRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EmptyDirsRules`

        # model = EmptyDirsRules()
        if include_optional:
            return EmptyDirsRules(
