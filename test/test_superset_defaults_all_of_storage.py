...
class TestSupersetDefaultsAllOfStorage(unittest.TestCase):
    """SupersetDefaultsAllOfStorage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupersetDefaultsAllOfStorage:
        """Test SupersetDefaultsAllOfStorage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupersetDefaultsAllOfStorage`

        # model = SupersetDefaultsAllOfStorage()
        if include_optional:
            return SupersetDefaultsAllOfStorage(
    ...
    def testSupersetDefaultsAllOfStorage(self):
        """Test SupersetDefaultsAllOfStorage"""
