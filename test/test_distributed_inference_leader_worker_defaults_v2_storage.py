...
class TestDistributedInferenceLeaderWorkerDefaultsV2Storage(unittest.TestCase):
    """DistributedInferenceLeaderWorkerDefaultsV2Storage unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DistributedInferenceLeaderWorkerDefaultsV2Storage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceLeaderWorkerDefaultsV2Storage`

        # model = DistributedInferenceLeaderWorkerDefaultsV2Storage()
        if include_optional:
            return DistributedInferenceLeaderWorkerDefaultsV2Storage(
    ...
    def testDistributedInferenceLeaderWorkerDefaultsV2Storage(self):
        """Test DistributedInferenceLeaderWorkerDefaultsV2Storage"""
