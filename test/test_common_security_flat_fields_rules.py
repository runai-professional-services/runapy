...
class TestCommonSecurityFlatFieldsRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommonSecurityFlatFieldsRules:
        """Test CommonSecurityFlatFieldsRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CommonSecurityFlatFieldsRules`

        # model = CommonSecurityFlatFieldsRules()
        if include_optional:
            return CommonSecurityFlatFieldsRules(
