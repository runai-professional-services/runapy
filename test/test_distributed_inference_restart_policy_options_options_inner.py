...
class TestDistributedInferenceRestartPolicyOptionsOptionsInner(unittest.TestCase):
    """DistributedInferenceRestartPolicyOptionsOptionsInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DistributedInferenceRestartPolicyOptionsOptionsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceRestartPolicyOptionsOptionsInner`

        # model = DistributedInferenceRestartPolicyOptionsOptionsInner()
        if include_optional:
            return DistributedInferenceRestartPolicyOptionsOptionsInner(
                value="RecreateGroupOnPodRestart", displayed="jUR,rZ#UM/?R,Fp^l6$ARj"
            )
        else:
            return DistributedInferenceRestartPolicyOptionsOptionsInner(
    ...
    def testDistributedInferenceRestartPolicyOptionsOptionsInner(self):
        """Test DistributedInferenceRestartPolicyOptionsOptionsInner"""
