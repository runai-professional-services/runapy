...
class TestPreemptibilityOptions(unittest.TestCase):
    """PreemptibilityOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreemptibilityOptions:
        """Test PreemptibilityOptions
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PreemptibilityOptions`

        # model = PreemptibilityOptions()
        if include_optional:
            return PreemptibilityOptions(
                options=[
    ...
    def testPreemptibilityOptions(self):
        """Test PreemptibilityOptions"""
