...
class TestMpiLauncherCreationPolicyRules(unittest.TestCase):
    """MpiLauncherCreationPolicyRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MpiLauncherCreationPolicyRules:
        """Test MpiLauncherCreationPolicyRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MpiLauncherCreationPolicyRules`

        # model = MpiLauncherCreationPolicyRules()
        if include_optional:
            return MpiLauncherCreationPolicyRules(
    ...
    def testMpiLauncherCreationPolicyRules(self):
        """Test MpiLauncherCreationPolicyRules"""
