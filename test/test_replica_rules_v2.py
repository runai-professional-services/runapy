...
class TestReplicaRulesV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReplicaRulesV2:
        """Test ReplicaRulesV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ReplicaRulesV2`

        # model = ReplicaRulesV2()
        if include_optional:
            return ReplicaRulesV2(
