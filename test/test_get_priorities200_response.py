...
class TestGetPriorities200Response(unittest.TestCase):
    """GetPriorities200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPriorities200Response:
        """Test GetPriorities200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetPriorities200Response`

        # model = GetPriorities200Response()
        if include_optional:
            return GetPriorities200Response(
                priorities=[
    ...
    def testGetPriorities200Response(self):
        """Test GetPriorities200Response"""
