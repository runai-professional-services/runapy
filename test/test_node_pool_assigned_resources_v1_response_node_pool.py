...
class TestNodePoolAssignedResourcesV1ResponseNodePool(unittest.TestCase):
    ...
    def make_instance(
        ...
        # uncomment below to create an instance of `NodePoolAssignedResourcesV1ResponseNodePool`

        # model = NodePoolAssignedResourcesV1ResponseNodePool()
        if include_optional:
            return NodePoolAssignedResourcesV1ResponseNodePool(id=3, name="default")
        else:
            return NodePoolAssignedResourcesV1ResponseNodePool(
                id=3,
            )
