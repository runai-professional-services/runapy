...
class TestEnvironmentAssetRef(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnvironmentAssetRef:
        """Test EnvironmentAssetRef
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EnvironmentAssetRef`

        # model = EnvironmentAssetRef()
        if include_optional:
            return EnvironmentAssetRef(
                id="0", name="my-asset", tool_types=["jupyter-notebook"]
            )
        else:
            return EnvironmentAssetRef(
                id="0",
