...
class TestDistributedApi:
    ...
    def test_create_distributed(self):
        ...
        Create a distributed training. [Experimental] Use to create a distributed training.
        """
        # Mock response
    ...
    def test_delete_distributed(self):
        ...
        Delete a distributed training by id. [Experimental] Use to delete a distributed training by workload id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
