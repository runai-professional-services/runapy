...
class TestDatavolumeStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DatavolumeStatus:
        """Test DatavolumeStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DatavolumeStatus`

        # model = DatavolumeStatus()
        if include_optional:
            return DatavolumeStatus(
                phase="Ready",
