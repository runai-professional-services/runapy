...
class TestTrainingSpecificRunParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrainingSpecificRunParams:
        """Test TrainingSpecificRunParams
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TrainingSpecificRunParams`

        # model = TrainingSpecificRunParams()
        if include_optional:
            return TrainingSpecificRunParams(
                command="python",
                args="-x my-script.py",
                run_as_uid=500,
                run_as_gid=30,
