...
class TestTrainingTemplatesListResponseItem(unittest.TestCase):
    """TrainingTemplatesListResponseItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrainingTemplatesListResponseItem:
        """Test TrainingTemplatesListResponseItem
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TrainingTemplatesListResponseItem`

        # model = TrainingTemplatesListResponseItem()
        if include_optional:
            return TrainingTemplatesListResponseItem(
    ...
    def testTrainingTemplatesListResponseItem(self):
        """Test TrainingTemplatesListResponseItem"""
