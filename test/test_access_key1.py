...
class TestAccessKey1(unittest.TestCase):
    """AccessKey1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessKey1:
        """Test AccessKey1
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessKey1`
