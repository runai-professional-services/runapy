...
class TestNgcApiKeyListResponse(unittest.TestCase):
    """NgcApiKeyListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NgcApiKeyListResponse:
        """Test NgcApiKeyListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NgcApiKeyListResponse`

        # model = NgcApiKeyListResponse()
        if include_optional:
            return NgcApiKeyListResponse(
                entries=[
    ...
    def testNgcApiKeyListResponse(self):
        """Test NgcApiKeyListResponse"""
