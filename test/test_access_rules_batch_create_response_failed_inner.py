...
class TestAccessRulesBatchCreateResponseFailedInner(unittest.TestCase):
    """AccessRulesBatchCreateResponseFailedInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test AccessRulesBatchCreateResponseFailedInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessRulesBatchCreateResponseFailedInner`

        # model = AccessRulesBatchCreateResponseFailedInner()
        if include_optional:
            return AccessRulesBatchCreateResponseFailedInner(
    ...
    def testAccessRulesBatchCreateResponseFailedInner(self):
        """Test AccessRulesBatchCreateResponseFailedInner"""
