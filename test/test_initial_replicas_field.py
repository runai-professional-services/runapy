...
class TestInitialReplicasField(unittest.TestCase):
    """InitialReplicasField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitialReplicasField:
        """Test InitialReplicasField
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InitialReplicasField`

        # model = InitialReplicasField()
        if include_optional:
            return InitialReplicasField(initial_replicas=0)
        else:
            return InitialReplicasField()

    def testInitialReplicasField(self):
        """Test InitialReplicasField"""
