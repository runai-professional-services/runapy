...
class TestConfigMapUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConfigMapUpdateRequest:
        """Test ConfigMapUpdateRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ConfigMapUpdateRequest`

        # model = ConfigMapUpdateRequest()
        if include_optional:
            return ConfigMapUpdateRequest(meta={"name": "my-asset"})
        else:
            return ConfigMapUpdateRequest(
                meta={"name": "my-asset"},
            )
