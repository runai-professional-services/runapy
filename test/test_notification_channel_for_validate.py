...
class TestNotificationChannelForValidate(unittest.TestCase):
    """NotificationChannelForValidate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationChannelForValidate:
        """Test NotificationChannelForValidate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NotificationChannelForValidate`

        # model = NotificationChannelForValidate()
        if include_optional:
            return NotificationChannelForValidate(
                type="email",
    ...
    def testNotificationChannelForValidate(self):
        """Test NotificationChannelForValidate"""
