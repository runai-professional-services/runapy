...
class TestCommonItemizedFieldsRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommonItemizedFieldsRules:
        """Test CommonItemizedFieldsRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CommonItemizedFieldsRules`

        # model = CommonItemizedFieldsRules()
        if include_optional:
            return CommonItemizedFieldsRules(
