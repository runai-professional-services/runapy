...
class TestDistributedInferenceStartupPolicy(unittest.TestCase):
    """DistributedInferenceStartupPolicy unit test stubs"""
    ...
    def testDistributedInferenceStartupPolicy(self):
        """Test DistributedInferenceStartupPolicy"""
        inst = DistributedInferenceStartupPolicy()
