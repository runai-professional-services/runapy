...
class TestWorkloadTypeUpdateFields(unittest.TestCase):
    """WorkloadTypeUpdateFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadTypeUpdateFields:
        """Test WorkloadTypeUpdateFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadTypeUpdateFields`

        # model = WorkloadTypeUpdateFields()
        if include_optional:
            return WorkloadTypeUpdateFields(
                category_id="",
                priority_id="",
                resource_interfaces=[
                    {
    ...
    def testWorkloadTypeUpdateFields(self):
        """Test WorkloadTypeUpdateFields"""
