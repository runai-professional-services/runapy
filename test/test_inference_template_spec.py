...
class TestInferenceTemplateSpec(unittest.TestCase):
    """InferenceTemplateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferenceTemplateSpec:
        """Test InferenceTemplateSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferenceTemplateSpec`

        # model = InferenceTemplateSpec()
        if include_optional:
            return InferenceTemplateSpec(
    ...
    def testInferenceTemplateSpec(self):
        """Test InferenceTemplateSpec"""
