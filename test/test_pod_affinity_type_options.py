...
class TestPodAffinityTypeOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PodAffinityTypeOptions:
        """Test PodAffinityTypeOptions
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PodAffinityTypeOptions`

        # model = PodAffinityTypeOptions()
        if include_optional:
            return PodAffinityTypeOptions(
                options=[
