...
class TestAssetsUsageRefCompute(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AssetsUsageRefCompute:
        """Test AssetsUsageRefCompute
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AssetsUsageRefCompute`

        # model = AssetsUsageRefCompute()
        if include_optional:
            return AssetsUsageRefCompute(id="0", name="my-asset")
        else:
            return AssetsUsageRefCompute(
                id="0",
                name="my-asset",
            )
