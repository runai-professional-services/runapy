...
class TestDistributedSpecSpec(unittest.TestCase):
    """DistributedSpecSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedSpecSpec:
        """Test DistributedSpecSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedSpecSpec`

        # model = DistributedSpecSpec()
        if include_optional:
            return DistributedSpecSpec(
                annotations=[
    ...
    def testDistributedSpecSpec(self):
        """Test DistributedSpecSpec"""
