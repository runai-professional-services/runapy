...
class TestTrainingPolicyDefaultsV2(unittest.TestCase):
    """TrainingPolicyDefaultsV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrainingPolicyDefaultsV2:
        """Test TrainingPolicyDefaultsV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TrainingPolicyDefaultsV2`

        # model = TrainingPolicyDefaultsV2()
        if include_optional:
            return TrainingPolicyDefaultsV2(
    ...
    def testTrainingPolicyDefaultsV2(self):
        """Test TrainingPolicyDefaultsV2"""
