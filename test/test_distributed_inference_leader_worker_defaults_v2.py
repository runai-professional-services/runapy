...
class TestDistributedInferenceLeaderWorkerDefaultsV2(unittest.TestCase):
    """DistributedInferenceLeaderWorkerDefaultsV2 unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DistributedInferenceLeaderWorkerDefaultsV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceLeaderWorkerDefaultsV2`

        # model = DistributedInferenceLeaderWorkerDefaultsV2()
        if include_optional:
            return DistributedInferenceLeaderWorkerDefaultsV2(
    ...
    def testDistributedInferenceLeaderWorkerDefaultsV2(self):
        """Test DistributedInferenceLeaderWorkerDefaultsV2"""
