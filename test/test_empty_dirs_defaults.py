...
class TestEmptyDirsDefaults(unittest.TestCase):
    """EmptyDirsDefaults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmptyDirsDefaults:
        """Test EmptyDirsDefaults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EmptyDirsDefaults`

        # model = EmptyDirsDefaults()
        if include_optional:
            return EmptyDirsDefaults(
    ...
    def testEmptyDirsDefaults(self):
        """Test EmptyDirsDefaults"""
