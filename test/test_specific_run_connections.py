...
class TestSpecificRunConnections(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SpecificRunConnections:
        """Test SpecificRunConnections
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SpecificRunConnections`

        # model = SpecificRunConnections()
        if include_optional:
            return SpecificRunConnections(
                connections=[
