...
class TestNodepoolMetadata(unittest.TestCase):
    """NodepoolMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodepoolMetadata:
        """Test NodepoolMetadata
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodepoolMetadata`

        # model = NodepoolMetadata()
        if include_optional:
            return NodepoolMetadata(
                id="5",
                name="v100",
