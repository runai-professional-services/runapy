...
class TestInferenceUpdateSpecServingConfiguration(unittest.TestCase):
    """InferenceUpdateSpecServingConfiguration unit test stubs"""
    ...
    def make_instance(
        ...
        """Test InferenceUpdateSpecServingConfiguration
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferenceUpdateSpecServingConfiguration`

        # model = InferenceUpdateSpecServingConfiguration()
        if include_optional:
            return InferenceUpdateSpecServingConfiguration(
    ...
    def testInferenceUpdateSpecServingConfiguration(self):
        """Test InferenceUpdateSpecServingConfiguration"""
