...
class TestSupersetWorkload(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupersetWorkload:
        """Test SupersetWorkload
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupersetWorkload`

        # model = SupersetWorkload()
        if include_optional:
            return SupersetWorkload(
