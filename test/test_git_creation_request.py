...
class TestGitCreationRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GitCreationRequest:
        """Test GitCreationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GitCreationRequest`

        # model = GitCreationRequest()
        if include_optional:
            return GitCreationRequest(
                meta={
                    "name": "my-asset",
                    "scope": "tenant",
