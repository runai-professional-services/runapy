...
class TestNimServiceDefaultsAllOfCompute(unittest.TestCase):
    """NimServiceDefaultsAllOfCompute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceDefaultsAllOfCompute:
        """Test NimServiceDefaultsAllOfCompute
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceDefaultsAllOfCompute`

        # model = NimServiceDefaultsAllOfCompute()
        if include_optional:
            return NimServiceDefaultsAllOfCompute(
                cpu_core_limit=2,
    ...
    def testNimServiceDefaultsAllOfCompute(self):
        """Test NimServiceDefaultsAllOfCompute"""
