...
class TestCleanPodPolicyOptions(unittest.TestCase):
    """CleanPodPolicyOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CleanPodPolicyOptions:
        """Test CleanPodPolicyOptions
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CleanPodPolicyOptions`

        # model = CleanPodPolicyOptions()
        if include_optional:
            return CleanPodPolicyOptions(
                options=[
    ...
    def testCleanPodPolicyOptions(self):
        """Test CleanPodPolicyOptions"""
