...
class TestDistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner(
    unittest.TestCase
):
    """DistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner`

        # model = DistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner()
        if include_optional:
            return DistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner(
    ...
    def testDistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner(self):
        """Test DistributedInferenceServingPortAuthorizationTypeOptionsOptionsInner"""
