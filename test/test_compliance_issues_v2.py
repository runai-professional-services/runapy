...
class TestComplianceIssuesV2(unittest.TestCase):
    """ComplianceIssuesV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceIssuesV2:
        """Test ComplianceIssuesV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ComplianceIssuesV2`

        # model = ComplianceIssuesV2()
        if include_optional:
            return ComplianceIssuesV2(
                compliance_issues=[
    ...
    def testComplianceIssuesV2(self):
        """Test ComplianceIssuesV2"""
