...
class TestServingConfigurationField(unittest.TestCase):
    """ServingConfigurationField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServingConfigurationField:
        """Test ServingConfigurationField
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServingConfigurationField`

        # model = ServingConfigurationField()
        if include_optional:
            return ServingConfigurationField(
    ...
    def testServingConfigurationField(self):
        """Test ServingConfigurationField"""
