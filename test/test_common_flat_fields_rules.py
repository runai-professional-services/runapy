...
class TestCommonFlatFieldsRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommonFlatFieldsRules:
        """Test CommonFlatFieldsRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CommonFlatFieldsRules`

        # model = CommonFlatFieldsRules()
        if include_optional:
            return CommonFlatFieldsRules(
