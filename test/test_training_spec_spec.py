...
class TestTrainingSpecSpec(unittest.TestCase):
    """TrainingSpecSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrainingSpecSpec:
        """Test TrainingSpecSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TrainingSpecSpec`

        # model = TrainingSpecSpec()
        if include_optional:
            return TrainingSpecSpec(
                annotations=[
