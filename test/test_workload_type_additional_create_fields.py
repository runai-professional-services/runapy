...
class TestWorkloadTypeAdditionalCreateFields(unittest.TestCase):
    """WorkloadTypeAdditionalCreateFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadTypeAdditionalCreateFields:
        """Test WorkloadTypeAdditionalCreateFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadTypeAdditionalCreateFields`

        # model = WorkloadTypeAdditionalCreateFields()
        if include_optional:
            return WorkloadTypeAdditionalCreateFields(name="Deployment", group="apps")
        else:
            return WorkloadTypeAdditionalCreateFields()

    def testWorkloadTypeAdditionalCreateFields(self):
        """Test WorkloadTypeAdditionalCreateFields"""
