...
class TestLogoutRedirectUriSetting(unittest.TestCase):
    """LogoutRedirectUriSetting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogoutRedirectUriSetting:
        """Test LogoutRedirectUriSetting
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `LogoutRedirectUriSetting`

        # model = LogoutRedirectUriSetting()
        if include_optional:
            return LogoutRedirectUriSetting(uri="https://example.com/logout")
        else:
            return LogoutRedirectUriSetting()

    def testLogoutRedirectUriSetting(self):
        """Test LogoutRedirectUriSetting"""
