...
class TestWorkspacesApi:
    ...
    def test_create_workspace1(self):
        ...
        Create a workspace [Experimental] Create a new workspace in a specific project in the cluster.
        """
        # Mock response
    ...
    def test_delete_workspace(self):
        ...
        Delete a workspace [Experimental] Delete a workspace using the workspace id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
    ...
    def test_get_workspace(self):
        ...
        Get workspace data [Experimental] Retrieve workspace details using a workload id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
    ...
    def test_resume_workspace(self):
        ...
        Resume a workspace [Experimental] Resume the workspace operation using the workspace id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
    ...
    def test_suspend_workspace(self):
        ...
        Suspend a workspace [Experimental] Suspend a workspace using the workspace id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
