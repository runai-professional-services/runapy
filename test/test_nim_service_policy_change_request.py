...
class TestNimServicePolicyChangeRequest(unittest.TestCase):
    """NimServicePolicyChangeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServicePolicyChangeRequest:
        """Test NimServicePolicyChangeRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServicePolicyChangeRequest`

        # model = NimServicePolicyChangeRequest()
        if include_optional:
            return NimServicePolicyChangeRequest(
    ...
    def testNimServicePolicyChangeRequest(self):
        """Test NimServicePolicyChangeRequest"""
