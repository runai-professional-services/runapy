...
class TestDistributedTemplate(unittest.TestCase):
    """DistributedTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedTemplate:
        """Test DistributedTemplate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedTemplate`

        # model = DistributedTemplate()
        if include_optional:
            return DistributedTemplate(
    ...
    def testDistributedTemplate(self):
        """Test DistributedTemplate"""
