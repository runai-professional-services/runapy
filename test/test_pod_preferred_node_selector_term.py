...
class TestPodPreferredNodeSelectorTerm(unittest.TestCase):
    """PodPreferredNodeSelectorTerm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PodPreferredNodeSelectorTerm:
        """Test PodPreferredNodeSelectorTerm
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PodPreferredNodeSelectorTerm`

        # model = PodPreferredNodeSelectorTerm()
        if include_optional:
            return PodPreferredNodeSelectorTerm(
                weight=1.337,
    ...
    def testPodPreferredNodeSelectorTerm(self):
        """Test PodPreferredNodeSelectorTerm"""
