...
class TestDistributedInferenceLeaderDefaults(unittest.TestCase):
    """DistributedInferenceLeaderDefaults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceLeaderDefaults:
        """Test DistributedInferenceLeaderDefaults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceLeaderDefaults`

        # model = DistributedInferenceLeaderDefaults()
        if include_optional:
            return DistributedInferenceLeaderDefaults(
    ...
    def testDistributedInferenceLeaderDefaults(self):
        """Test DistributedInferenceLeaderDefaults"""
