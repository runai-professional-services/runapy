...
class TestResourcesResetAction(unittest.TestCase):
    """ResourcesResetAction unit test stubs"""
    ...
    def testResourcesResetAction(self):
        """Test ResourcesResetAction"""
        inst = ResourcesResetAction()
