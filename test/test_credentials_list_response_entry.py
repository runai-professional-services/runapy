...
class TestCredentialsListResponseEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CredentialsListResponseEntry:
        """Test CredentialsListResponseEntry
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CredentialsListResponseEntry`

        # model = CredentialsListResponseEntry()
        if include_optional:
            return CredentialsListResponseEntry(
                meta={
                    "name": "my-asset",
                    "scope": "tenant",
