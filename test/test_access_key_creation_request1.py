...
class TestAccessKeyCreationRequest1(unittest.TestCase):
    """AccessKeyCreationRequest1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessKeyCreationRequest1:
        """Test AccessKeyCreationRequest1
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessKeyCreationRequest1`

        # model = AccessKeyCreationRequest1()
        if include_optional:
            return AccessKeyCreationRequest1(name="awat5ikwowtta-3mh2lcafqw3zhes0")
        else:
            return AccessKeyCreationRequest1(
                name="awat5ikwowtta-3mh2lcafqw3zhes0",
            )

    def testAccessKeyCreationRequest1(self):
        """Test AccessKeyCreationRequest1"""
