...
class TestInternalEnrichmentDataFields(unittest.TestCase):
    """InternalEnrichmentDataFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InternalEnrichmentDataFields:
        """Test InternalEnrichmentDataFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InternalEnrichmentDataFields`

        # model = InternalEnrichmentDataFields()
        if include_optional:
            return InternalEnrichmentDataFields(
    ...
    def testInternalEnrichmentDataFields(self):
        """Test InternalEnrichmentDataFields"""
