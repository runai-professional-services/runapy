...
class TestWorkspacePolicyDefaultsV2(unittest.TestCase):
    """WorkspacePolicyDefaultsV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspacePolicyDefaultsV2:
        """Test WorkspacePolicyDefaultsV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspacePolicyDefaultsV2`

        # model = WorkspacePolicyDefaultsV2()
        if include_optional:
            return WorkspacePolicyDefaultsV2(
    ...
    def testWorkspacePolicyDefaultsV2(self):
        """Test WorkspacePolicyDefaultsV2"""
