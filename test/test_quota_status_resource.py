...
class TestQuotaStatusResource(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QuotaStatusResource:
        """Test QuotaStatusResource
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `QuotaStatusResource`

        # model = QuotaStatusResource()
        if include_optional:
            return QuotaStatusResource(gpu=0, cpu=1000, memory=1000)
        else:
            return QuotaStatusResource()
