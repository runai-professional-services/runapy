...
class TestDataUpdatableDepartmentFields(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DataUpdatableDepartmentFields:
        """Test DataUpdatableDepartmentFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DataUpdatableDepartmentFields`

        # model = DataUpdatableDepartmentFields()
        if include_optional:
            return DataUpdatableDepartmentFields(
                description="",
                resources=[
