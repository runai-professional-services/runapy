...
class TestWorkloadCreationMeta(unittest.TestCase):
    """WorkloadCreationMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadCreationMeta:
        """Test WorkloadCreationMeta
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadCreationMeta`

        # model = WorkloadCreationMeta()
        if include_optional:
            return WorkloadCreationMeta(
    ...
    def testWorkloadCreationMeta(self):
        """Test WorkloadCreationMeta"""
