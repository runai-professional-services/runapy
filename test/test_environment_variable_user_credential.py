...
class TestEnvironmentVariableUserCredential(unittest.TestCase):
    """EnvironmentVariableUserCredential unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnvironmentVariableUserCredential:
        """Test EnvironmentVariableUserCredential
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EnvironmentVariableUserCredential`

        # model = EnvironmentVariableUserCredential()
        if include_optional:
            return EnvironmentVariableUserCredential(
                name="my_postgres_user_and_password", key="POSTGRES_PASSWORD"
            )
        else:
            return EnvironmentVariableUserCredential()

    def testEnvironmentVariableUserCredential(self):
        """Test EnvironmentVariableUserCredential"""
