...
class TestResourcesDataOvertimeV1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ResourcesDataOvertimeV1:
        """Test ResourcesDataOvertimeV1
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ResourcesDataOvertimeV1`

        # model = ResourcesDataOvertimeV1()
        if include_optional:
            return ResourcesDataOvertimeV1(
