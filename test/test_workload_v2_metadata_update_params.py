...
class TestWorkloadV2MetadataUpdateParams(unittest.TestCase):
    """WorkloadV2MetadataUpdateParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadV2MetadataUpdateParams:
        """Test WorkloadV2MetadataUpdateParams
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadV2MetadataUpdateParams`

        # model = WorkloadV2MetadataUpdateParams()
        if include_optional:
            return WorkloadV2MetadataUpdateParams(
                priority="jUR,rZ#UM/?R,Fp^l6$ARj", category="jUR,rZ#UM/?R,Fp^l6$ARj"
            )
        else:
            return WorkloadV2MetadataUpdateParams()

    def testWorkloadV2MetadataUpdateParams(self):
        """Test WorkloadV2MetadataUpdateParams"""
