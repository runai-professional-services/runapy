...
class TestTrainingTemplatesListResponse(unittest.TestCase):
    """TrainingTemplatesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrainingTemplatesListResponse:
        """Test TrainingTemplatesListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TrainingTemplatesListResponse`

        # model = TrainingTemplatesListResponse()
        if include_optional:
            return TrainingTemplatesListResponse(
                entries=[null],
    ...
    def testTrainingTemplatesListResponse(self):
        """Test TrainingTemplatesListResponse"""
