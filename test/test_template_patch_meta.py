...
class TestTemplatePatchMeta(unittest.TestCase):
    """TemplatePatchMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplatePatchMeta:
        """Test TemplatePatchMeta
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TemplatePatchMeta`

        # model = TemplatePatchMeta()
        if include_optional:
            return TemplatePatchMeta(
    ...
    def testTemplatePatchMeta(self):
        """Test TemplatePatchMeta"""
