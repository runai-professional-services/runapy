...
class TestInferenceFlatFields(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InferenceFlatFields:
        """Test InferenceFlatFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferenceFlatFields`

        # model = InferenceFlatFields()
        if include_optional:
            return InferenceFlatFields(
                command="python",
                args="-x my-script.py",
                image="python:3.8",
