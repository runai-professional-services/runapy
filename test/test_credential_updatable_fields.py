...
class TestCredentialUpdatableFields(unittest.TestCase):
    """CredentialUpdatableFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CredentialUpdatableFields:
        """Test CredentialUpdatableFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CredentialUpdatableFields`

        # model = CredentialUpdatableFields()
        if include_optional:
            return CredentialUpdatableFields(description="description of my asset.")
        else:
            return CredentialUpdatableFields()

    def testCredentialUpdatableFields(self):
        """Test CredentialUpdatableFields"""
