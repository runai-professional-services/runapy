...
class TestUsersApi:
    ...
    def test_get_roles(self):
        ...
        Get all possible permissions. Get the complete set of permissions that a tenant can grant to users and applications. Deprecated endpoint. please reffer to Roles &amp; Access rules API.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
