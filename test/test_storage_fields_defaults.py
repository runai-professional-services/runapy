...
class TestStorageFieldsDefaults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StorageFieldsDefaults:
        """Test StorageFieldsDefaults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StorageFieldsDefaults`

        # model = StorageFieldsDefaults()
        if include_optional:
            return StorageFieldsDefaults(
