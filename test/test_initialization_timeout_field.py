...
class TestInitializationTimeoutField(unittest.TestCase):
    """InitializationTimeoutField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitializationTimeoutField:
        """Test InitializationTimeoutField
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InitializationTimeoutField`

        # model = InitializationTimeoutField()
        if include_optional:
            return InitializationTimeoutField(initialization_timeout_seconds=1)
        else:
            return InitializationTimeoutField()

    def testInitializationTimeoutField(self):
        """Test InitializationTimeoutField"""
