...
class TestNIMServiceMetadataCreateParams(unittest.TestCase):
    """NIMServiceMetadataCreateParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NIMServiceMetadataCreateParams:
        """Test NIMServiceMetadataCreateParams
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NIMServiceMetadataCreateParams`

        # model = NIMServiceMetadataCreateParams()
        if include_optional:
            return NIMServiceMetadataCreateParams(
                name="my-workload-name", use_given_name_as_prefix=True, project_id="1"
            )
        else:
            return NIMServiceMetadataCreateParams(
    ...
    def testNIMServiceMetadataCreateParams(self):
        """Test NIMServiceMetadataCreateParams"""
