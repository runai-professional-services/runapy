...
class TestInferencePolicyDefaultsV2AllOfSecurity(unittest.TestCase):
    """InferencePolicyDefaultsV2AllOfSecurity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferencePolicyDefaultsV2AllOfSecurity:
        """Test InferencePolicyDefaultsV2AllOfSecurity
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferencePolicyDefaultsV2AllOfSecurity`

        # model = InferencePolicyDefaultsV2AllOfSecurity()
        if include_optional:
            return InferencePolicyDefaultsV2AllOfSecurity(
    ...
    def testInferencePolicyDefaultsV2AllOfSecurity(self):
        """Test InferencePolicyDefaultsV2AllOfSecurity"""
