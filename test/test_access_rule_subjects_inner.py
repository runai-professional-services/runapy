...
class TestAccessRuleSubjectsInner(unittest.TestCase):
    """AccessRuleSubjectsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessRuleSubjectsInner:
        """Test AccessRuleSubjectsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessRuleSubjectsInner`

        # model = AccessRuleSubjectsInner()
        if include_optional:
            return AccessRuleSubjectsInner(
                subject_id="user@run.ai", subject_type="user"
            )
        else:
            return AccessRuleSubjectsInner(
    ...
    def testAccessRuleSubjectsInner(self):
        """Test AccessRuleSubjectsInner"""
