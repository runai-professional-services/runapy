...
class TestSupersetRulesAllOfSecurity(unittest.TestCase):
    """SupersetRulesAllOfSecurity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupersetRulesAllOfSecurity:
        """Test SupersetRulesAllOfSecurity
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupersetRulesAllOfSecurity`

        # model = SupersetRulesAllOfSecurity()
        if include_optional:
            return SupersetRulesAllOfSecurity(
    ...
    def testSupersetRulesAllOfSecurity(self):
        """Test SupersetRulesAllOfSecurity"""
