...
class TestNimServicePolicyDefaultsAndRules(unittest.TestCase):
    """NimServicePolicyDefaultsAndRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServicePolicyDefaultsAndRules:
        """Test NimServicePolicyDefaultsAndRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServicePolicyDefaultsAndRules`

        # model = NimServicePolicyDefaultsAndRules()
        if include_optional:
            return NimServicePolicyDefaultsAndRules(
                defaults=None,
                rules=None,
    ...
    def testNimServicePolicyDefaultsAndRules(self):
        """Test NimServicePolicyDefaultsAndRules"""
