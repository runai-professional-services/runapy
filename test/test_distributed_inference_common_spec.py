...
class TestDistributedInferenceCommonSpec(unittest.TestCase):
    """DistributedInferenceCommonSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceCommonSpec:
        """Test DistributedInferenceCommonSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceCommonSpec`
    ...
    def testDistributedInferenceCommonSpec(self):
        """Test DistributedInferenceCommonSpec"""
