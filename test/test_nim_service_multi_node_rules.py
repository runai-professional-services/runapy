...
class TestNimServiceMultiNodeRules(unittest.TestCase):
    """NimServiceMultiNodeRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceMultiNodeRules:
        """Test NimServiceMultiNodeRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceMultiNodeRules`

        # model = NimServiceMultiNodeRules()
        if include_optional:
            return NimServiceMultiNodeRules(
    ...
    def testNimServiceMultiNodeRules(self):
        """Test NimServiceMultiNodeRules"""
