...
class TestNimServiceDefaults(unittest.TestCase):
    """NimServiceDefaults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceDefaults:
        """Test NimServiceDefaults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceDefaults`

        # model = NimServiceDefaults()
        if include_optional:
            return NimServiceDefaults(
    ...
    def testNimServiceDefaults(self):
        """Test NimServiceDefaults"""
