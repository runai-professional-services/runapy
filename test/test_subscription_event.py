...
class TestSubscriptionEvent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SubscriptionEvent:
        """Test SubscriptionEvent
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SubscriptionEvent`

        # model = SubscriptionEvent()
        if include_optional:
            return SubscriptionEvent(category="", types=[""])
        else:
