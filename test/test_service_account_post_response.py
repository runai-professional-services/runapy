...
class TestServiceAccountPostResponse(unittest.TestCase):
    """ServiceAccountPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceAccountPostResponse:
        """Test ServiceAccountPostResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceAccountPostResponse`

        # model = ServiceAccountPostResponse()
        if include_optional:
            return ServiceAccountPostResponse(
                id="", name="", client_secret="", client_id=""
            )
        else:
            return ServiceAccountPostResponse(
                id="",
    ...
    def testServiceAccountPostResponse(self):
        """Test ServiceAccountPostResponse"""
