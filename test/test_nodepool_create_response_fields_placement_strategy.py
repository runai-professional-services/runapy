...
class TestNodepoolCreateResponseFieldsPlacementStrategy(unittest.TestCase):
    """NodepoolCreateResponseFieldsPlacementStrategy unit test stubs"""
    ...
    def make_instance(
        ...
        """Test NodepoolCreateResponseFieldsPlacementStrategy
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodepoolCreateResponseFieldsPlacementStrategy`

        # model = NodepoolCreateResponseFieldsPlacementStrategy()
        if include_optional:
            return NodepoolCreateResponseFieldsPlacementStrategy(
                cpu="spread", gpu="spread"
            )
        else:
            return NodepoolCreateResponseFieldsPlacementStrategy()

    def testNodepoolCreateResponseFieldsPlacementStrategy(self):
        """Test NodepoolCreateResponseFieldsPlacementStrategy"""
