...
class TestDistributedInferencePolicyChangeRequestV2(unittest.TestCase):
    """DistributedInferencePolicyChangeRequestV2 unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DistributedInferencePolicyChangeRequestV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferencePolicyChangeRequestV2`

        # model = DistributedInferencePolicyChangeRequestV2()
        if include_optional:
            return DistributedInferencePolicyChangeRequestV2(
    ...
    def testDistributedInferencePolicyChangeRequestV2(self):
        """Test DistributedInferencePolicyChangeRequestV2"""
