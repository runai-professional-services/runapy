...
class TestTemplateComplianceInfo(unittest.TestCase):
    """TemplateComplianceInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateComplianceInfo:
        """Test TemplateComplianceInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TemplateComplianceInfo`

        # model = TemplateComplianceInfo()
        if include_optional:
            return TemplateComplianceInfo(
                compliance_issues=[
    ...
    def testTemplateComplianceInfo(self):
        """Test TemplateComplianceInfo"""
