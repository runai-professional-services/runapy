...
class TestDistributedInferenceTemplatesListResponseItem(unittest.TestCase):
    """DistributedInferenceTemplatesListResponseItem unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DistributedInferenceTemplatesListResponseItem
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceTemplatesListResponseItem`

        # model = DistributedInferenceTemplatesListResponseItem()
        if include_optional:
            return DistributedInferenceTemplatesListResponseItem(
    ...
    def testDistributedInferenceTemplatesListResponseItem(self):
        """Test DistributedInferenceTemplatesListResponseItem"""
