...
class TestNimServiceRulesAllOfSecurity(unittest.TestCase):
    """NimServiceRulesAllOfSecurity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceRulesAllOfSecurity:
        """Test NimServiceRulesAllOfSecurity
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceRulesAllOfSecurity`

        # model = NimServiceRulesAllOfSecurity()
        if include_optional:
            return NimServiceRulesAllOfSecurity(
    ...
    def testNimServiceRulesAllOfSecurity(self):
        """Test NimServiceRulesAllOfSecurity"""
