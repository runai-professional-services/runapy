...
class TestTemplateUpdateMeta(unittest.TestCase):
    """TemplateUpdateMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateUpdateMeta:
        """Test TemplateUpdateMeta
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TemplateUpdateMeta`

        # model = TemplateUpdateMeta()
        if include_optional:
            return TemplateUpdateMeta(
    ...
    def testTemplateUpdateMeta(self):
        """Test TemplateUpdateMeta"""
