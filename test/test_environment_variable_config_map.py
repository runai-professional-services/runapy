...
class TestEnvironmentVariableConfigMap(unittest.TestCase):
    """EnvironmentVariableConfigMap unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnvironmentVariableConfigMap:
        """Test EnvironmentVariableConfigMap
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EnvironmentVariableConfigMap`

        # model = EnvironmentVariableConfigMap()
        if include_optional:
            return EnvironmentVariableConfigMap(
                name="my-config-map", key="MY_POSTGRES_SCHEMA"
            )
        else:
            return EnvironmentVariableConfigMap()

    def testEnvironmentVariableConfigMap(self):
        """Test EnvironmentVariableConfigMap"""
