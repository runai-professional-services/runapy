...
class TestDistributedInferenceLeaderWorkerSpec1(unittest.TestCase):
    """DistributedInferenceLeaderWorkerSpec1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceLeaderWorkerSpec1:
        """Test DistributedInferenceLeaderWorkerSpec1
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceLeaderWorkerSpec1`

        # model = DistributedInferenceLeaderWorkerSpec1()
        if include_optional:
            return DistributedInferenceLeaderWorkerSpec1(
                annotations=[
    ...
    def testDistributedInferenceLeaderWorkerSpec1(self):
        """Test DistributedInferenceLeaderWorkerSpec1"""
