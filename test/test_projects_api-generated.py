...
class TestProjectsApi:
    ...
    def test_create_project_0(self):
        ...
        Create a new project. Creates a new project in a specific cluster.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
    ...
    def test_delete_project_0(self):
        ...
        Delete a project. Deletes a project from a specific cluster.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
    ...
    def test_get_project(self):
        ...
        # Verify response
        assert isinstance(response, GetProjects200ResponseProjectsInner)
    ...
    def test_get_project_0(self):
        ...
        List details of a specific project. Retrieves the details of a specific project from a specific cluster. \\n Use for project analysis. \\n **Requires &#x60;view&#x60; permissions to the queried project.**
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
    ...
    def test_get_projects_0(self):
        ...
        List all projects and their details. Retrieves a list of all projects and details from a specific cluster. \\n Use in reporting and analysis tools.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
    ...
    def test_update_project_0(self):
        ...
        Update a project. Updates a project&#39;s details in a specific cluster. \\n For example, node pool resources, and others.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
