...
class TestCommonFlatFields(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommonFlatFields:
        """Test CommonFlatFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CommonFlatFields`

        # model = CommonFlatFields()
        if include_optional:
            return CommonFlatFields(
                command="python",
                args="-x my-script.py",
                image="python:3.8",
