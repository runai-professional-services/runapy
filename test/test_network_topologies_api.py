...
class TestNetworkTopologiesApi(unittest.TestCase):
    """NetworkTopologiesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = NetworkTopologiesApi()

    def tearDown(self) -> None:
        pass

    def test_create_network_topology(self) -> None:
    ...
    def test_delete_network_topology(self) -> None:
    ...
    def test_get_network_topologies(self) -> None:
    ...
    def test_get_network_topologies_count(self) -> None:
    ...
    def test_get_network_topology_by_id(self) -> None:
