...
class TestAccessRulesBatchCreateFieldsPayload(unittest.TestCase):
    """AccessRulesBatchCreateFieldsPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessRulesBatchCreateFieldsPayload:
        """Test AccessRulesBatchCreateFieldsPayload
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessRulesBatchCreateFieldsPayload`

        # model = AccessRulesBatchCreateFieldsPayload()
        if include_optional:
            return AccessRulesBatchCreateFieldsPayload(
                role_id=53142648,
    ...
    def testAccessRulesBatchCreateFieldsPayload(self):
        """Test AccessRulesBatchCreateFieldsPayload"""
