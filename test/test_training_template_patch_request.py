...
class TestTrainingTemplatePatchRequest(unittest.TestCase):
    """TrainingTemplatePatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrainingTemplatePatchRequest:
        """Test TrainingTemplatePatchRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TrainingTemplatePatchRequest`

        # model = TrainingTemplatePatchRequest()
        if include_optional:
            return TrainingTemplatePatchRequest(
    ...
    def testTrainingTemplatePatchRequest(self):
        """Test TrainingTemplatePatchRequest"""
