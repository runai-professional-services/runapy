...
class TestServingPortExposedProtocolOptionsOptionsInner(unittest.TestCase):
    """ServingPortExposedProtocolOptionsOptionsInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test ServingPortExposedProtocolOptionsOptionsInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServingPortExposedProtocolOptionsOptionsInner`

        # model = ServingPortExposedProtocolOptionsOptionsInner()
        if include_optional:
            return ServingPortExposedProtocolOptionsOptionsInner(
    ...
    def testServingPortExposedProtocolOptionsOptionsInner(self):
        """Test ServingPortExposedProtocolOptionsOptionsInner"""
