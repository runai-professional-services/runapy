...
class TestPodNodeAffinity(unittest.TestCase):
    """PodNodeAffinity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PodNodeAffinity:
        """Test PodNodeAffinity
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PodNodeAffinity`

        # model = PodNodeAffinity()
        if include_optional:
            return PodNodeAffinity(
