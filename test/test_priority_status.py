...
class TestPriorityStatus(unittest.TestCase):
    """PriorityStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriorityStatus:
        """Test PriorityStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PriorityStatus`

        # model = PriorityStatus()
        if include_optional:
            return PriorityStatus(
                cluster_id="d73a738f-fab3-430a-8fa3-5241493d7128", phase="Ready"
            )
        else:
            return PriorityStatus()

    def testPriorityStatus(self):
        """Test PriorityStatus"""
