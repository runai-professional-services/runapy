...
class TestHistogramValue(unittest.TestCase):
    """HistogramValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistogramValue:
        """Test HistogramValue
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HistogramValue`

        # model = HistogramValue()
        if include_optional:
