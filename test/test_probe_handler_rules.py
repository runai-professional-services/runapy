...
class TestProbeHandlerRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProbeHandlerRules:
        """Test ProbeHandlerRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProbeHandlerRules`

        # model = ProbeHandlerRules()
        if include_optional:
            return ProbeHandlerRules(
