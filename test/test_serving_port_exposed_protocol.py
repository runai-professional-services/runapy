...
class TestServingPortExposedProtocol(unittest.TestCase):
    """ServingPortExposedProtocol unit test stubs"""
    ...
    def testServingPortExposedProtocol(self):
        """Test ServingPortExposedProtocol"""
        inst = ServingPortExposedProtocol()
