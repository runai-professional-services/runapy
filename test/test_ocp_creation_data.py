...
class TestOcpCreationData(unittest.TestCase):
    """OcpCreationData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OcpCreationData:
        """Test OcpCreationData
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `OcpCreationData`

        # model = OcpCreationData()
        if include_optional:
            return OcpCreationData(
                client_id="0",
