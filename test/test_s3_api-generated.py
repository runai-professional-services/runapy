...
class TestS3Api:
    ...
    def setup(self):
        ...
        self.api = S3Api(self.api_client)
    ...
    def test_create_s3_asset(self):
        ...
        Create an S3 asset. Use to create an S3 compatible datasource asset.
        """
        # Mock response
        ...
        # Test parameters
        s3_creation_request = runai.S3CreationRequest()  # S3CreationRequest |

        # Make request
        response = self.api.create_s3_asset()
        ...
        assert "/api/v1/asset/datasource/s3" in kwargs["url"]
    ...
    def test_create_s3_asset_error(self):
        """Test error handling for create_s3_asset"""
        # Mock error response
        mock_response = mock.Mock()
        ...
        with pytest.raises(ApiException) as exc_info:
            self.api.create_s3_asset()
        assert exc_info.value.status == 400

    def test_delete_s3_asset_by_id(self):
        """Test case for delete_s3_asset_by_id

        Delete an S3 asset. Use to delete an S3 compatible datasource asset by id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Make request
        response = self.api.delete_s3_asset_by_id(
            asset_id=asset_id,
        )
        ...
        assert "/api/v1/asset/datasource/s3/{AssetId}" in kwargs["url"]

        # Verify response
        assert isinstance(response, HttpResponse)

    def test_delete_s3_asset_by_id_error(self):
        """Test error handling for delete_s3_asset_by_id"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
        ...
        # Verify error handling
        with pytest.raises(ApiException) as exc_info:
            self.api.delete_s3_asset_by_id(
                asset_id=asset_id,
            )
        assert exc_info.value.status == 400
    ...
    def test_get_s3_asset_by_id(self):
        ...
        Get an S3 asset. Retrieve the details of S3 compatible datasource asset by id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Make request
        response = self.api.get_s3_asset_by_id(
            asset_id=asset_id,
        )
    ...
    def test_get_s3_asset_by_id_error(self):
        """Test error handling for get_s3_asset_by_id"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
    ...
    def test_list_s3_assets(self):
        ...
        List S3 assets. Retrieve a list of S3 compatible datasource assets.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Make request
        response = self.api.list_s3_assets()
    ...
    def test_list_s3_assets_error(self):
        """Test error handling for list_s3_assets"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
        ...
        # Verify error handling
        with pytest.raises(ApiException) as exc_info:
            self.api.list_s3_assets()
        assert exc_info.value.status == 400

    def test_update_s3_asset_by_id(self):
        """Test case for update_s3_asset_by_id

        Update an S3 asset. Use to update the details of an S3 compatible datasource asset by id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Test parameters
        asset_id = "asset_id_example"  # str | Unique identifier of the asset.
        s3_update_request = runai.S3UpdateRequest()  # S3UpdateRequest |

        # Make request
        response = self.api.update_s3_asset_by_id(
            asset_id=asset_id,
        )
    ...
    def test_update_s3_asset_by_id_error(self):
        """Test error handling for update_s3_asset_by_id"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
        ...
        # Verify error handling
        with pytest.raises(ApiException) as exc_info:
            self.api.update_s3_asset_by_id(
                asset_id=asset_id,
            )
        assert exc_info.value.status == 400
