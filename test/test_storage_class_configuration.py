...
class TestStorageClassConfiguration(unittest.TestCase):
    """StorageClassConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageClassConfiguration:
        """Test StorageClassConfiguration
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StorageClassConfiguration`

        # model = StorageClassConfiguration()
        if include_optional:
    ...
    def testStorageClassConfiguration(self):
        """Test StorageClassConfiguration"""
