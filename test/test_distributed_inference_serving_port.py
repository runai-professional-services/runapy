...
class TestDistributedInferenceServingPort(unittest.TestCase):
    """DistributedInferenceServingPort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceServingPort:
        """Test DistributedInferenceServingPort
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceServingPort`

        # model = DistributedInferenceServingPort()
        if include_optional:
            return DistributedInferenceServingPort(
                port=8080,
                protocol="http",
    ...
    def testDistributedInferenceServingPort(self):
        """Test DistributedInferenceServingPort"""
