...
class TestDistributedInferenceStartupPolicyField(unittest.TestCase):
    """DistributedInferenceStartupPolicyField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceStartupPolicyField:
        """Test DistributedInferenceStartupPolicyField
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceStartupPolicyField`

        # model = DistributedInferenceStartupPolicyField()
        if include_optional:
            return DistributedInferenceStartupPolicyField(
                startup_policy="LeaderCreated"
            )
        else:
            return DistributedInferenceStartupPolicyField()

    def testDistributedInferenceStartupPolicyField(self):
        """Test DistributedInferenceStartupPolicyField"""
