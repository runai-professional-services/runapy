...
class TestNimServiceServingPort(unittest.TestCase):
    """NimServiceServingPort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceServingPort:
        """Test NimServiceServingPort
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceServingPort`

        # model = NimServiceServingPort()
        if include_optional:
            return NimServiceServingPort(
    ...
    def testNimServiceServingPort(self):
        """Test NimServiceServingPort"""
