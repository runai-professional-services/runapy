...
class TestPvcSupportedAccessModes(unittest.TestCase):
    """PvcSupportedAccessModes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PvcSupportedAccessModes:
        """Test PvcSupportedAccessModes
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PvcSupportedAccessModes`

        # model = PvcSupportedAccessModes()
        if include_optional:
            return PvcSupportedAccessModes(
                read_write_once=True, read_only_many=True, read_write_many=True
            )
        else:
            return PvcSupportedAccessModes()

    def testPvcSupportedAccessModes(self):
        """Test PvcSupportedAccessModes"""
