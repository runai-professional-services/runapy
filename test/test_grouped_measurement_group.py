...
class TestGroupedMeasurementGroup(unittest.TestCase):
    """GroupedMeasurementGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupedMeasurementGroup:
        """Test GroupedMeasurementGroup
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GroupedMeasurementGroup`

        # model = GroupedMeasurementGroup()
        if include_optional:
            return GroupedMeasurementGroup(key="Nodepool", value="gpu-pool-1")
        else:
            return GroupedMeasurementGroup(
                key="Nodepool",
                value="gpu-pool-1",
            )

    def testGroupedMeasurementGroup(self):
        """Test GroupedMeasurementGroup"""
