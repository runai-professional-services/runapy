...
class TestSecretFieldsNonUpdatable(unittest.TestCase):
    """SecretFieldsNonUpdatable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecretFieldsNonUpdatable:
        """Test SecretFieldsNonUpdatable
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SecretFieldsNonUpdatable`

        # model = SecretFieldsNonUpdatable()
        if include_optional:
            return SecretFieldsNonUpdatable(secret="0")
        else:
            return SecretFieldsNonUpdatable()

    def testSecretFieldsNonUpdatable(self):
        """Test SecretFieldsNonUpdatable"""
