...
class TestNimServiceRulesAllOfCompute(unittest.TestCase):
    """NimServiceRulesAllOfCompute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceRulesAllOfCompute:
        """Test NimServiceRulesAllOfCompute
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceRulesAllOfCompute`

        # model = NimServiceRulesAllOfCompute()
        if include_optional:
            return NimServiceRulesAllOfCompute(
    ...
    def testNimServiceRulesAllOfCompute(self):
        """Test NimServiceRulesAllOfCompute"""
