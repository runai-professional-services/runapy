...
class TestServiceAccountCreationRequest(unittest.TestCase):
    """ServiceAccountCreationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceAccountCreationRequest:
        """Test ServiceAccountCreationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceAccountCreationRequest`

        # model = ServiceAccountCreationRequest()
        if include_optional:
            return ServiceAccountCreationRequest(name="awat5ikwowtta-3mh2lcafqw3zhes0")
        else:
            return ServiceAccountCreationRequest(
                name="awat5ikwowtta-3mh2lcafqw3zhes0",
            )

    def testServiceAccountCreationRequest(self):
        """Test ServiceAccountCreationRequest"""
