...
class TestTemplateCreationMeta(unittest.TestCase):
    """TemplateCreationMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateCreationMeta:
        """Test TemplateCreationMeta
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TemplateCreationMeta`

        # model = TemplateCreationMeta()
        if include_optional:
            return TemplateCreationMeta(
    ...
    def testTemplateCreationMeta(self):
        """Test TemplateCreationMeta"""
