...
class TestGPUResourceOptimization(unittest.TestCase):
    """GPUResourceOptimization unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GPUResourceOptimization:
        """Test GPUResourceOptimization
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GPUResourceOptimization`

        # model = GPUResourceOptimization()
        if include_optional:
            return GPUResourceOptimization(
                swap_enabled=True,
    ...
    def testGPUResourceOptimization(self):
        """Test GPUResourceOptimization"""
