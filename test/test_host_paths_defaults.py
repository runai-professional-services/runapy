...
class TestHostPathsDefaults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HostPathsDefaults:
        """Test HostPathsDefaults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HostPathsDefaults`

        # model = HostPathsDefaults()
        if include_optional:
            return HostPathsDefaults(
