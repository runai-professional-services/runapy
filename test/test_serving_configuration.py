...
class TestServingConfiguration(unittest.TestCase):
    """ServingConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServingConfiguration:
        """Test ServingConfiguration
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServingConfiguration`

        # model = ServingConfiguration()
        if include_optional:
            return ServingConfiguration(
                initialization_timeout_seconds=1, request_timeout_seconds=1
            )
        else:
            return ServingConfiguration()

    def testServingConfiguration(self):
        """Test ServingConfiguration"""
