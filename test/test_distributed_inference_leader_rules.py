...
class TestDistributedInferenceLeaderRules(unittest.TestCase):
    """DistributedInferenceLeaderRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceLeaderRules:
        """Test DistributedInferenceLeaderRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceLeaderRules`

        # model = DistributedInferenceLeaderRules()
        if include_optional:
            return DistributedInferenceLeaderRules(
    ...
    def testDistributedInferenceLeaderRules(self):
        """Test DistributedInferenceLeaderRules"""
