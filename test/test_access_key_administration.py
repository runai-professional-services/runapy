...
class TestAccessKeyAdministration(unittest.TestCase):
    """AccessKeyAdministration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessKeyAdministration:
        """Test AccessKeyAdministration
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessKeyAdministration`

        # model = AccessKeyAdministration()
        if include_optional:
            return AccessKeyAdministration(
                name="",
                id="",
                client_id="",
                created_by="",
    ...
    def testAccessKeyAdministration(self):
        """Test AccessKeyAdministration"""
