...
class TestWorkloadTemplateUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WorkloadTemplateUpdateRequest:
        """Test WorkloadTemplateUpdateRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadTemplateUpdateRequest`

        # model = WorkloadTemplateUpdateRequest()
        if include_optional:
            return WorkloadTemplateUpdateRequest(
                meta={"name": "my-asset"},
