...
class TestSecret5(unittest.TestCase):
    """Secret5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Secret5:
        """Test Secret5
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Secret5`

        # model = Secret5()
        if include_optional:
            return Secret5(mount_path="0", default_mode="0644", secret="0")
        else:
            return Secret5()
