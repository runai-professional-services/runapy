...
class TestHistoryRecordMeta(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HistoryRecordMeta:
        """Test HistoryRecordMeta
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HistoryRecordMeta`

        # model = HistoryRecordMeta()
        if include_optional:
            return HistoryRecordMeta(
                creation_timestamp="2022-01-01T03:49:52.531Z", type="Event"
            )
        else:
            return HistoryRecordMeta(
