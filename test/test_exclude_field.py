...
class TestExcludeField(unittest.TestCase):
    """ExcludeField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExcludeField:
        """Test ExcludeField
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExcludeField`

        # model = ExcludeField()
        if include_optional:
            return ExcludeField(exclude=False)
        else:
            return ExcludeField()

    def testExcludeField(self):
        """Test ExcludeField"""
