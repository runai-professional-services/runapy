...
class TestNimServicePolicyOverwriteRequest(unittest.TestCase):
    """NimServicePolicyOverwriteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServicePolicyOverwriteRequest:
        """Test NimServicePolicyOverwriteRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServicePolicyOverwriteRequest`

        # model = NimServicePolicyOverwriteRequest()
        if include_optional:
            return NimServicePolicyOverwriteRequest(
    ...
    def testNimServicePolicyOverwriteRequest(self):
        """Test NimServicePolicyOverwriteRequest"""
