...
class TestDistributedInferenceServingPortRules2(unittest.TestCase):
    """DistributedInferenceServingPortRules2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceServingPortRules2:
        """Test DistributedInferenceServingPortRules2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceServingPortRules2`

        # model = DistributedInferenceServingPortRules2()
        if include_optional:
            return DistributedInferenceServingPortRules2(
    ...
    def testDistributedInferenceServingPortRules2(self):
        """Test DistributedInferenceServingPortRules2"""
