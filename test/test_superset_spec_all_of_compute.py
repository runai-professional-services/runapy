...
class TestSupersetSpecAllOfCompute(unittest.TestCase):
    """SupersetSpecAllOfCompute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupersetSpecAllOfCompute:
        """Test SupersetSpecAllOfCompute
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupersetSpecAllOfCompute`

        # model = SupersetSpecAllOfCompute()
        if include_optional:
    ...
    def testSupersetSpecAllOfCompute(self):
        """Test SupersetSpecAllOfCompute"""
