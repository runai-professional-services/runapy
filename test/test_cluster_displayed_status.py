...
class TestClusterDisplayedStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClusterDisplayedStatus:
        """Test ClusterDisplayedStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterDisplayedStatus`

        # model = ClusterDisplayedStatus()
        if include_optional:
            return ClusterDisplayedStatus(
                conditions = [
