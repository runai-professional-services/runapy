...
class TestNimServicePolicy(unittest.TestCase):
    """NimServicePolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServicePolicy:
        """Test NimServicePolicy
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServicePolicy`

        # model = NimServicePolicy()
        if include_optional:
            return NimServicePolicy(
                meta=None,
