...
class TestServingPortServiceTypeRules(unittest.TestCase):
    """ServingPortServiceTypeRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServingPortServiceTypeRules:
        """Test ServingPortServiceTypeRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServingPortServiceTypeRules`

        # model = ServingPortServiceTypeRules()
        if include_optional:
            return ServingPortServiceTypeRules(
    ...
    def testServingPortServiceTypeRules(self):
        """Test ServingPortServiceTypeRules"""
