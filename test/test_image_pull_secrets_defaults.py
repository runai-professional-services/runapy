...
class TestImagePullSecretsDefaults(unittest.TestCase):
    """ImagePullSecretsDefaults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImagePullSecretsDefaults:
        """Test ImagePullSecretsDefaults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ImagePullSecretsDefaults`

        # model = ImagePullSecretsDefaults()
        if include_optional:
            return ImagePullSecretsDefaults(
                instances=[
    ...
    def testImagePullSecretsDefaults(self):
        """Test ImagePullSecretsDefaults"""
