...
class TestNFSApi:
    ...
    def setup(self):
        ...
        self.api = NFSApi(self.api_client)
    ...
    def test_create_nfs_asset(self):
        ...
        Create an NFS asset. Use to create an NFS datasource asset.
        """
        # Mock response
        ...
        # Test parameters
        nfs_creation_request = runai.NFSCreationRequest()  # NFSCreationRequest |

        # Make request
        response = self.api.create_nfs_asset()
        ...
        assert "/api/v1/asset/datasource/nfs" in kwargs["url"]

        # Verify body
        assert kwargs["body"] is not None

        # Verify response
        assert isinstance(response, S3Asset)

    def test_create_nfs_asset_error(self):
        """Test error handling for create_nfs_asset"""
        # Mock error response
        mock_response = mock.Mock()
        ...
        with pytest.raises(ApiException) as exc_info:
            self.api.create_nfs_asset()
        assert exc_info.value.status == 400

    def test_delete_nfs_asset_by_id(self):
        """Test case for delete_nfs_asset_by_id

        Delete an NFS asset. Use to delete an NFS datasource asset by id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Make request
        response = self.api.delete_nfs_asset_by_id(
            asset_id=asset_id,
        )
        ...
        assert "/api/v1/asset/datasource/nfs/{AssetId}" in kwargs["url"]

        # Verify response
        assert isinstance(response, HttpResponse)

    def test_delete_nfs_asset_by_id_error(self):
        """Test error handling for delete_nfs_asset_by_id"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
        ...
        # Verify error handling
        with pytest.raises(ApiException) as exc_info:
            self.api.delete_nfs_asset_by_id(
                asset_id=asset_id,
            )
        assert exc_info.value.status == 400
    ...
    def test_get_nfs_asset_by_id(self):
        ...
        Get an NFS asset. Use to retrieve the details of NFS datasource asset by id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Make request
        response = self.api.get_nfs_asset_by_id(
            asset_id=asset_id,
        )
        ...
        # Verify response
        assert isinstance(response, NFSAsset)

    def test_get_nfs_asset_by_id_error(self):
        """Test error handling for get_nfs_asset_by_id"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
    ...
    def test_list_nfs_assets(self):
        ...
        List NFS assets. Retrieve a list of NFS datasource assets.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Make request
        response = self.api.list_nfs_assets()
        ...
        # Verify response
        assert isinstance(response, NFSListResponse)

    def test_list_nfs_assets_error(self):
        """Test error handling for list_nfs_assets"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
        ...
        # Verify error handling
        with pytest.raises(ApiException) as exc_info:
            self.api.list_nfs_assets()
        assert exc_info.value.status == 400

    def test_update_nfs_asset_by_id(self):
        """Test case for update_nfs_asset_by_id

        Update an NFS asset. Use to update the details of NFS datasource asset by id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Test parameters
        asset_id = "asset_id_example"  # str | Unique identifier of the asset.
        nfs_update_request = runai.NFSUpdateRequest()  # NFSUpdateRequest |

        # Make request
        response = self.api.update_nfs_asset_by_id(
            asset_id=asset_id,
        )
    ...
    def test_update_nfs_asset_by_id_error(self):
        """Test error handling for update_nfs_asset_by_id"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
        ...
        # Verify error handling
        with pytest.raises(ApiException) as exc_info:
            self.api.update_nfs_asset_by_id(
                asset_id=asset_id,
            )
        assert exc_info.value.status == 400
