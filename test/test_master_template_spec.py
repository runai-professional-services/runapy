...
class TestMasterTemplateSpec(unittest.TestCase):
    """MasterTemplateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MasterTemplateSpec:
        """Test MasterTemplateSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MasterTemplateSpec`

        # model = MasterTemplateSpec()
        if include_optional:
            return MasterTemplateSpec(
                annotations=[
    ...
    def testMasterTemplateSpec(self):
        """Test MasterTemplateSpec"""
