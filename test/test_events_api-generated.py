...
class TestEventsApi:
    ...
    def test_get_workload_events(self):
        ...
        Get the workload events. Retrieve all the workload events by workload id.
        """
        # Mock response
    ...
    def test_get_workload_history(self):
        ...
        Get the workload history. Retrieve the details workload history including events by workload id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
