...
class TestStorageClassConfigurationPatchRequest(unittest.TestCase):
    """StorageClassConfigurationPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageClassConfigurationPatchRequest:
        """Test StorageClassConfigurationPatchRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StorageClassConfigurationPatchRequest`

        # model = StorageClassConfigurationPatchRequest()
        if include_optional:
            return StorageClassConfigurationPatchRequest(
    ...
    def testStorageClassConfigurationPatchRequest(self):
        """Test StorageClassConfigurationPatchRequest"""
