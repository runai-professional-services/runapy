...
class TestDistributedTemplatesListResponse(unittest.TestCase):
    """DistributedTemplatesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedTemplatesListResponse:
        """Test DistributedTemplatesListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedTemplatesListResponse`

        # model = DistributedTemplatesListResponse()
        if include_optional:
            return DistributedTemplatesListResponse(
                entries=[null],
    ...
    def testDistributedTemplatesListResponse(self):
        """Test DistributedTemplatesListResponse"""
