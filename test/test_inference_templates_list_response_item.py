...
class TestInferenceTemplatesListResponseItem(unittest.TestCase):
    """InferenceTemplatesListResponseItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferenceTemplatesListResponseItem:
        """Test InferenceTemplatesListResponseItem
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferenceTemplatesListResponseItem`

        # model = InferenceTemplatesListResponseItem()
        if include_optional:
            return InferenceTemplatesListResponseItem(
    ...
    def testInferenceTemplatesListResponseItem(self):
        """Test InferenceTemplatesListResponseItem"""
