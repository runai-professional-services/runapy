...
class TestInferencePolicyRulesV2AllOfSecurity(unittest.TestCase):
    """InferencePolicyRulesV2AllOfSecurity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferencePolicyRulesV2AllOfSecurity:
        """Test InferencePolicyRulesV2AllOfSecurity
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferencePolicyRulesV2AllOfSecurity`

        # model = InferencePolicyRulesV2AllOfSecurity()
        if include_optional:
            return InferencePolicyRulesV2AllOfSecurity(
    ...
    def testInferencePolicyRulesV2AllOfSecurity(self):
        """Test InferencePolicyRulesV2AllOfSecurity"""
