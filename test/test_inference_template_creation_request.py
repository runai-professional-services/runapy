...
class TestInferenceTemplateCreationRequest(unittest.TestCase):
    """InferenceTemplateCreationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferenceTemplateCreationRequest:
        """Test InferenceTemplateCreationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferenceTemplateCreationRequest`

        # model = InferenceTemplateCreationRequest()
        if include_optional:
            return InferenceTemplateCreationRequest(
    ...
    def testInferenceTemplateCreationRequest(self):
        """Test InferenceTemplateCreationRequest"""
