...
class TestNimServiceDefaultsAllOfModelStore(unittest.TestCase):
    """NimServiceDefaultsAllOfModelStore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceDefaultsAllOfModelStore:
        """Test NimServiceDefaultsAllOfModelStore
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceDefaultsAllOfModelStore`

        # model = NimServiceDefaultsAllOfModelStore()
        if include_optional:
            return NimServiceDefaultsAllOfModelStore(
    ...
    def testNimServiceDefaultsAllOfModelStore(self):
        """Test NimServiceDefaultsAllOfModelStore"""
