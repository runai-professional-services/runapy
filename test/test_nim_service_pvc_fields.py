...
class TestNimServicePvcFields(unittest.TestCase):
    """NimServicePvcFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServicePvcFields:
        """Test NimServicePvcFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServicePvcFields`

        # model = NimServicePvcFields()
        if include_optional:
            return NimServicePvcFields(
                existing_pvc=True,
                claim_name="my-claim",
                read_only=True,
    ...
    def testNimServicePvcFields(self):
        """Test NimServicePvcFields"""
