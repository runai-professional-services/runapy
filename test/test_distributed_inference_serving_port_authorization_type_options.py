...
class TestDistributedInferenceServingPortAuthorizationTypeOptions(unittest.TestCase):
    """DistributedInferenceServingPortAuthorizationTypeOptions unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DistributedInferenceServingPortAuthorizationTypeOptions
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceServingPortAuthorizationTypeOptions`

        # model = DistributedInferenceServingPortAuthorizationTypeOptions()
        if include_optional:
            return DistributedInferenceServingPortAuthorizationTypeOptions(
                options=[
    ...
    def testDistributedInferenceServingPortAuthorizationTypeOptions(self):
        """Test DistributedInferenceServingPortAuthorizationTypeOptions"""
