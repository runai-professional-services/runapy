...
class TestUsageTimesInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UsageTimesInfo:
        """Test UsageTimesInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UsageTimesInfo`

        # model = UsageTimesInfo()
        if include_optional:
            return UsageTimesInfo(
