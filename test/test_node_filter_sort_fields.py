...
class TestNodeFilterSortFields(unittest.TestCase):
    """NodeFilterSortFields unit test stubs"""
    ...
    def testNodeFilterSortFields(self):
        """Test NodeFilterSortFields"""
        inst = NodeFilterSortFields()
