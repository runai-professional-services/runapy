...
class TestTemplateMasterSection(unittest.TestCase):
    """TemplateMasterSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateMasterSection:
        """Test TemplateMasterSection
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TemplateMasterSection`

        # model = TemplateMasterSection()
        if include_optional:
            return TemplateMasterSection(
    ...
    def testTemplateMasterSection(self):
        """Test TemplateMasterSection"""
