...
class TestListPods200Response(unittest.TestCase):
    """ListPods200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPods200Response:
        """Test ListPods200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ListPods200Response`

        # model = ListPods200Response()
        if include_optional:
            return ListPods200Response(next=1, pods=[null])
        else:
            return ListPods200Response(
                pods=[null],
            )

    def testListPods200Response(self):
        """Test ListPods200Response"""
