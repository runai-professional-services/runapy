...
class TestCleanPodPolicyRules(unittest.TestCase):
    """CleanPodPolicyRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CleanPodPolicyRules:
        """Test CleanPodPolicyRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CleanPodPolicyRules`

        # model = CleanPodPolicyRules()
        if include_optional:
            return CleanPodPolicyRules(
    ...
    def testCleanPodPolicyRules(self):
        """Test CleanPodPolicyRules"""
