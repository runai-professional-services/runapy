...
class TestStorageClassCustomization(unittest.TestCase):
    """StorageClassCustomization unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageClassCustomization:
        """Test StorageClassCustomization
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StorageClassCustomization`

        # model = StorageClassCustomization()
        if include_optional:
            return StorageClassCustomization(
    ...
    def testStorageClassCustomization(self):
        """Test StorageClassCustomization"""
