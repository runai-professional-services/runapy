...
class TestNimServiceMultiNode(unittest.TestCase):
    """NimServiceMultiNode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceMultiNode:
        """Test NimServiceMultiNode
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceMultiNode`

        # model = NimServiceMultiNode()
        if include_optional:
            return NimServiceMultiNode(workers=3)
        else:
            return NimServiceMultiNode()

    def testNimServiceMultiNode(self):
        """Test NimServiceMultiNode"""
