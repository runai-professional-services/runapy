...
class TestRegenerateServiceAccountSecretResponse(unittest.TestCase):
    """RegenerateServiceAccountSecretResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegenerateServiceAccountSecretResponse:
        """Test RegenerateServiceAccountSecretResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RegenerateServiceAccountSecretResponse`

        # model = RegenerateServiceAccountSecretResponse()
        if include_optional:
            return RegenerateServiceAccountSecretResponse(client_secret="")
        else:
            return RegenerateServiceAccountSecretResponse()

    def testRegenerateServiceAccountSecretResponse(self):
        """Test RegenerateServiceAccountSecretResponse"""
