...
class TestDistributedTemplatePatchRequest(unittest.TestCase):
    """DistributedTemplatePatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedTemplatePatchRequest:
        """Test DistributedTemplatePatchRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedTemplatePatchRequest`

        # model = DistributedTemplatePatchRequest()
        if include_optional:
            return DistributedTemplatePatchRequest(
                meta=runai.models.template_patch_meta_fields.TemplatePatchMetaFields(
                    name="my-template-name",
                    description="description of my template.",
                ),
                fields_to_clear=["spec.image"],
                spec=None,
    ...
    def testDistributedTemplatePatchRequest(self):
        """Test DistributedTemplatePatchRequest"""
