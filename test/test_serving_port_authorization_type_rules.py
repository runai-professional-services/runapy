...
class TestServingPortAuthorizationTypeRules(unittest.TestCase):
    """ServingPortAuthorizationTypeRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServingPortAuthorizationTypeRules:
        """Test ServingPortAuthorizationTypeRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServingPortAuthorizationTypeRules`

        # model = ServingPortAuthorizationTypeRules()
        if include_optional:
            return ServingPortAuthorizationTypeRules(
    ...
    def testServingPortAuthorizationTypeRules(self):
        """Test ServingPortAuthorizationTypeRules"""
