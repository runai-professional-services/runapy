...
class TestWorkspaceTemplateCreationRequest(unittest.TestCase):
    """WorkspaceTemplateCreationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceTemplateCreationRequest:
        """Test WorkspaceTemplateCreationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceTemplateCreationRequest`

        # model = WorkspaceTemplateCreationRequest()
        if include_optional:
            return WorkspaceTemplateCreationRequest(
    ...
    def testWorkspaceTemplateCreationRequest(self):
        """Test WorkspaceTemplateCreationRequest"""
