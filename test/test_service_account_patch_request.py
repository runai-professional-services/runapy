...
class TestServiceAccountPatchRequest(unittest.TestCase):
    """ServiceAccountPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceAccountPatchRequest:
        """Test ServiceAccountPatchRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceAccountPatchRequest`

        # model = ServiceAccountPatchRequest()
        if include_optional:
            return ServiceAccountPatchRequest(enabled=True)
        else:
            return ServiceAccountPatchRequest(
                enabled=True,
            )

    def testServiceAccountPatchRequest(self):
        """Test ServiceAccountPatchRequest"""
