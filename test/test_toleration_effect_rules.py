...
class TestTolerationEffectRules(unittest.TestCase):
    """TolerationEffectRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TolerationEffectRules:
        """Test TolerationEffectRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TolerationEffectRules`

        # model = TolerationEffectRules()
        if include_optional:
            return TolerationEffectRules(
    ...
    def testTolerationEffectRules(self):
        """Test TolerationEffectRules"""
