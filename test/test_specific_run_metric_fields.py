...
class TestSpecificRunMetricFields(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SpecificRunMetricFields:
        """Test SpecificRunMetricFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SpecificRunMetricFields`

        # model = SpecificRunMetricFields()
        if include_optional:
            return SpecificRunMetricFields(
                threshold_metric="http_requests_total", threshold_value=56
            )
        else:
            return SpecificRunMetricFields()
