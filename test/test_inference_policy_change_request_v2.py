...
class TestInferencePolicyChangeRequestV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InferencePolicyChangeRequestV2:
        """Test InferencePolicyChangeRequestV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferencePolicyChangeRequestV2`

        # model = InferencePolicyChangeRequestV2()
        if include_optional:
            return InferencePolicyChangeRequestV2(
