...
class TestSupersetTemplate(unittest.TestCase):
    """SupersetTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupersetTemplate:
        """Test SupersetTemplate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupersetTemplate`

        # model = SupersetTemplate()
        if include_optional:
            return SupersetTemplate(
