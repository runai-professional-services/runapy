...
class TestAccessKeysAdministration(unittest.TestCase):
    """AccessKeysAdministration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessKeysAdministration:
        """Test AccessKeysAdministration
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessKeysAdministration`

        # model = AccessKeysAdministration()
        if include_optional:
            return AccessKeysAdministration(
                access_keys=[
                    {
                        "name": "my-access-key",
    ...
    def testAccessKeysAdministration(self):
        """Test AccessKeysAdministration"""
