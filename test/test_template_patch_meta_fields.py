...
class TestTemplatePatchMetaFields(unittest.TestCase):
    """TemplatePatchMetaFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplatePatchMetaFields:
        """Test TemplatePatchMetaFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TemplatePatchMetaFields`

        # model = TemplatePatchMetaFields()
        if include_optional:
            return TemplatePatchMetaFields(
    ...
    def testTemplatePatchMetaFields(self):
        """Test TemplatePatchMetaFields"""
