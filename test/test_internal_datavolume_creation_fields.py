...
class TestInternalDatavolumeCreationFields(unittest.TestCase):
    """InternalDatavolumeCreationFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InternalDatavolumeCreationFields:
        """Test InternalDatavolumeCreationFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InternalDatavolumeCreationFields`

        # model = InternalDatavolumeCreationFields()
        if include_optional:
            return InternalDatavolumeCreationFields(
                name="datavolume-a",
                scope="cluster",
    ...
    def testInternalDatavolumeCreationFields(self):
        """Test InternalDatavolumeCreationFields"""
