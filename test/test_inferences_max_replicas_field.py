...
class TestInferencesMaxReplicasField(unittest.TestCase):
    """InferencesMaxReplicasField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferencesMaxReplicasField:
        """Test InferencesMaxReplicasField
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferencesMaxReplicasField`

        # model = InferencesMaxReplicasField()
        if include_optional:
            return InferencesMaxReplicasField(max_replicas=1)
        else:
            return InferencesMaxReplicasField()

    def testInferencesMaxReplicasField(self):
        """Test InferencesMaxReplicasField"""
