...
class TestGitCredentialId(unittest.TestCase):
    """GitCredentialId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GitCredentialId:
        """Test GitCredentialId
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GitCredentialId`

        # model = GitCredentialId()
        if include_optional:
            return GitCredentialId(credential_id="0")
        else:
            return GitCredentialId()

    def testGitCredentialId(self):
        """Test GitCredentialId"""
