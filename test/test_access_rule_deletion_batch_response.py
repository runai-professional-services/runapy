...
class TestAccessRuleDeletionBatchResponse(unittest.TestCase):
    """AccessRuleDeletionBatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessRuleDeletionBatchResponse:
        """Test AccessRuleDeletionBatchResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessRuleDeletionBatchResponse`

        # model = AccessRuleDeletionBatchResponse()
        if include_optional:
            return AccessRuleDeletionBatchResponse(
                id="",
                succeeded=[""],
                failed=[
    ...
    def testAccessRuleDeletionBatchResponse(self):
        """Test AccessRuleDeletionBatchResponse"""
