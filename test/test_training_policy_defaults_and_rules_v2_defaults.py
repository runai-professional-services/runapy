...
class TestTrainingPolicyDefaultsAndRulesV2Defaults(unittest.TestCase):
    """TrainingPolicyDefaultsAndRulesV2Defaults unit test stubs"""
    ...
    def make_instance(
        ...
        """Test TrainingPolicyDefaultsAndRulesV2Defaults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TrainingPolicyDefaultsAndRulesV2Defaults`

        # model = TrainingPolicyDefaultsAndRulesV2Defaults()
        if include_optional:
            return TrainingPolicyDefaultsAndRulesV2Defaults(
                command="python",
                args="-x my-script.py",
                image="python:3.8",
    ...
    def testTrainingPolicyDefaultsAndRulesV2Defaults(self):
        """Test TrainingPolicyDefaultsAndRulesV2Defaults"""
