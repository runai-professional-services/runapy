...
class TestDistributedInferenceLeaderWorkerSpec(unittest.TestCase):
    """DistributedInferenceLeaderWorkerSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceLeaderWorkerSpec:
        """Test DistributedInferenceLeaderWorkerSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceLeaderWorkerSpec`

        # model = DistributedInferenceLeaderWorkerSpec()
        if include_optional:
            return DistributedInferenceLeaderWorkerSpec(
                command="python",
                args="-x my-script.py",
                image="python:3.8",
    ...
    def testDistributedInferenceLeaderWorkerSpec(self):
        """Test DistributedInferenceLeaderWorkerSpec"""
