...
class TestMpiLauncherCreationPolicyOptions(unittest.TestCase):
    """MpiLauncherCreationPolicyOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MpiLauncherCreationPolicyOptions:
        """Test MpiLauncherCreationPolicyOptions
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MpiLauncherCreationPolicyOptions`

        # model = MpiLauncherCreationPolicyOptions()
        if include_optional:
            return MpiLauncherCreationPolicyOptions(
                options=[
    ...
    def testMpiLauncherCreationPolicyOptions(self):
        """Test MpiLauncherCreationPolicyOptions"""
