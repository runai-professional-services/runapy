...
class TestWorkloadV2MetadataCreateParams(unittest.TestCase):
    """WorkloadV2MetadataCreateParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadV2MetadataCreateParams:
        """Test WorkloadV2MetadataCreateParams
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadV2MetadataCreateParams`

        # model = WorkloadV2MetadataCreateParams()
        if include_optional:
            return WorkloadV2MetadataCreateParams(
    ...
    def testWorkloadV2MetadataCreateParams(self):
        """Test WorkloadV2MetadataCreateParams"""
