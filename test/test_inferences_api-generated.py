...
class TestInferencesApi:
    ...
    def test_create_inference1(self):
        ...
        Create an inference. [Experimental] Create an inference using container related fields.
        """
        # Mock response
    ...
    def test_delete_inference(self):
        ...
        Delete an inference. [Experimental] Delete an inference using a workload id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
    ...
    def test_get_inference(self):
        ...
        Get inference data. [Experimental] Retrieve inference details using a workload id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
    ...
    def test_get_inference_workload_metrics(self):
        ...
        Get inference metrics data. [Experimental] Retrieve inference metrics data by id. Supported from control-plane version 2.18 or later.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
    ...
    def test_get_inference_workload_pod_metrics(self):
        ...
        Get inference pod's metrics data. [Experimental] Retrieve inference metrics pod&#39;s data by workload and pod id. Supported from control-plane version 2.18 or later.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
