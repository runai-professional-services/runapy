...
class TestCreateSlackAppRequestBody(unittest.TestCase):
    """CreateSlackAppRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSlackAppRequestBody:
        """Test CreateSlackAppRequestBody
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateSlackAppRequestBody`

        # model = CreateSlackAppRequestBody()
        if include_optional:
            return CreateSlackAppRequestBody(access_token="")
        else:
            return CreateSlackAppRequestBody(
                access_token="",
            )

    def testCreateSlackAppRequestBody(self):
        """Test CreateSlackAppRequestBody"""
