...
class TestSupersetRulesAllOfCompute(unittest.TestCase):
    """SupersetRulesAllOfCompute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupersetRulesAllOfCompute:
        """Test SupersetRulesAllOfCompute
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupersetRulesAllOfCompute`

        # model = SupersetRulesAllOfCompute()
        if include_optional:
            return SupersetRulesAllOfCompute(
    ...
    def testSupersetRulesAllOfCompute(self):
        """Test SupersetRulesAllOfCompute"""
