...
class TestDistributedPolicyOverwriteRequestV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DistributedPolicyOverwriteRequestV2:
        """Test DistributedPolicyOverwriteRequestV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedPolicyOverwriteRequestV2`

        # model = DistributedPolicyOverwriteRequestV2()
        if include_optional:
            return DistributedPolicyOverwriteRequestV2(
