...
class TestSpecificRunInfoFields(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SpecificRunInfoFields:
        """Test SpecificRunInfoFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SpecificRunInfoFields`

        # model = SpecificRunInfoFields()
        if include_optional:
            return SpecificRunInfoFields(
