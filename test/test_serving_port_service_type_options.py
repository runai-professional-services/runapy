...
class TestServingPortServiceTypeOptions(unittest.TestCase):
    """ServingPortServiceTypeOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServingPortServiceTypeOptions:
        """Test ServingPortServiceTypeOptions
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServingPortServiceTypeOptions`

        # model = ServingPortServiceTypeOptions()
        if include_optional:
            return ServingPortServiceTypeOptions(
                options=[
    ...
    def testServingPortServiceTypeOptions(self):
        """Test ServingPortServiceTypeOptions"""
