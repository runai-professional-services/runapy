...
class TestRequestedPods(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RequestedPods:
        """Test RequestedPods
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RequestedPods`

        # model = RequestedPods()
        if include_optional:
            return RequestedPods(number=1, min=2, max=5, parallelism=3, completions=5)
        else:
