...
class TestRoleCreationFieldsInternal(unittest.TestCase):
    """RoleCreationFieldsInternal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoleCreationFieldsInternal:
        """Test RoleCreationFieldsInternal
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RoleCreationFieldsInternal`

        # model = RoleCreationFieldsInternal()
        if include_optional:
            return RoleCreationFieldsInternal(
                name="admin",
    ...
    def testRoleCreationFieldsInternal(self):
        """Test RoleCreationFieldsInternal"""
