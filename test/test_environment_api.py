...
class TestEnvironmentApi(unittest.TestCase):
    ...
    def test_create_environment_asset(self) -> None:
    ...
    def test_delete_environment_asset_by_id(self) -> None:
    ...
    def test_get_environment_asset_by_id(self) -> None:
    ...
    def test_list_environment_assets(self) -> None:
    ...
    def test_update_environment_asset_by_id(self) -> None:
