...
class TestWorkloadTypeStatus(unittest.TestCase):
    """WorkloadTypeStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadTypeStatus:
        """Test WorkloadTypeStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadTypeStatus`

        # model = WorkloadTypeStatus()
        if include_optional:
            return WorkloadTypeStatus(
                phase="Ready",
                conditions=[
    ...
    def testWorkloadTypeStatus(self):
        """Test WorkloadTypeStatus"""
