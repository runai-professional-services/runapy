...
class TestWorkloadV2GetResponse(unittest.TestCase):
    """WorkloadV2GetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadV2GetResponse:
        """Test WorkloadV2GetResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadV2GetResponse`

        # model = WorkloadV2GetResponse()
        if include_optional:
            return WorkloadV2GetResponse(
    ...
    def testWorkloadV2GetResponse(self):
        """Test WorkloadV2GetResponse"""
