...
class TestDistributedInferenceWorkerDefaults(unittest.TestCase):
    """DistributedInferenceWorkerDefaults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceWorkerDefaults:
        """Test DistributedInferenceWorkerDefaults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceWorkerDefaults`

        # model = DistributedInferenceWorkerDefaults()
        if include_optional:
            return DistributedInferenceWorkerDefaults(
    ...
    def testDistributedInferenceWorkerDefaults(self):
        """Test DistributedInferenceWorkerDefaults"""
