...
class TestNimCacheRules(unittest.TestCase):
    """NimCacheRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimCacheRules:
        """Test NimCacheRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimCacheRules`

        # model = NimCacheRules()
        if include_optional:
            return NimCacheRules(
