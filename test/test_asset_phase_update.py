...
class TestAssetPhaseUpdate(unittest.TestCase):
    """AssetPhaseUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetPhaseUpdate:
        """Test AssetPhaseUpdate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AssetPhaseUpdate`

        # model = AssetPhaseUpdate()
        if include_optional:
            return AssetPhaseUpdate(
                phase="Creating", phase_message="Creating PVC asset pvc-123"
            )
        else:
            return AssetPhaseUpdate(
                phase="Creating",
                phase_message="Creating PVC asset pvc-123",
            )

    def testAssetPhaseUpdate(self):
        """Test AssetPhaseUpdate"""
