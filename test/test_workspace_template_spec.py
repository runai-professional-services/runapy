...
class TestWorkspaceTemplateSpec(unittest.TestCase):
    """WorkspaceTemplateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceTemplateSpec:
        """Test WorkspaceTemplateSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceTemplateSpec`

        # model = WorkspaceTemplateSpec()
        if include_optional:
    ...
    def testWorkspaceTemplateSpec(self):
        """Test WorkspaceTemplateSpec"""
