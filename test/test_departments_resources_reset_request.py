...
class TestDepartmentsResourcesResetRequest(unittest.TestCase):
    """DepartmentsResourcesResetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepartmentsResourcesResetRequest:
        """Test DepartmentsResourcesResetRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DepartmentsResourcesResetRequest`

        # model = DepartmentsResourcesResetRequest()
        if include_optional:
            return DepartmentsResourcesResetRequest(
    ...
    def testDepartmentsResourcesResetRequest(self):
        """Test DepartmentsResourcesResetRequest"""
