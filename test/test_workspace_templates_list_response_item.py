...
class TestWorkspaceTemplatesListResponseItem(unittest.TestCase):
    """WorkspaceTemplatesListResponseItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceTemplatesListResponseItem:
        """Test WorkspaceTemplatesListResponseItem
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceTemplatesListResponseItem`

        # model = WorkspaceTemplatesListResponseItem()
        if include_optional:
            return WorkspaceTemplatesListResponseItem(
    ...
    def testWorkspaceTemplatesListResponseItem(self):
        """Test WorkspaceTemplatesListResponseItem"""
