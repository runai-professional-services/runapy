...
class TestInferencesMinReplicasField(unittest.TestCase):
    """InferencesMinReplicasField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferencesMinReplicasField:
        """Test InferencesMinReplicasField
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferencesMinReplicasField`

        # model = InferencesMinReplicasField()
        if include_optional:
            return InferencesMinReplicasField(min_replicas=0)
        else:
            return InferencesMinReplicasField()

    def testInferencesMinReplicasField(self):
        """Test InferencesMinReplicasField"""
