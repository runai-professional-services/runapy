...
class TestCommonStorageFieldsDefaults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommonStorageFieldsDefaults:
        """Test CommonStorageFieldsDefaults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CommonStorageFieldsDefaults`

        # model = CommonStorageFieldsDefaults()
        if include_optional:
            return CommonStorageFieldsDefaults(
                ...
                secret_volume=runai.models.secrets_defaults.SecretsDefaults(
                    attributes=runai.models.secret_instance.SecretInstance(),
                    instances=[runai.models.secret_instance1.SecretInstance1()],
                ),
            )
        else:
            return CommonStorageFieldsDefaults()
