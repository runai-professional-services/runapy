...
class TestExposedUrlRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExposedUrlRules:
        """Test ExposedUrlRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExposedUrlRules`

        # model = ExposedUrlRules()
        if include_optional:
            return ExposedUrlRules(
