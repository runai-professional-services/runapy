...
class TestInferenceSpecSpecAllOfStorage(unittest.TestCase):
    """InferenceSpecSpecAllOfStorage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InferenceSpecSpecAllOfStorage:
        """Test InferenceSpecSpecAllOfStorage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InferenceSpecSpecAllOfStorage`

        # model = InferenceSpecSpecAllOfStorage()
        if include_optional:
            return InferenceSpecSpecAllOfStorage(
                config_map_volume=[
    ...
    def testInferenceSpecSpecAllOfStorage(self):
        """Test InferenceSpecSpecAllOfStorage"""
