...
class TestNonNullResource(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NonNullResource:
        """Test NonNullResource
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NonNullResource`

        # model = NonNullResource()
        if include_optional:
            return NonNullResource(deserved=1000, limit=0, over_quota_weight=2)
        else:
            return NonNullResource()
