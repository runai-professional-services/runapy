...
class TestStorageFieldsRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StorageFieldsRules:
        """Test StorageFieldsRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `StorageFieldsRules`

        # model = StorageFieldsRules()
        if include_optional:
            return StorageFieldsRules(
