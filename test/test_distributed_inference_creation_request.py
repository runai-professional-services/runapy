...
class TestDistributedInferenceCreationRequest(unittest.TestCase):
    """DistributedInferenceCreationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceCreationRequest:
        """Test DistributedInferenceCreationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceCreationRequest`

        # model = DistributedInferenceCreationRequest()
        if include_optional:
            return DistributedInferenceCreationRequest(
    ...
    def testDistributedInferenceCreationRequest(self):
        """Test DistributedInferenceCreationRequest"""
