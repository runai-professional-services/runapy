...
class TestAccessRuleClusterPhase(unittest.TestCase):
    """AccessRuleClusterPhase unit test stubs"""
    ...
    def testAccessRuleClusterPhase(self):
        """Test AccessRuleClusterPhase"""
        inst = AccessRuleClusterPhase()
