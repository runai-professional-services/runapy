...
class TestNodepoolFullMetadata(unittest.TestCase):
    """NodepoolFullMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodepoolFullMetadata:
        """Test NodepoolFullMetadata
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodepoolFullMetadata`

        # model = NodepoolFullMetadata()
        if include_optional:
            return NodepoolFullMetadata(
                id="5",
                name="v100",
    ...
    def testNodepoolFullMetadata(self):
        """Test NodepoolFullMetadata"""
