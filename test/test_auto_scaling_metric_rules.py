...
class TestAutoScalingMetricRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AutoScalingMetricRules:
        """Test AutoScalingMetricRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AutoScalingMetricRules`

        # model = AutoScalingMetricRules()
        if include_optional:
            return AutoScalingMetricRules(
