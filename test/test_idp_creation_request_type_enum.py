...
class TestIdpCreationRequestTypeEnum(unittest.TestCase):
    """IdpCreationRequestTypeEnum unit test stubs"""
    ...
    def testIdpCreationRequestTypeEnum(self):
        """Test IdpCreationRequestTypeEnum"""
        inst = IdpCreationRequestTypeEnum()
