...
class TestPolicyListEntryStatus(unittest.TestCase):
    """PolicyListEntryStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyListEntryStatus:
        """Test PolicyListEntryStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PolicyListEntryStatus`

        # model = PolicyListEntryStatus()
        if include_optional:
            return PolicyListEntryStatus(
                clusters=[
    ...
    def testPolicyListEntryStatus(self):
        """Test PolicyListEntryStatus"""
