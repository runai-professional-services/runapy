...
class TestNodeAdditionalReadFields(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NodeAdditionalReadFields:
        """Test NodeAdditionalReadFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodeAdditionalReadFields`

        # model = NodeAdditionalReadFields()
        if include_optional:
            return NodeAdditionalReadFields(
                id="",
