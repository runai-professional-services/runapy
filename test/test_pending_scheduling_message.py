...
class TestPendingSchedulingMessage(unittest.TestCase):
    """PendingSchedulingMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PendingSchedulingMessage:
        """Test PendingSchedulingMessage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PendingSchedulingMessage`

        # model = PendingSchedulingMessage()
        if include_optional:
    ...
    def testPendingSchedulingMessage(self):
        """Test PendingSchedulingMessage"""
