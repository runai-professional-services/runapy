...
class TestWorkloadV2MetadataAutoFill(unittest.TestCase):
    """WorkloadV2MetadataAutoFill unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadV2MetadataAutoFill:
        """Test WorkloadV2MetadataAutoFill
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadV2MetadataAutoFill`

        # model = WorkloadV2MetadataAutoFill()
        if include_optional:
            return WorkloadV2MetadataAutoFill(
                id="",
    ...
    def testWorkloadV2MetadataAutoFill(self):
        """Test WorkloadV2MetadataAutoFill"""
