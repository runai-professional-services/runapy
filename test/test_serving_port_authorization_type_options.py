...
class TestServingPortAuthorizationTypeOptions(unittest.TestCase):
    """ServingPortAuthorizationTypeOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServingPortAuthorizationTypeOptions:
        """Test ServingPortAuthorizationTypeOptions
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServingPortAuthorizationTypeOptions`

        # model = ServingPortAuthorizationTypeOptions()
        if include_optional:
            return ServingPortAuthorizationTypeOptions(
                options=[
    ...
    def testServingPortAuthorizationTypeOptions(self):
        """Test ServingPortAuthorizationTypeOptions"""
