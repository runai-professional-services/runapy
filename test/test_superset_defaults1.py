...
class TestSupersetDefaults1(unittest.TestCase):
    """SupersetDefaults1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupersetDefaults1:
        """Test SupersetDefaults1
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupersetDefaults1`

        # model = SupersetDefaults1()
        if include_optional:
            return SupersetDefaults1(
    ...
    def testSupersetDefaults1(self):
        """Test SupersetDefaults1"""
