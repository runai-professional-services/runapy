...
class TestAppTokenRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AppTokenRequest:
        """Test AppTokenRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AppTokenRequest`

        # model = AppTokenRequest()
        if include_optional:
            return AppTokenRequest(id="", name="", secret="")
        else:
