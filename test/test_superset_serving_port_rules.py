...
class TestSupersetServingPortRules(unittest.TestCase):
    """SupersetServingPortRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupersetServingPortRules:
        """Test SupersetServingPortRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SupersetServingPortRules`

        # model = SupersetServingPortRules()
        if include_optional:
            return SupersetServingPortRules(
    ...
    def testSupersetServingPortRules(self):
        """Test SupersetServingPortRules"""
