...
class TestDataVolumeRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DataVolumeRules:
        """Test DataVolumeRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DataVolumeRules`

        # model = DataVolumeRules()
        if include_optional:
            return DataVolumeRules(
