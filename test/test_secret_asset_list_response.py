...
class TestSecretAssetListResponse(unittest.TestCase):
    """SecretAssetListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecretAssetListResponse:
        """Test SecretAssetListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SecretAssetListResponse`

        # model = SecretAssetListResponse()
        if include_optional:
            return SecretAssetListResponse(
                entries=[
    ...
    def testSecretAssetListResponse(self):
        """Test SecretAssetListResponse"""
