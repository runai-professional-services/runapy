...
class TestImagePullSecretsFieldRules(unittest.TestCase):
    """ImagePullSecretsFieldRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImagePullSecretsFieldRules:
        """Test ImagePullSecretsFieldRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ImagePullSecretsFieldRules`

        # model = ImagePullSecretsFieldRules()
        if include_optional:
            return ImagePullSecretsFieldRules(
    ...
    def testImagePullSecretsFieldRules(self):
        """Test ImagePullSecretsFieldRules"""
