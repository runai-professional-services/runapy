...
class TestPodNodeAffinityRequired(unittest.TestCase):
    """PodNodeAffinityRequired unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PodNodeAffinityRequired:
        """Test PodNodeAffinityRequired
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PodNodeAffinityRequired`

        # model = PodNodeAffinityRequired()
        if include_optional:
            return PodNodeAffinityRequired(
                node_selector_terms=[
    ...
    def testPodNodeAffinityRequired(self):
        """Test PodNodeAffinityRequired"""
