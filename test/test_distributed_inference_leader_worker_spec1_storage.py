...
class TestDistributedInferenceLeaderWorkerSpec1Storage(unittest.TestCase):
    """DistributedInferenceLeaderWorkerSpec1Storage unit test stubs"""
    ...
    def make_instance(
        ...
        """Test DistributedInferenceLeaderWorkerSpec1Storage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceLeaderWorkerSpec1Storage`

        # model = DistributedInferenceLeaderWorkerSpec1Storage()
        if include_optional:
            return DistributedInferenceLeaderWorkerSpec1Storage(
                config_map_volume=[
    ...
    def testDistributedInferenceLeaderWorkerSpec1Storage(self):
        """Test DistributedInferenceLeaderWorkerSpec1Storage"""
