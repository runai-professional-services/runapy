...
class TestAccessKeyPostResponse(unittest.TestCase):
    """AccessKeyPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessKeyPostResponse:
        """Test AccessKeyPostResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessKeyPostResponse`

        # model = AccessKeyPostResponse()
        if include_optional:
            return AccessKeyPostResponse(
                id="",
                client_id="",
                name="",
                client_secret="",
    ...
    def testAccessKeyPostResponse(self):
        """Test AccessKeyPostResponse"""
