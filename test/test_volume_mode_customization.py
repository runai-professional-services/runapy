...
class TestVolumeModeCustomization(unittest.TestCase):
    """VolumeModeCustomization unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VolumeModeCustomization:
        """Test VolumeModeCustomization
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VolumeModeCustomization`

        # model = VolumeModeCustomization()
        if include_optional:
            return VolumeModeCustomization(
                required=True,
                default="Filesystem",
    ...
    def testVolumeModeCustomization(self):
        """Test VolumeModeCustomization"""
