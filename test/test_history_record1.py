...
class TestHistoryRecord1(unittest.TestCase):
    """HistoryRecord1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistoryRecord1:
        """Test HistoryRecord1
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HistoryRecord1`

        # model = HistoryRecord1()
        if include_optional:
            return HistoryRecord1(
