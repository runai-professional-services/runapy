...
class TestPreemptibilityRules(unittest.TestCase):
    """PreemptibilityRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreemptibilityRules:
        """Test PreemptibilityRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PreemptibilityRules`

        # model = PreemptibilityRules()
        if include_optional:
            return PreemptibilityRules(
    ...
    def testPreemptibilityRules(self):
        """Test PreemptibilityRules"""
