...
class TestNimServiceRulesAllOfAutoscaling(unittest.TestCase):
    """NimServiceRulesAllOfAutoscaling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimServiceRulesAllOfAutoscaling:
        """Test NimServiceRulesAllOfAutoscaling
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NimServiceRulesAllOfAutoscaling`

        # model = NimServiceRulesAllOfAutoscaling()
        if include_optional:
            return NimServiceRulesAllOfAutoscaling(
    ...
    def testNimServiceRulesAllOfAutoscaling(self):
        """Test NimServiceRulesAllOfAutoscaling"""
