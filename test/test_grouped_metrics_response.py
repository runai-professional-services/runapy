...
class TestGroupedMetricsResponse(unittest.TestCase):
    """GroupedMetricsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupedMetricsResponse:
        """Test GroupedMetricsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GroupedMetricsResponse`

        # model = GroupedMetricsResponse()
        if include_optional:
    ...
    def testGroupedMetricsResponse(self):
        """Test GroupedMetricsResponse"""
