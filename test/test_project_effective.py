...
class TestProjectEffective(unittest.TestCase):
    """ProjectEffective unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectEffective:
        """Test ProjectEffective
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectEffective`

        # model = ProjectEffective()
        if include_optional:
