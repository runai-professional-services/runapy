...
class TestProjectV1NodeAffinityResponseInteractive(unittest.TestCase):
    ...
    def make_instance(
        ...
        # uncomment below to create an instance of `ProjectV1NodeAffinityResponseInteractive`

        # model = ProjectV1NodeAffinityResponseInteractive()
        if include_optional:
            return ProjectV1NodeAffinityResponseInteractive(
