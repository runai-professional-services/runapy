...
class TestHistoryRecord1Spec(unittest.TestCase):
    """HistoryRecord1Spec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistoryRecord1Spec:
        """Test HistoryRecord1Spec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HistoryRecord1Spec`

        # model = HistoryRecord1Spec()
        if include_optional:
            return HistoryRecord1Spec(
    ...
    def testHistoryRecord1Spec(self):
        """Test HistoryRecord1Spec"""
