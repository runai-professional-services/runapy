...
class TestDistributedSpecMasterSpec(unittest.TestCase):
    """DistributedSpecMasterSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedSpecMasterSpec:
        """Test DistributedSpecMasterSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedSpecMasterSpec`

        # model = DistributedSpecMasterSpec()
        if include_optional:
            return DistributedSpecMasterSpec(
                command="python",
                args="-x my-script.py",
                image="python:3.8",
    ...
    def testDistributedSpecMasterSpec(self):
        """Test DistributedSpecMasterSpec"""
