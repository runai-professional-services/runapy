...
class TestBatchResponseFailureItem(unittest.TestCase):
    """BatchResponseFailureItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchResponseFailureItem:
        """Test BatchResponseFailureItem
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BatchResponseFailureItem`

        # model = BatchResponseFailureItem()
        if include_optional:
            return BatchResponseFailureItem(id="", code=56, message="")
        else:
            return BatchResponseFailureItem(
                id="",
                code=56,
                message="",
            )

    def testBatchResponseFailureItem(self):
        """Test BatchResponseFailureItem"""
