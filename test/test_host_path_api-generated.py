...
class TestHostPathApi:
    """Test cases for HostPathApi"""
    ...
    def setup(self):
        ...
        self.api = HostPathApi(self.api_client)
    ...
    def test_create_host_path(self):
        ...
        Create a host path asset. Use to create a hostPath datasource asset.
        """
        # Mock response
        ...
        # Test parameters
        host_path_creation_request = (
            runai.HostPathCreationRequest()
        )  # HostPathCreationRequest |

        # Make request
        response = self.api.create_host_path(
        ...
        assert "/api/v1/asset/datasource/host-path" in kwargs["url"]

        # Verify body
        assert kwargs["body"] is not None

        # Verify response
        assert isinstance(response, HostPathAsset)

    def test_create_host_path_error(self):
        """Test error handling for create_host_path"""
        # Mock error response
        mock_response = mock.Mock()
    ...
    def test_delete_host_path_by_id(self):
        ...
        Delete a hostPath asset. Use to delete a hostPath datasource asset by id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Make request
        response = self.api.delete_host_path_by_id(
            asset_id=asset_id,
        )
        ...
        assert "/api/v1/asset/datasource/host-path/{AssetId}" in kwargs["url"]

        # Verify response
        assert isinstance(response, HttpResponse1)

    def test_delete_host_path_by_id_error(self):
        """Test error handling for delete_host_path_by_id"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
        ...
        # Verify error handling
        with pytest.raises(ApiException) as exc_info:
            self.api.delete_host_path_by_id(
                asset_id=asset_id,
            )
        assert exc_info.value.status == 400
    ...
    def test_get_host_path_by_id(self):
        ...
        Get a hostPath asset. Use to retrieve the details of a hostPath datasource by id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Make request
        response = self.api.get_host_path_by_id(
            asset_id=asset_id,
        )
    ...
    def test_get_host_path_by_id_error(self):
        """Test error handling for get_host_path_by_id"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
    ...
    def test_list_host_path_assets(self):
        ...
        List host path assets. Retrieve a list of hostPath datasource assets.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Make request
        response = self.api.list_host_path_assets()
        ...
        # Verify response
        assert isinstance(response, HostPathListResponse)

    def test_list_host_path_assets_error(self):
        """Test error handling for list_host_path_assets"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
        ...
        # Verify error handling
        with pytest.raises(ApiException) as exc_info:
            self.api.list_host_path_assets()
        assert exc_info.value.status == 400

    def test_update_host_path_by_id(self):
        """Test case for update_host_path_by_id

        Update a hostPath asset. Use to update the details of a hostPath datasource by id.
        """
        # Mock response
        mock_response = mock.Mock()
        mock_response.status = 200
        ...
        # Test parameters
        asset_id = "asset_id_example"  # str | Unique identifier of the asset.
        host_path_update_request = (
            runai.HostPathUpdateRequest()
        )  # HostPathUpdateRequest |

        # Make request
        response = self.api.update_host_path_by_id(
            asset_id=asset_id,
    ...
    def test_update_host_path_by_id_error(self):
        """Test error handling for update_host_path_by_id"""
        # Mock error response
        mock_response = mock.Mock()
        mock_response.status = 400
        mock_response.read.return_value = json.dumps({"message": "Error message"})
        ...
        # Verify error handling
        with pytest.raises(ApiException) as exc_info:
            self.api.update_host_path_by_id(
                asset_id=asset_id,
                host_path_update_request=host_path_update_request,
            )
        assert exc_info.value.status == 400
