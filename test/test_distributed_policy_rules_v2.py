...
class TestDistributedPolicyRulesV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DistributedPolicyRulesV2:
        """Test DistributedPolicyRulesV2
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedPolicyRulesV2`

        # model = DistributedPolicyRulesV2()
        if include_optional:
            return DistributedPolicyRulesV2(
