...
class TestNgcApiKeyUpdateRequest(unittest.TestCase):
    """NgcApiKeyUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NgcApiKeyUpdateRequest:
        """Test NgcApiKeyUpdateRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NgcApiKeyUpdateRequest`

        # model = NgcApiKeyUpdateRequest()
        if include_optional:
            return NgcApiKeyUpdateRequest(meta={"description": "my-credentials"})
        else:
            return NgcApiKeyUpdateRequest()

    def testNgcApiKeyUpdateRequest(self):
        """Test NgcApiKeyUpdateRequest"""
