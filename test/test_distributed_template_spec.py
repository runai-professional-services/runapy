...
class TestDistributedTemplateSpec(unittest.TestCase):
    """DistributedTemplateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedTemplateSpec:
        """Test DistributedTemplateSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedTemplateSpec`

        # model = DistributedTemplateSpec()
        if include_optional:
            return DistributedTemplateSpec(
                annotations=[
    ...
    def testDistributedTemplateSpec(self):
        """Test DistributedTemplateSpec"""
