...
class TestWorkloadV2MetadataResponse(unittest.TestCase):
    """WorkloadV2MetadataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadV2MetadataResponse:
        """Test WorkloadV2MetadataResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadV2MetadataResponse`

        # model = WorkloadV2MetadataResponse()
        if include_optional:
            return WorkloadV2MetadataResponse(
    ...
    def testWorkloadV2MetadataResponse(self):
        """Test WorkloadV2MetadataResponse"""
