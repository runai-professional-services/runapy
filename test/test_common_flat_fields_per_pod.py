...
class TestCommonFlatFieldsPerPod(unittest.TestCase):
    """CommonFlatFieldsPerPod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommonFlatFieldsPerPod:
        """Test CommonFlatFieldsPerPod
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CommonFlatFieldsPerPod`

        # model = CommonFlatFieldsPerPod()
        if include_optional:
            return CommonFlatFieldsPerPod(
                command="python",
                args="-x my-script.py",
                image="python:3.8",
    ...
    def testCommonFlatFieldsPerPod(self):
        """Test CommonFlatFieldsPerPod"""
