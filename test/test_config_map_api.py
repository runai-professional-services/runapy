...
class TestConfigMapApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = ConfigMapApi()

    def tearDown(self) -> None:
        pass

    def test_create_config_map_asset(self) -> None:
    ...
    def test_delete_config_map_asset_by_id(self) -> None:
    ...
    def test_get_config_map_asset_by_id(self) -> None:
    ...
    def test_list_config_map_assets(self) -> None:
    ...
    def test_update_config_map_asset_by_id(self) -> None:
