...
class TestApplicationRequestResources(unittest.TestCase):
    """ApplicationRequestResources unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationRequestResources:
        """Test ApplicationRequestResources
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ApplicationRequestResources`

        # model = ApplicationRequestResources()
        if include_optional:
            return ApplicationRequestResources(
    ...
    def testApplicationRequestResources(self):
        """Test ApplicationRequestResources"""
