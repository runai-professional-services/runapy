...
class TestRoleCalculatedFields(unittest.TestCase):
    """RoleCalculatedFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoleCalculatedFields:
        """Test RoleCalculatedFields
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RoleCalculatedFields`

        # model = RoleCalculatedFields()
        if include_optional:
            return RoleCalculatedFields(
                id=32,
    ...
    def testRoleCalculatedFields(self):
        """Test RoleCalculatedFields"""
