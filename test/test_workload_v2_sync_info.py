...
class TestWorkloadV2SyncInfo(unittest.TestCase):
    """WorkloadV2SyncInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadV2SyncInfo:
        """Test WorkloadV2SyncInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkloadV2SyncInfo`

        # model = WorkloadV2SyncInfo()
        if include_optional:
            return WorkloadV2SyncInfo(status="Queued", message="jUR,rZ#UM/?R,Fp^l6$ARj")
        else:
            return WorkloadV2SyncInfo(
                status="Queued",
            )

    def testWorkloadV2SyncInfo(self):
        """Test WorkloadV2SyncInfo"""
