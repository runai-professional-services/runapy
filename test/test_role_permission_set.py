...
class TestRolePermissionSet(unittest.TestCase):
    """RolePermissionSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RolePermissionSet:
        """Test RolePermissionSet
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RolePermissionSet`

        # model = RolePermissionSet()
        if include_optional:
            return RolePermissionSet(id="", name="test")
        else:
            return RolePermissionSet(
                id="",
            )

    def testRolePermissionSet(self):
        """Test RolePermissionSet"""
