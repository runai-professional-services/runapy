...
class TestDatavolumeNoSharedScopes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DatavolumeNoSharedScopes:
        """Test DatavolumeNoSharedScopes
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DatavolumeNoSharedScopes`

        # model = DatavolumeNoSharedScopes()
        if include_optional:
