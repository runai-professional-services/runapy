...
class TestDistributedInferenceWorkersField(unittest.TestCase):
    """DistributedInferenceWorkersField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistributedInferenceWorkersField:
        """Test DistributedInferenceWorkersField
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistributedInferenceWorkersField`

        # model = DistributedInferenceWorkersField()
        if include_optional:
            return DistributedInferenceWorkersField(workers=4)
        else:
            return DistributedInferenceWorkersField()

    def testDistributedInferenceWorkersField(self):
        """Test DistributedInferenceWorkersField"""
