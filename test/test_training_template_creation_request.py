...
class TestTrainingTemplateCreationRequest(unittest.TestCase):
    """TrainingTemplateCreationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrainingTemplateCreationRequest:
        """Test TrainingTemplateCreationRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TrainingTemplateCreationRequest`

        # model = TrainingTemplateCreationRequest()
        if include_optional:
            return TrainingTemplateCreationRequest(
    ...
    def testTrainingTemplateCreationRequest(self):
        """Test TrainingTemplateCreationRequest"""
