...
def example_create_compute_asset():
    ...
    try:
        ...
        compute_creation_request = models.ComputeCreationRequest(
            ...
            spec = {cpuMemoryLimit=30M, extendedResources=[Ljava.lang.Object;@2bb41f5c, gpuMemoryLimit=10M, migProfile=1g.5gb, cpuCoreLimit=2, gpuRequestType=portion, cpuMemoryRequest=20M, gpuDevicesRequest=1, gpuMemoryRequest=10M, gpuPortionRequest=0.5, largeShmRequest=false, gpuPortionLimit=0.5, cpuCoreRequest=0.5}
        )
