    ...
    try:
        ...
        workload_template_creation_request = models.WorkloadTemplateCreationRequest(
            ...
            spec = runai.models.specific_run_creation_fields.SpecificRunCreationFields(
                    ...
                    specific_env = {terminationGracePeriodSeconds=20, terminateAfterPreemption=false, backoffLimit=3, imagePullSecrets=[Ljava.lang.Object;@76e90da5, parallelism=1, autoDeletionTimeAfterCompletionSeconds=15, annotations=[Ljava.lang.Object;@4e3e11b9, runAsUid=500, tolerations=[Ljava.lang.Object;@67cffead, servingPortAccess={}, runAsGid=30, supplementalGroups=2,3,5,8, nodePools=["my-node-pool-a","my-node-pool-b"], podAffinity={type=Required, key=key}, connections=[Ljava.lang.Object;@214beff9, nodeAffinityRequired={nodeSelectorTerms=[Ljava.lang.Object;@1ff15a50}, autoScaling={maxReplicas=1, initialReplicas=0, scaleToZeroRetentionSeconds=1301, metricThresholdPercentage=15.511548, minReplicas=0, activationReplicas=1, scaleDownDelaySeconds=729, initializationTimeoutSeconds=1, thresholdMetric=http_requests_total, concurrencyHardLimit=0, thresholdValue=7}, completions=1, nodeType=my-node-type, priorityClass=priorityClass, restartPolicy=Always, command=python, labels=[Ljava.lang.Object;@217c23ce, args=-x my-script.py, environmentVariables=[Ljava.lang.Object;@39de9bda, allowOverQuota=true, category=category}, )
        )
