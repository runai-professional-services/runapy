    ...
    try:
        ...
        workload_template_creation_request = models.WorkloadTemplateCreationRequest(
            ...
            spec = runai.models.specific_run_creation_fields.SpecificRunCreationFields(
                    ...
                    specific_env = {terminationGracePeriodSeconds=20, backoffLimit=3, terminateAfterPreemption=false, imagePullSecrets=[Ljava.lang.Object;@5bda157e, parallelism=1, annotations=[Ljava.lang.Object;@67e0fd6d, autoDeletionTimeAfterCompletionSeconds=15, runAsUid=500, tolerations=[Ljava.lang.Object;@21390938, servingPortAccess={}, runAsGid=30, supplementalGroups=2,3,5,8, nodePools=["my-node-pool-a","my-node-pool-b"], connections=[Ljava.lang.Object;@1129829c, podAffinity={type=Required, key=key}, nodeAffinityRequired={nodeSelectorTerms=[Ljava.lang.Object;@1a531422}, autoScaling={maxReplicas=1, initialReplicas=0, scaleToZeroRetentionSeconds=1301, metricThresholdPercentage=15.511548, minReplicas=0, activationReplicas=1, scaleDownDelaySeconds=729, initializationTimeoutSeconds=1, thresholdMetric=http_requests_total, concurrencyHardLimit=0, thresholdValue=7}, completions=1, nodeType=my-node-type, priorityClass=null, restartPolicy=Always, command=python, labels=[Ljava.lang.Object;@7a388990, args=-x my-script.py, environmentVariables=[Ljava.lang.Object;@13213f26, allowOverQuota=true, category=null}, )
        )
